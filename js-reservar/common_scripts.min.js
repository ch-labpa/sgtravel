! function(t, e) {
    ...
    function l(n) {
        for (var t = 1; t < arguments.length; t++) {
            ...
            "function" == typeof Object.getOwnPropertySymbols && (e = e.concat(Object.getOwnPropertySymbols(a).filter(function(t) {
                ...
                var e, i, s;
                e = n, s = a[i = t], i in e ? Object.defineProperty(e, i, {
                    value: s,
                    enumerable: !0,
                    configurable: !0,
                    writable: !0
        ...
        typeCheckConfig: function(t, e, i) {
            for (var s in i)
                if (Object.prototype.hasOwnProperty.call(i, s)) {
                    var n = i[s],
                        a = e[s],
                        o = a && m.isElement(a) ? "element" : (r = a, {}.toString.call(r).match(/\s([a-z]+)/i)[1].toLowerCase());
    ...
    p.fn.emulateTransitionEnd = i, p.event.special[m.TRANSITION_END] = {
        bindType: e,
        delegateType: e,
        handle: function(t) {
        ...
        g = function() {
            ...
            return t.close = function(t) {
                ...
                var e = m.getSelectorFromElement(t),
                    i = !1;
                return e && (i = document.querySelector(e)), i || (i = p(t).closest("." + d)[0]), i
            }, t._triggerCloseEvent = function(t) {
                var e = p.Event(c.CLOSE);
                ...
                p(t).detach().trigger(c.CLOSED).remove()
            }, s._jQueryInterface = function(i) {
                return this.each(function() {
                    var t = p(this),
                        e = t.data(a);
                    e || (e = new s(this), t.data(a, e)), "close" === i && e[i](this)
                })
    ...
    p(document).on(c.CLICK_DATA_API, '[data-dismiss="alert"]', g._handleDismiss(new g)), p.fn[n] = g._jQueryInterface, p.fn[n].Constructor = g, p.fn[n].noConflict = function() {
        return p.fn[n] = h, g._jQueryInterface
    };
    var v = "button",
        _ = "bs.button",
        y = "." + _,
                ...
                if (i) {
                    ...
                    if (s) {
                        ...
                        if (t) {
                            ...
                            s.checked = !this._element.classList.contains(D), p(s).trigger("change")
                        }
                        s.focus(), e = !1
                    }
                }
    ...
    p(document).on(E.CLICK_DATA_API, x, function(t) {
        t.preventDefault();
        var e = t.target;
        p(e).hasClass(C) || (e = p(e).closest(M)), P._jQueryInterface.call(p(e), "toggle")
    }).on(E.FOCUS_BLUR_DATA_API, x, function(t) {
        var e = p(t.target).closest(M)[0];
        p(e).toggleClass(k, /^focus(in)?$/.test(t.type))
    }), p.fn[v] = P._jQueryInterface, p.fn[v].Constructor = P, p.fn[v].noConflict = function() {
        return p.fn[v] = w, P._jQueryInterface
    };
    var A = "carousel",
        O = "bs.carousel",
        F = "." + O,
        ...
        j = {
            ...
            LOAD_DATA_API: "load" + F + N,
            CLICK_DATA_API: "click" + F + N
        },
        B = "carousel",
        q = "active",
        U = "slide",
        ...
        rt = function() {
            ...
            return t.next = function() {
                ...
                p(this._element).off(F), p.removeData(this._element, O), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
            }, t._getConfig = function(t) {
                return t = l({}, H, t), m.typeCheckConfig(A, t, z), t
                ...
                if (this._touchSupported) {
                    var e = function(t) {
                            i._pointerEvent && ot[t.originalEvent.pointerType.toUpperCase()] ? i.touchStartX = t.originalEvent.clientX : i._pointerEvent || (i.touchStartX = t.originalEvent.touches[0].clientX)
                        },
                        s = function(t) {
                            i._pointerEvent && ot[t.originalEvent.pointerType.toUpperCase()] && (i.touchDeltaX = t.originalEvent.clientX - i.touchStartX), i._handleSwipe(), "hover" === i._config.pause && (i.pause(), i.touchTimeout && clearTimeout(i.touchTimeout), i.touchTimeout = setTimeout(function(t) {
                                return i.cycle(t)
                            }, 500 + i._config.interval))
                        };
                    p(this._element.querySelectorAll(et)).on(j.DRAG_START, function(t) {
                        return t.preventDefault()
                    }), this._pointerEvent ? (p(this._element).on(j.POINTERDOWN, function(t) {
                        return e(t)
                    }), p(this._element).on(j.POINTERUP, function(t) {
                        return s(t)
                    }), this._element.classList.add(X)) : (p(this._element).on(j.TOUCHSTART, function(t) {
                        return e(t)
                ...
                var o = (n + (t === L ? -1 : 1)) % this._items.length;
                ...
                if (n = t === W ? (i = Q, s = K, R) : (i = V, s = G, $), l && p(l).hasClass(q)) this._isSliding = !1;
                else if (!this._triggerSlideEvent(l, n).isDefaultPrevented() && o && l) {
                    this._isSliding = !0, c && this.pause(), this._setActiveIndicatorElement(l);
                    var d = p.Event(j.SLID, {
                        relatedTarget: l,
                        direction: n,
                        from: r,
                        to: h
                    ...
                    if (p(this._element).hasClass(U)) {
                        p(l).addClass(s), m.reflow(l), p(o).addClass(i), p(l).addClass(i);
                        ...
                        p(o).one(m.TRANSITION_END, function() {
                            p(l).removeClass(i + " " + s).addClass(q), p(o).removeClass(q + " " + s + " " + i), a._isSliding = !1, setTimeout(function() {
                                return p(a._element).trigger(d)
                            }, 0)
                        }).emulateTransitionEnd(f)
                    } else p(o).removeClass(q), p(l).addClass(q), this._isSliding = !1, p(this._element).trigger(d);
                    c && this.cycle()
                }
                ...
                return this.each(function() {
                    ...
                    if (t || (t = new a(this, e), p(this).data(O, t)), "number" == typeof s) t.to(s);
                ...
                if (e) {
                    var i = p(e)[0];
                    if (i && p(i).hasClass(B)) {
                        var s = l({}, p(i).data(), p(this).data()),
                            n = this.getAttribute("data-slide-to");
                        n && (s.interval = !1), a._jQueryInterface.call(p(i), s), n && p(i).data(O).to(n), t.preventDefault()
                    }
                }
            }, o(a, null, [{
                key: "VERSION",
    ...
    p(document).on(j.CLICK_DATA_API, nt, rt._dataApiClickHandler), p(window).on(j.LOAD_DATA_API, function() {
        for (var t = [].slice.call(document.querySelectorAll(at)), e = 0, i = t.length; e < i; e++) {
            var s = p(t[e]);
            rt._jQueryInterface.call(s, s.data())
        }
    }), p.fn[A] = rt._jQueryInterface, p.fn[A].Constructor = rt, p.fn[A].noConflict = function() {
        return p.fn[A] = Y, rt._jQueryInterface
    };
    var lt = "collapse",
        ht = "bs.collapse",
        ct = "." + ht,
        ...
        Ct = function() {
            function r(e, t) {
                ...
                for (var i = [].slice.call(document.querySelectorAll(Dt)), s = 0, n = i.length; s < n; s++) {
                    var a = i[s],
            ...
            return t.toggle = function() {
                ...
                if (!this._isTransitioning && !p(this._element).hasClass(mt) && (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(wt)).filter(function(t) {
                    ...
                    var s = p.Event(pt.SHOW);
                    if (p(this._element).trigger(s), !s.isDefaultPrevented()) {
                        t && (r._jQueryInterface.call(p(t).not(this._selector), "hide"), e || p(t).data(ht, null));
                        var n = this._getDimension();
                        p(this._element).removeClass(gt).addClass(vt), this._element.style[n] = 0, this._triggerArray.length && p(this._triggerArray).removeClass(_t).attr("aria-expanded", !0), this.setTransitioning(!0);
                        var a = "scroll" + (n[0].toUpperCase() + n.slice(1)),
                            o = m.getTransitionDurationFromElement(this._element);
                        p(this._element).one(m.TRANSITION_END, function() {
                            p(i._element).removeClass(vt).addClass(gt).addClass(mt), i._element.style[n] = "", i.setTransitioning(!1), p(i._element).trigger(pt.SHOWN)
                        }).emulateTransitionEnd(o), this._element.style[n] = this._element[a] + "px"
                    }
                }
            }, t.hide = function() {
                var t = this;
                if (!this._isTransitioning && p(this._element).hasClass(mt)) {
                    ...
                    if (p(this._element).trigger(e), !e.isDefaultPrevented()) {
                        ...
                        this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", m.reflow(this._element), p(this._element).addClass(vt).removeClass(gt).removeClass(mt);
                        var s = this._triggerArray.length;
                        if (0 < s)
                            for (var n = 0; n < s; n++) {
                                var a = this._triggerArray[n],
                                    o = m.getSelectorFromElement(a);
                                if (null !== o) p([].slice.call(document.querySelectorAll(o))).hasClass(mt) || p(a).addClass(_t).attr("aria-expanded", !1)
                            }
                ...
                p.removeData(this._element, ht), this._config = null, this._parent = null, this._element = null, this._triggerArray = null, this._isTransitioning = null
            }, t._getConfig = function(t) {
                return (t = l({}, ut, t)).toggle = Boolean(t.toggle), m.typeCheckConfig(lt, t, ft), t
            }, t._getDimension = function() {
                return p(this._element).hasClass(yt) ? yt : bt
                ...
                return p(s).each(function(t, e) {
                    i._addAriaAndCollapsedClass(r._getTargetFromElement(e), [e])
                }), t
            }, t._addAriaAndCollapsedClass = function(t, e) {
                var i = p(t).hasClass(mt);
                e.length && p(e).toggleClass(_t, !i).attr("aria-expanded", i)
                ...
                return this.each(function() {
                    ...
                    if (!e && i.toggle && /show|hide/.test(s) && (i.toggle = !1), e || (e = new r(this, i), t.data(ht, e)), "string" == typeof s) {
    ...
    for (var kt = "undefined" != typeof window && "undefined" != typeof document, xt = ["Edge", "Trident", "Firefox"], St = 0, It = 0; It < xt.length; It += 1)
        if (kt && 0 <= navigator.userAgent.indexOf(xt[It])) {
            St = 1;
            break
        }
    var Tt = kt && window.Promise ? function(t) {
        var e = !1;
        return function() {
    ...
    function At(t) {
        ...
        var e = Et(t),
            ...
            s = e.overflowX,
            n = e.overflowY;
        return /(auto|scroll|overlay)/.test(i + n + s) ? t : At(Pt(t))
    }
    var Ot = kt && !(!window.MSInputMethodContext || !document.documentMode),
        Ft = kt && /MSIE 10/.test(navigator.userAgent);

    function Nt(t) {
        return 11 === t ? Ot : 10 === t ? Ft : Ot || Ft
    }

    function Yt(t) {
        if (!t) return document.documentElement;
        for (var e = Nt(10) ? document.body : null, i = t.offsetParent || null; i === e && t.nextElementSibling;) i = (t = t.nextElementSibling).offsetParent;
        var s = i && i.nodeName;
        return s && "BODY" !== s && "HTML" !== s ? -1 !== ["TH", "TD", "TABLE"].indexOf(i.nodeName) && "static" === Et(i, "position") ? Yt(i) : i : t ? t.ownerDocument.documentElement : document.documentElement
    }
    ...
    function zt(t, e) {
        ...
        a.setStart(s, 0), a.setEnd(n, 0);
        var o, r, l = a.commonAncestorContainer;
        if (t !== l && e !== l || s.contains(n)) return "BODY" === (r = (o = l).nodeName) || "HTML" !== r && Yt(o.firstElementChild) !== o ? Yt(l) : l;
        var h = Ht(t);
        return h.host ? zt(h.host, e) : zt(t, Ht(e).host)
    }
    ...
    function Rt(t, e, i, s) {
        return Math.max(e["offset" + t], e["scroll" + t], i["client" + t], i["offset" + t], i["scroll" + t], Nt(10) ? parseInt(i["offset" + t]) + parseInt(s["margin" + ("Height" === t ? "Top" : "Left")]) + parseInt(s["margin" + ("Height" === t ? "Bottom" : "Right")]) : 0)
    }

    function $t(t) {
        var e = t.body,
            i = t.documentElement,
            s = Nt(10) && getComputedStyle(i);
        return {
    ...
    function Vt(t) {
        ...
        var n = {
            ...
            a = "HTML" === t.nodeName ? $t(t.ownerDocument) : {},
            o = a.width || t.clientWidth || n.right - n.left,
            r = a.height || t.clientHeight || n.bottom - n.top,
            l = t.offsetWidth - o,
            h = t.offsetHeight - r;
        if (l || h) {
            var c = Et(t);
            l -= Lt(c, "x"), h -= Lt(c, "y"), n.width -= l, n.height -= h
        }
        return Ut(n)
    }
    ...
    function Qt(t, e) {
        ...
        i && n && (o.top = Math.max(o.top, 0), o.left = Math.max(o.left, 0));
        var d = Ut({
            top: a.top - o.top - h,
        ...
        if (d.marginTop = 0, d.marginLeft = 0, !s && n) {
            var u = parseFloat(l.marginTop, 10),
                f = parseFloat(l.marginLeft, 10);
            d.top -= h - u, d.bottom -= h - u, d.left -= c - f, d.right -= c - f, d.marginTop = u, d.marginLeft = f
        }
        return (s && !i ? e.contains(r) : e === r && "BODY" !== r.nodeName) && (d = function(t, e) {
            var i = 2 < arguments.length && void 0 !== arguments[2] && arguments[2],
                s = Wt(e, "top"),
                n = Wt(e, "left"),
                a = i ? -1 : 1;
            return t.top += s * a, t.bottom += s * a, t.left += n * a, t.right += n * a, t
        }(d, e)), d
    }
    ...
    function Gt(t, e, i, s) {
        ...
        if ("viewport" === s) a = function(t) {
            ...
            var r = void 0;
            "scrollParent" === s ? "BODY" === (r = At(Pt(e))).nodeName && (r = t.ownerDocument.documentElement) : r = "window" === s ? t.ownerDocument.documentElement : s;
            var l = Qt(r, o, n);
            if ("HTML" !== r.nodeName || function t(e) {
                    var i = e.nodeName;
                    return "BODY" !== i && "HTML" !== i && ("fixed" === Et(e, "position") || t(Pt(e)))
                }(o)) a = l;
            else {
                var h = $t(t.ownerDocument),
                    c = h.height,
                    d = h.width;
                a.top += l.top - l.marginTop, a.bottom = c + l.top, a.left += l.left - l.marginLeft, a.right = d + l.left
            }
        }
        var u = "number" == typeof(i = i || 0);
        return a.left += u ? i : i.left || 0, a.top += u ? i : i.top || 0, a.right -= u ? i : i.right || 0, a.bottom -= u ? i : i.bottom || 0, a
    }

    function Xt(t, e, s, i, n) {
    ...
    function ee(t, e, i) {
        ...
        var s = Jt(t),
            ...
            l = a ? "height" : "width",
            h = a ? "width" : "height";
        return n[o] = e[o] + e[l] / 2 - s[l] / 2, n[r] = i === r ? e[r] - s[h] : e[te(r)], n
    }
    ...
    function se(t, i, e) {
        return (void 0 === e ? t : t.slice(0, function(t, e, i) {
            ...
            t.enabled && Mt(e) && (i.offsets.popper = Ut(i.offsets.popper), i.offsets.reference = Ut(i.offsets.reference), i = e(i, t))
        }), i
    }
    ...
    function re(t, e, i, s) {
        i.updateBound = s, oe(t).addEventListener("resize", i.updateBound, {
            passive: !0
        });
        var n = At(t);
        return function t(e, i, s, n) {
            ...
            o.addEventListener(i, s, {
                passive: !0
            }), a || t(At(o.parentNode), i, s, n), n.push(o)
    ...
    function ce(i, s) {
        Object.keys(s).forEach(function(t) {
            var e = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(t) && he(s[t]) && (e = "px"), i.style[t] = s[t] + e
        })
    }
    var de = kt && /Firefox/i.test(navigator.userAgent);
    ...
    function me(t) {
        var e = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
            i = pe.indexOf(t),
            s = pe.slice(i + 1).concat(pe.slice(0, i));
    ...
    var be = {
            ...
            modifiers: {
                    ...
                    fn: function(t) {
                        ...
                        if (s) {
                            var n = t.offsets,
                                ...
                                c = {
                                    start: Bt({}, l, a[l]),
                                    end: Bt({}, l, a[l] + a[h] - o[h])
                                };
                            t.offsets.popper = qt({}, o, c[s])
                        }
                        return t
                    }
                },
                offset: {
                    ...
                    fn: function(t, e) {
                        var i = e.offset,
                            ...
                            r = s.split("-")[0],
                            l = void 0;
                        return l = he(+i) ? [+i, 0] : ye(i, a, o, r), "left" === r ? (a.top += l[0], a.left -= l[1]) : "right" === r ? (a.top += l[0], a.left += l[1]) : "top" === r ? (a.left += l[0], a.top -= l[1]) : "bottom" === r && (a.left += l[0], a.top += l[1]), t.popper = a, t
                    },
                    offset: 0
                },
                preventOverflow: {
                    ...
                    enabled: !0,
                    fn: function(t, s) {
                        var e = s.boundariesElement || Yt(t.instance.popper);
                        ...
                        var i = ae("transform"),
                            ...
                            r = n[i];
                        n.top = "", n.left = "", n[i] = "";
                        var l = Gt(t.instance.popper, t.instance.reference, s.padding, e, t.positionFixed);
                        ...
                        var h = s.priority,
                            ...
                            d = {
                                primary: function(t) {
                                    var e = c[t];
                                    return c[t] < l[t] && !s.escapeWithReference && (e = Math.max(c[t], l[t])), Bt({}, t, e)
                                },
                                secondary: function(t) {
                                    var e = "right" === t ? "left" : "top",
                                        i = c[e];
                                    return c[t] > l[t] && !s.escapeWithReference && (i = Math.min(c[e], l[t] - ("right" === t ? c.width : c.height))), Bt({}, e, i)
                                }
                            };
                ...
                keepTogether: {
                    ...
                    fn: function(t) {
                        var e = t.offsets,
                            ...
                            l = o ? "left" : "top",
                            h = o ? "width" : "height";
                        return i[r] < a(s[l]) && (t.offsets.popper[l] = a(s[l]) - i[h]), i[l] > a(s[r]) && (t.offsets.popper[l] = a(s[r])), t
                    }
                },
                arrow: {
                    order: 500,
                    ...
                    fn: function(t, e) {
                        ...
                        var n = t.placement.split("-")[0],
                            ...
                            f = l ? "bottom" : "right",
                            p = Jt(s)[h];
                        r[f] - p < o[d] && (t.offsets.popper[d] -= o[d] - (r[f] - p)), r[d] + p > o[f] && (t.offsets.popper[d] += r[d] + p - o[f]), t.offsets.popper = Ut(t.offsets.popper);
                        var m = r[d] + r[h] / 2 - p / 2,
                            g = Et(t.instance.popper),
                            v = parseFloat(g["margin" + c], 10),
                            _ = parseFloat(g["border" + c + "Width"], 10),
                            y = m - t.offsets.popper[d] - v - _;
                        return y = Math.max(Math.min(o[h] - p, y), 0), t.arrowElement = s, t.offsets.arrow = (Bt(i = {}, d, Math.round(y)), Bt(i, u, ""), i), t
                    },
                    element: "[x-arrow]"
                },
                flip: {
                    ...
                    fn: function(p, m) {
                        ...
                        return b.forEach(function(t, e) {
                            ...
                            v = p.placement.split("-")[0], _ = te(v);
                            var i, s = p.offsets.popper,
                                n = p.offsets.reference,
                                a = Math.floor,
                                o = "left" === v && a(s.right) > a(n.left) || "right" === v && a(s.left) < a(n.right) || "top" === v && a(s.bottom) > a(n.top) || "bottom" === v && a(s.top) < a(n.bottom),
                                r = a(s.left) < a(g.left),
                                l = a(s.right) > a(g.right),
                                h = a(s.top) < a(g.top),
                                c = a(s.bottom) > a(g.bottom),
                                d = "left" === v && r || "right" === v && l || "top" === v && h || "bottom" === v && c,
                                u = -1 !== ["top", "bottom"].indexOf(v),
                                f = !!m.flipVariations && (u && "start" === y && r || u && "end" === y && l || !u && "start" === y && h || !u && "end" === y && c);
                            (o || d || f) && (p.flipped = !0, (o || d) && (v = b[e + 1]), f && (y = "end" === (i = y) ? "start" : "start" === i ? "end" : i), p.placement = v + (y ? "-" + y : ""), p.offsets.popper = qt({}, p.offsets.popper, ee(p.instance.popper, p.offsets.reference, p.placement)), p = se(p.instance.modifiers, p, "flip"))
                        }), p
                    },
                    behavior: "flip",
                    padding: 5,
                ...
                inner: {
                    ...
                    fn: function(t) {
                        ...
                        return n[o ? "left" : "top"] = a[i] - (r ? n[o ? "width" : "height"] : 0), t.placement = te(e), t.offsets.popper = Ut(n), t
                    }
                },
                hide: {
                    order: 800,
                    ...
                    fn: function(t) {
                        ...
                        var e = t.offsets.reference,
                            i = ie(t.instance.modifiers, function(t) {
                ...
                computeStyle: {
                    ...
                    fn: function(t, e) {
                        var i = e.x,
                            s = e.y,
                            n = t.offsets.popper,
                            a = ie(t.instance.modifiers, function(t) {
                                return "applyStyle" === t.name
                            }).gpuAcceleration;
                        void 0 !== a && console.warn("WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will not be supported in future versions of Popper.js!");
                        var o, r, l, h, c, d, u, f, p, m, g, v, _ = void 0 !== a ? a : e.gpuAcceleration,
                            y = Yt(t.instance.popper),
                            b = Vt(y),
                            w = {
                                position: n.position
                            },
                            D = (o = t, r = window.devicePixelRatio < 2 || !de, l = o.offsets, h = l.popper, c = l.reference, d = -1 !== ["left", "right"].indexOf(o.placement), u = -1 !== o.placement.indexOf("-"), f = c.width % 2 == h.width % 2, p = c.width % 2 == 1 && h.width % 2 == 1, m = function(t) {
                                return t
                            }, g = r ? d || u || f ? Math.round : Math.floor : m, v = r ? Math.round : m, {
                                left: g(p && !u && r ? h.left - 1 : h.left),
                                top: v(h.top),
                                bottom: v(h.bottom),
                                right: g(h.right)
                            }),
                            C = "bottom" === i ? "top" : "bottom",
                            k = "right" === s ? "left" : "right",
                            x = ae("transform"),
                            S = void 0,
                            I = void 0;
                        if (I = "bottom" === C ? "HTML" === y.nodeName ? -y.clientHeight + D.bottom : -b.height + D.bottom : D.top, S = "right" === k ? "HTML" === y.nodeName ? -y.clientWidth + D.right : -b.width + D.right : D.left, _ && x) w[x] = "translate3d(" + S + "px, " + I + "px, 0)", w[C] = 0, w[k] = 0, w.willChange = "transform";
                        else {
                            var T = "bottom" === C ? -1 : 1,
                                M = "right" === k ? -1 : 1;
                            w[C] = I * T, w[k] = S * M, w.willChange = C + ", " + k
                        }
                        var E = {
                            "x-placement": t.placement
                        };
                        return t.attributes = qt({}, E, t.attributes), t.styles = qt({}, w, t.styles), t.arrowStyles = qt({}, t.offsets.arrow, t.arrowStyles), t
                    },
                    gpuAcceleration: !0,
                    x: "bottom",
                    y: "right"
                ...
                applyStyle: {
                    ...
                    fn: function(t) {
                        var e, i;
                        return ce(t.instance.popper, t.styles), e = t.instance.popper, i = t.attributes, Object.keys(i).forEach(function(t) {
                            !1 !== i[t] ? e.setAttribute(t, i[t]) : e.removeAttribute(t)
                        }), t.arrowElement && Object.keys(t.arrowStyles).length && ce(t.arrowElement, t.arrowStyles), t
                    },
                    onLoad: function(t, e, i, s, n) {
                        var a = Zt(n, e, t, i.positionFixed),
                            o = Xt(i.placement, a, e, t, i.modifiers.flip.boundariesElement, i.modifiers.flip.padding);
                        return e.setAttribute("x-placement", o), ce(e, {
        ...
        we = function() {
            function a(t, e) {
                ...
                }, this.update = Tt(this.update.bind(this)), this.options = qt({}, a.Defaults, s), this.state = {
                    isDestroyed: !1,
                    isCreated: !1,
                    scrollParents: []
                }, this.reference = t && t.jquery ? t[0] : t, this.popper = e && e.jquery ? e[0] : e, this.options.modifiers = {}, Object.keys(qt({}, a.Defaults.modifiers, s.modifiers)).forEach(function(t) {
                    i.options.modifiers[t] = qt({}, a.Defaults.modifiers[t] || {}, s.modifiers ? s.modifiers[t] : {})
                ...
                value: function() {
                    return function() {
                        if (!this.state.isDestroyed) {
                            ...
                            t.offsets.reference = Zt(this.state, this.popper, this.reference, this.options.positionFixed), t.placement = Xt(this.options.placement, t.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), t.originalPlacement = t.placement, t.positionFixed = this.options.positionFixed, t.offsets.popper = ee(this.popper, t.offsets.reference, t.placement), t.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", t = se(this.modifiers, t), this.state.isCreated ? this.options.onUpdate(t) : (this.state.isCreated = !0, this.options.onCreate(t))
                        }
                    }.call(this)
                }
            }, {
    ...
    we.Utils = ("undefined" != typeof window ? window : global).PopperUtils, we.placements = fe, we.Defaults = be;
    var De = "dropdown",
        Ce = "bs.dropdown",
        ke = "." + Ce,
        xe = ".data-api",
        ...
        Te = {
            ...
            SHOWN: "shown" + ke,
            CLICK: "click" + ke,
            CLICK_DATA_API: "click" + ke + xe,
            KEYDOWN_DATA_API: "keydown" + ke + xe,
            KEYUP_DATA_API: "keyup" + ke + xe
        },
        Me = "disabled",
        Ee = "show",
        Pe = "dropup",
            ...
            return t.toggle = function() {
                if (!this._element.disabled && !p(this._element).hasClass(Me)) {
                    var t = h._getParentFromElement(this._element),
                        e = p(this._menu).hasClass(Ee);
                    if (h._clearMenus(), !e) {
                        var i = {
                                relatedTarget: this._element
                            },
                            s = p.Event(Te.SHOW, i);
                        if (p(t).trigger(s), !s.isDefaultPrevented()) {
                            if (!this._inNavbar) {
                                if (void 0 === we) throw new TypeError("Bootstrap's dropdowns require Popper.js (https://popper.js.org/)");
                                var n = this._element;
                                "parent" === this._config.reference ? n = t : m.isElement(this._config.reference) && (n = this._config.reference, void 0 !== this._config.reference.jquery && (n = this._config.reference[0])), "scrollParent" !== this._config.boundary && p(t).addClass(Ne), this._popper = new we(n, this._menu, this._getPopperConfig())
                            }
                            "ontouchstart" in document.documentElement && 0 === p(t).closest(We).length && p(document.body).children().on("mouseover", null, p.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), p(this._menu).toggleClass(Ee), p(t).toggleClass(Ee).trigger(p.Event(Te.SHOWN, i))
                        }
                    }
                }
            }, t.show = function() {
                if (!(this._element.disabled || p(this._element).hasClass(Me) || p(this._menu).hasClass(Ee))) {
                    var t = {
                            relatedTarget: this._element
                        },
                        e = p.Event(Te.SHOW, t),
                        i = h._getParentFromElement(this._element);
                    p(i).trigger(e), e.isDefaultPrevented() || (p(this._menu).toggleClass(Ee), p(i).toggleClass(Ee).trigger(p.Event(Te.SHOWN, t)))
                }
            }, t.hide = function() {
                if (!this._element.disabled && !p(this._element).hasClass(Me) && p(this._menu).hasClass(Ee)) {
                    var t = {
                        ...
                        e = p.Event(Te.HIDE, t),
                        i = h._getParentFromElement(this._element);
                    p(i).trigger(e), e.isDefaultPrevented() || (p(this._menu).toggleClass(Ee), p(i).toggleClass(Ee).trigger(p.Event(Te.HIDDEN, t)))
                }
            }, t.dispose = function() {
                p.removeData(this._element, Ce), p(this._element).off(ke), this._element = null, (this._menu = null) !== this._popper && (this._popper.destroy(), this._popper = null)
            }, t.update = function() {
                this._inNavbar = this._detectNavbar(), null !== this._popper && this._popper.scheduleUpdate()
            }, t._addEventListeners = function() {
                var e = this;
                p(this._element).on(Te.CLICK, function(t) {
                ...
                if (!this._menu) {
                    var t = h._getParentFromElement(this._element);
                    t && (this._menu = t.querySelector(ze))
                }
                return this._menu
            }, t._getPlacement = function() {
                var t = p(this._element.parentNode),
                    e = je;
                return t.hasClass(Pe) ? (e = Re, p(this._menu).hasClass(Fe) && (e = $e)) : t.hasClass(Ae) ? e = qe : t.hasClass(Oe) ? e = Ue : p(this._menu).hasClass(Fe) && (e = Be), e
                ...
                return this.each(function() {
                    ...
                    if (t || (t = new h(this, "object" == typeof e ? e : null), p(this).data(Ce, t)), "string" == typeof e) {
                ...
                if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which))
                    for (var e = [].slice.call(document.querySelectorAll(Ye)), i = 0, s = e.length; i < s; i++) {
                        var n = h._getParentFromElement(e[i]),
                            a = p(e[i]).data(Ce),
                            o = {
                                relatedTarget: e[i]
                            };
                        if (t && "click" === t.type && (o.clickEvent = t), a) {
                            var r = a._menu;
                            if (p(n).hasClass(Ee) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && p.contains(n, t.target))) {
                                var l = p.Event(Te.HIDE, o);
                                p(n).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), e[i].setAttribute("aria-expanded", "false"), p(r).removeClass(Ee), p(n).removeClass(Ee).trigger(p.Event(Te.HIDDEN, o)))
                            }
                        }
                    }
                ...
                if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || p(t.target).closest(ze).length)) : Ie.test(t.which)) && (t.preventDefault(), t.stopPropagation(), !this.disabled && !p(this).hasClass(Me))) {
                    var e = h._getParentFromElement(this),
                        i = p(e).hasClass(Ee);
                    if (i && (!i || 27 !== t.which && 32 !== t.which)) {
                        var s = [].slice.call(e.querySelectorAll(Le));
                        if (0 !== s.length) {
    ...
    p(document).on(Te.KEYDOWN_DATA_API, Ye, Ke._dataApiKeydownHandler).on(Te.KEYDOWN_DATA_API, ze, Ke._dataApiKeydownHandler).on(Te.CLICK_DATA_API + " " + Te.KEYUP_DATA_API, Ke._clearMenus).on(Te.CLICK_DATA_API, Ye, function(t) {
        t.preventDefault(), t.stopPropagation(), Ke._jQueryInterface.call(p(this), "toggle")
    }).on(Te.CLICK_DATA_API, He, function(t) {
        t.stopPropagation()
    ...
    var Ge = "modal",
        ...
        ri = "show",
        li = ".modal-dialog",
        hi = '[data-toggle="modal"]',
        ci = '[data-dismiss="modal"]',
        di = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",
        ui = ".sticky-top",
        fi = function() {
            function n(t, e) {
                this._config = this._getConfig(e), this._element = t, this._dialog = t.querySelector(li), this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._isTransitioning = !1, this._scrollbarWidth = 0
            }
            var t = n.prototype;
            return t.toggle = function(t) {
                ...
                if (!this._isShown && !this._isTransitioning) {
                    p(this._element).hasClass(oi) && (this._isTransitioning = !0);
                    var i = p.Event(ii.SHOW, {
                        relatedTarget: t
                    });
                    p(this._element).trigger(i), this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), p(this._element).on(ii.CLICK_DISMISS, ci, function(t) {
                        return e.hide(t)
                    }), p(this._dialog).on(ii.MOUSEDOWN_DISMISS, function() {
                        p(e._element).one(ii.MOUSEUP_DISMISS, function(t) {
                ...
                if (t && t.preventDefault(), this._isShown && !this._isTransitioning) {
                    var i = p.Event(ii.HIDE);
                    if (p(this._element).trigger(i), this._isShown && !i.isDefaultPrevented()) {
                        this._isShown = !1;
                        var s = p(this._element).hasClass(oi);
                        if (s && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), p(document).off(ii.FOCUSIN), p(this._element).removeClass(ri), p(this._element).off(ii.CLICK_DISMISS), p(this._dialog).off(ii.MOUSEDOWN_DISMISS), s) {
                ...
                [window, this._element, this._dialog].forEach(function(t) {
                    return p(t).off(Ze)
                }), p(document).off(ii.FOCUSIN), p.removeData(this._element, Xe), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
            }, t.handleUpdate = function() {
                this._adjustDialog()
            }, t._getConfig = function(t) {
                return t = l({}, ti, t), m.typeCheckConfig(Ge, t, ei), t
            }, t._showElement = function(t) {
                var e = this,
                    i = p(this._element).hasClass(oi);
                ...
                if (i) {
                    ...
                    p(this._dialog).one(m.TRANSITION_END, n).emulateTransitionEnd(a)
                } else n()
            }, t._enforceFocus = function() {
                var e = this;
                p(document).off(ii.FOCUSIN).on(ii.FOCUSIN, function(t) {
                    document !== t.target && e._element !== t.target && 0 === p(e._element).has(t.target).length && e._element.focus()
                })
            }, t._setEscapeEvent = function() {
                var e = this;
                this._isShown && this._config.keyboard ? p(this._element).on(ii.KEYDOWN_DISMISS, function(t) {
                    27 === t.which && (t.preventDefault(), e.hide())
                }) : this._isShown || p(this._element).off(ii.KEYDOWN_DISMISS)
            }, t._setResizeEvent = function() {
                var e = this;
                this._isShown ? p(window).on(ii.RESIZE, function(t) {
                    return e.handleUpdate(t)
                }) : p(window).off(ii.RESIZE)
            }, t._hideModal = function() {
                var t = this;
                this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._isTransitioning = !1, this._showBackdrop(function() {
                    p(document.body).removeClass(ai), t._resetAdjustments(), t._resetScrollbar(), p(t._element).trigger(ii.HIDDEN)
                })
            }, t._removeBackdrop = function() {
                this._backdrop && (p(this._backdrop).remove(), this._backdrop = null)
            }, t._showBackdrop = function(t) {
                var e = this,
                    i = p(this._element).hasClass(oi) ? oi : "";
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = ni, i && this._backdrop.classList.add(i), p(this._backdrop).appendTo(document.body), p(this._element).on(ii.CLICK_DISMISS, function(t) {
                            e._ignoreBackdropClick ? e._ignoreBackdropClick = !1 : t.target === t.currentTarget && ("static" === e._config.backdrop ? e._element.focus() : e.hide())
                        }), i && m.reflow(this._backdrop), p(this._backdrop).addClass(ri), !t) return;
                    if (!i) return void t();
                    var s = m.getTransitionDurationFromElement(this._backdrop);
                    p(this._backdrop).one(m.TRANSITION_END, t).emulateTransitionEnd(s)
                } else if (!this._isShown && this._backdrop) {
                    p(this._backdrop).removeClass(ri);
                    var n = function() {
                        e._removeBackdrop(), t && t()
                    };
                    if (p(this._element).hasClass(oi)) {
                        var a = m.getTransitionDurationFromElement(this._backdrop);
                        p(this._backdrop).one(m.TRANSITION_END, n).emulateTransitionEnd(a)
                    } else n()
                } else t && t()
                ...
                if (this._isBodyOverflowing) {
                    var t = [].slice.call(document.querySelectorAll(di)),
                        e = [].slice.call(document.querySelectorAll(ui));
                    p(t).each(function(t, e) {
                        var i = e.style.paddingRight,
                            s = p(e).css("padding-right");
                        p(e).data("padding-right", i).css("padding-right", parseFloat(s) + n._scrollbarWidth + "px")
                    }), p(e).each(function(t, e) {
                        var i = e.style.marginRight,
                            s = p(e).css("margin-right");
                        p(e).data("margin-right", i).css("margin-right", parseFloat(s) - n._scrollbarWidth + "px")
                    });
                    var i = document.body.style.paddingRight,
                        s = p(document.body).css("padding-right");
                    p(document.body).data("padding-right", i).css("padding-right", parseFloat(s) + this._scrollbarWidth + "px")
                }
                p(document.body).addClass(ai)
                ...
                var e = [].slice.call(document.querySelectorAll("" + ui));
                p(e).each(function(t, e) {
                ...
                return this.each(function() {
                    var t = p(this).data(Xe),
                        e = l({}, ti, p(this).data(), "object" == typeof i && i ? i : {});
                    if (t || (t = new n(this, e), p(this).data(Xe, t)), "string" == typeof i) {
                        if (void 0 === t[i]) throw new TypeError('No method named "' + i + '"');
                        t[i](s)
    ...
    p(document).on(ii.CLICK_DATA_API, hi, function(t) {
        var e, i = this,
            s = m.getSelectorFromElement(this);
        s && (e = document.querySelector(s));
        var n = p(e).data(Xe) ? "toggle" : l({}, p(e).data(), p(this).data());
        "A" !== this.tagName && "AREA" !== this.tagName || t.preventDefault();
        var a = p(e).one(ii.SHOW, function(t) {
            t.isDefaultPrevented() || a.one(ii.HIDDEN, function() {
                p(i).is(":visible") && i.focus()
            })
        });
        fi._jQueryInterface.call(p(e), n, this)
    }), p.fn[Ge] = fi._jQueryInterface, p.fn[Ge].Constructor = fi, p.fn[Ge].noConflict = function() {
        return p.fn[Ge] = Je, fi._jQueryInterface
    };
    var pi = "tooltip",
        mi = "bs.tooltip",
        gi = "." + mi,
            ...
            return t.enable = function() {
                ...
                if (this._isEnabled)
                    if (t) {
                        ...
                        if (p(this.getTipElement()).hasClass(Ii)) return void this._leave(null, this);
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    var i = m.findShadowRoot(this.element),
                        s = p.contains(null !== i ? i : this.element.ownerDocument.documentElement, this.element);
                    if (t.isDefaultPrevented() || !s) return;
                    var n = this.getTipElement(),
                        a = m.getUID(this.constructor.NAME);
                    n.setAttribute("id", a), this.element.setAttribute("aria-describedby", a), this.setContent(), this.config.animation && p(n).addClass(Si);
                    ...
                    p(n).data(this.constructor.DATA_KEY, this), p.contains(this.element.ownerDocument.documentElement, this.tip) || p(n).appendTo(l), p(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new we(this.element, n, {
                        placement: r,
                        modifiers: {
                            offset: {
                    ...
                    }), p(n).addClass(Ii), "ontouchstart" in document.documentElement && p(document.body).children().on("mouseover", null, p.noop);
                    var h = function() {
                        e.config.animation && e._fixTransition();
                        var t = e._hoverState;
                        e._hoverState = null, p(e.element).trigger(e.constructor.Event.SHOWN), t === ki && e._leave(null, e)
                    };
                    if (p(this.tip).hasClass(Si)) {
                ...
                var e = this,
                    ...
                    n = function() {
                        e._hoverState !== Ci && i.parentNode && i.parentNode.removeChild(i), e._cleanTipClass(), e.element.removeAttribute("aria-describedby"), p(e.element).trigger(e.constructor.Event.HIDDEN), null !== e._popper && e._popper.destroy(), t && t()
                    };
                if (p(this.element).trigger(s), !s.isDefaultPrevented()) {
                    if (p(i).removeClass(Ii), "ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), this._activeTrigger[Ai] = !1, this._activeTrigger[Pi] = !1, this._activeTrigger[Ei] = !1, p(this.tip).hasClass(Si)) {
                        var a = m.getTransitionDurationFromElement(i);
                        p(i).one(m.TRANSITION_END, n).emulateTransitionEnd(a)
                    } else n();
                    this._hoverState = ""
                }
            }, t.update = function() {
                ...
                p(this.getTipElement()).addClass(_i + "-" + t)
            }, t.getTipElement = function() {
                return this.tip = this.tip || p(this.config.template)[0], this.tip
            }, t.setContent = function() {
                var t = this.getTipElement();
                this.setElementContent(p(t.querySelectorAll(Ti)), this.getTitle()), p(t).removeClass(Si + " " + Ii)
            }, t.setElementContent = function(t, e) {
                var i = this.config.html;
                "object" == typeof e && (e.nodeType || e.jquery) ? i ? p(e).parent().is(t) || t.empty().append(e) : t.text(p(e).text()) : t[i ? "html" : "text"](e)
            }, t.getTitle = function() {
                ...
                this.config.trigger.split(" ").forEach(function(t) {
                    if ("click" === t) p(s.element).on(s.constructor.Event.CLICK, s.config.selector, function(t) {
                        return s.toggle(t)
                    });
                    else if (t !== Oi) {
                        var e = t === Ei ? s.constructor.Event.MOUSEENTER : s.constructor.Event.FOCUSIN,
                            i = t === Ei ? s.constructor.Event.MOUSELEAVE : s.constructor.Event.FOCUSOUT;
                        p(s.element).on(e, s.config.selector, function(t) {
                            return s._enter(t)
                ...
                var i = this.constructor.DATA_KEY;
                (e = e || p(t.currentTarget).data(i)) || (e = new this.constructor(t.currentTarget, this._getDelegateConfig()), p(t.currentTarget).data(i, e)), t && (e._activeTrigger["focusout" === t.type ? Pi : Ei] = !1), e._isWithActiveTrigger() || (clearTimeout(e._timeout), e._hoverState = ki, e.config.delay && e.config.delay.hide ? e._timeout = setTimeout(function() {
                ...
                return "number" == typeof(t = l({}, this.constructor.Default, p(this.element).data(), "object" == typeof t && t ? t : {})).delay && (t.delay = {
                    show: t.delay,
                    hide: t.delay
                }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), m.typeCheckConfig(pi, t, this.constructor.DefaultType), t
                ...
                null === t.getAttribute("x-placement") && (p(t).removeClass(Si), this.config.animation = !1, this.hide(), this.show(), this.config.animation = e)
            }, s._jQueryInterface = function(i) {
                return this.each(function() {
                    var t = p(this).data(mi),
                        e = "object" == typeof i && i;
                    if ((t || !/dispose|hide/.test(i)) && (t || (t = new s(this, e), p(this).data(mi, t)), "string" == typeof i)) {
                        if (void 0 === t[i]) throw new TypeError('No method named "' + i + '"');
                        t[i]()
                    }
                })
    ...
    p.fn[pi] = Fi._jQueryInterface, p.fn[pi].Constructor = Fi, p.fn[pi].noConflict = function() {
        return p.fn[pi] = vi, Fi._jQueryInterface
    };
    var Ni = "popover",
        Yi = "bs.popover",
        Hi = "." + Yi,
        ...
        Qi = function(t) {
            ...
            return n.isWithContent = function() {
                ...
                p(this.getTipElement()).addClass(Wi + "-" + t)
            }, n.getTipElement = function() {
                return this.tip = this.tip || p(this.config.template)[0], this.tip
            }, n.setContent = function() {
                var t = p(this.getTipElement());
                this.setElementContent(t.find(qi), this.getTitle());
                var e = this._getContent();
                "function" == typeof e && (e = e.call(this.element)), this.setElementContent(t.find(Ui), e), t.removeClass(ji + " " + Bi)
            }, n._getContent = function() {
                return this.element.getAttribute("data-content") || this.config.content
            }, n._cleanTipClass = function() {
                var t = p(this.getTipElement()),
                    e = t.attr("class").match(Li);
                null !== e && 0 < e.length && t.removeClass(e.join(""))
            }, s._jQueryInterface = function(i) {
                return this.each(function() {
                    var t = p(this).data(Yi),
                        e = "object" == typeof i ? i : null;
                    if ((t || !/dispose|hide/.test(i)) && (t || (t = new s(this, e), p(this).data(Yi, t)), "string" == typeof i)) {
                        if (void 0 === t[i]) throw new TypeError('No method named "' + i + '"');
                        t[i]()
                    }
                })
    ...
    p.fn[Ni] = Qi._jQueryInterface, p.fn[Ni].Constructor = Qi, p.fn[Ni].noConflict = function() {
        return p.fn[Ni] = zi, Qi._jQueryInterface
    };
    var Ki = "scrollspy",
        Gi = "bs.scrollspy",
        Xi = "." + Gi,
        ...
        es = {
            ACTIVATE: "activate" + Xi,
            SCROLL: "scroll" + Xi,
            LOAD_DATA_API: "load" + Xi + ".data-api"
        },
        is = "dropdown-item",
        ss = "active",
        ns = '[data-spy="scroll"]',
        ...
        ps = function() {
            function i(t, e) {
                var i = this;
                this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(e), this._selector = this._config.target + " " + os + "," + this._config.target + " " + ls + "," + this._config.target + " " + cs, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, p(this._scrollElement).on(es.SCROLL, function(t) {
                    return i._process(t)
            ...
            return t.refresh = function() {
                var e = this,
                    t = this._scrollElement === this._scrollElement.window ? us : fs,
                    n = "auto" === this._config.method ? t : this._config.method,
                    a = n === fs ? this._getScrollTop() : 0;
                this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), [].slice.call(document.querySelectorAll(this._selector)).map(function(t) {
                    var e, i = m.getSelectorFromElement(t);
                    if (i && (e = document.querySelector(i)), e) {
                        var s = e.getBoundingClientRect();
                        if (s.width || s.height) return [p(e)[n]().top + a, i]
                    }
                    return null
                }).filter(function(t) {
                    return t
                ...
                p.removeData(this._element, Gi), p(this._scrollElement).off(Xi), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
            }, t._getConfig = function(t) {
                if ("string" != typeof(t = l({}, Ji, "object" == typeof t && t ? t : {})).target) {
                    var e = p(t.target).attr("id");
                    e || (e = m.getUID(Ki), p(t.target).attr("id", e)), t.target = "#" + e
                }
                return m.typeCheckConfig(Ki, t, ts), t
                ...
                i.hasClass(is) ? (i.closest(hs).find(ds).addClass(ss), i.addClass(ss)) : (i.addClass(ss), i.parents(as).prev(os + ", " + ls).addClass(ss), i.parents(as).prev(rs).children(os).addClass(ss)), p(this._scrollElement).trigger(es.ACTIVATE, {
                    relatedTarget: e
                })
            }, t._clear = function() {
                [].slice.call(document.querySelectorAll(this._selector)).filter(function(t) {
                    ...
                    return t.classList.remove(ss)
                })
            }, i._jQueryInterface = function(e) {
                return this.each(function() {
                    var t = p(this).data(Gi);
                    if (t || (t = new i(this, "object" == typeof e && e), p(this).data(Gi, t)), "string" == typeof e) {
                        if (void 0 === t[e]) throw new TypeError('No method named "' + e + '"');
                        t[e]()
                    }
                })
    ...
    p(window).on(es.LOAD_DATA_API, function() {
        for (var t = [].slice.call(document.querySelectorAll(ns)), e = t.length; e--;) {
            var i = p(t[e]);
            ps._jQueryInterface.call(i, i.data())
        }
    }), p.fn[Ki] = ps._jQueryInterface, p.fn[Ki].Constructor = ps, p.fn[Ki].noConflict = function() {
        return p.fn[Ki] = Zi, ps._jQueryInterface
    };
    var ms = "bs.tab",
        gs = "." + ms,
        vs = p.fn.tab,
        _s = {
            ...
            SHOW: "show" + gs,
            SHOWN: "shown" + gs,
            CLICK_DATA_API: "click" + gs + ".data-api"
        },
        ys = "dropdown-menu",
        bs = "active",
        ws = "disabled",
        ...
        Ss = ".active",
        Is = "> li > .active",
        Ts = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]',
        Ms = ".dropdown-toggle",
        Es = "> .dropdown-menu .active",
        Ps = function() {
            function s(t) {
                this._element = t
            }
            ...
            return t.show = function() {
                var i = this;
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(bs) || p(this._element).hasClass(ws))) {
                    var t, s, e = p(this._element).closest(xs)[0],
                        n = m.getSelectorFromElement(this._element);
                    if (e) {
                        var a = "UL" === e.nodeName || "OL" === e.nodeName ? Is : Ss;
                        s = (s = p.makeArray(p(e).find(a)))[s.length - 1]
                    }
                    var o = p.Event(_s.HIDE, {
                            relatedTarget: this._element
                        }),
                        r = p.Event(_s.SHOW, {
                            relatedTarget: s
                        });
                    if (s && p(s).trigger(o), p(this._element).trigger(r), !r.isDefaultPrevented() && !o.isDefaultPrevented()) {
                        n && (t = document.querySelector(n)), this._activate(this._element, e);
                        var l = function() {
                            var t = p.Event(_s.HIDDEN, {
                                    relatedTarget: i._element
                                }),
                                e = p.Event(_s.SHOWN, {
                                    relatedTarget: s
                                });
                            p(s).trigger(t), p(i._element).trigger(e)
                        };
                        t ? this._activate(t, t.parentNode, l) : l()
                    }
                }
            }, t.dispose = function() {
                p.removeData(this._element, ms), this._element = null
            }, t._activate = function(t, e, i) {
                var s = this,
                    n = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? p(e).children(Ss) : p(e).find(Is))[0],
                    a = i && n && p(n).hasClass(Ds),
                    o = function() {
                        return s._transitionComplete(t, n, i)
                    };
                if (n && a) {
                    var r = m.getTransitionDurationFromElement(n);
                    p(n).removeClass(Cs).one(m.TRANSITION_END, o).emulateTransitionEnd(r)
                } else o()
            }, t._transitionComplete = function(t, e, i) {
                if (e) {
                    p(e).removeClass(bs);
                    var s = p(e.parentNode).find(Es)[0];
                    s && p(s).removeClass(bs), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1)
                }
                if (p(t).addClass(bs), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), m.reflow(t), p(t).addClass(Cs), t.parentNode && p(t.parentNode).hasClass(ys)) {
                    var n = p(t).closest(ks)[0];
                    if (n) {
                        var a = [].slice.call(n.querySelectorAll(Ms));
                        p(a).addClass(bs)
                    }
                ...
                return this.each(function() {
                    var t = p(this),
                        e = t.data(ms);
                    if (e || (e = new s(this), t.data(ms, e)), "string" == typeof i) {
    ...
    p(document).on(_s.CLICK_DATA_API, Ts, function(t) {
        t.preventDefault(), Ps._jQueryInterface.call(p(this), "show")
    }), p.fn.tab = Ps._jQueryInterface, p.fn.tab.Constructor = Ps, p.fn.tab.noConflict = function() {
        return p.fn.tab = vs, Ps._jQueryInterface
    };
    var As = "toast",
        Os = "bs.toast",
        Fs = "." + Os,
        Ns = p.fn[As],
        Ys = {
            CLICK_DISMISS: "click.dismiss" + Fs,
            HIDE: "hide" + Fs,
            HIDDEN: "hidden" + Fs,
            SHOW: "show" + Fs,
            SHOWN: "shown" + Fs
        ...
        Bs = function() {
            ...
            return t.show = function() {
                var t = this;
                p(this._element).trigger(Ys.SHOW), this._config.animation && this._element.classList.add(Hs);
                var e = function() {
                    t._element.classList.remove(Ls), t._element.classList.add(Ws), p(t._element).trigger(Ys.SHOWN), t._config.autohide && t.hide()
                };
                if (this._element.classList.remove(zs), this._element.classList.add(Ls), this._config.animation) {
                    var i = m.getTransitionDurationFromElement(this._element);
                    p(this._element).one(m.TRANSITION_END, e).emulateTransitionEnd(i)
                } else e()
            }, t.hide = function(t) {
                var e = this;
                this._element.classList.contains(Ws) && (p(this._element).trigger(Ys.HIDE), t ? this._close() : this._timeout = setTimeout(function() {
                    e._close()
                }, this._config.delay))
            }, t.dispose = function() {
                clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(Ws) && this._element.classList.remove(Ws), p(this._element).off(Ys.CLICK_DISMISS), p.removeData(this._element, Os), this._element = null, this._config = null
            }, t._getConfig = function(t) {
                return t = l({}, $s, p(this._element).data(), "object" == typeof t && t ? t : {}), m.typeCheckConfig(As, t, this.constructor.DefaultType), t
            }, t._setListeners = function() {
                var t = this;
                p(this._element).on(Ys.CLICK_DISMISS, js, function() {
                    return t.hide(!0)
                })
            }, t._close = function() {
                var t = this,
                    e = function() {
                        t._element.classList.add(zs), p(t._element).trigger(Ys.HIDDEN)
                    };
                if (this._element.classList.remove(Ws), this._config.animation) {
                    var i = m.getTransitionDurationFromElement(this._element);
                    p(this._element).one(m.TRANSITION_END, e).emulateTransitionEnd(i)
                } else e()
            }, s._jQueryInterface = function(i) {
                return this.each(function() {
                    var t = p(this),
                        e = t.data(Os);
                    if (e || (e = new s(this, "object" == typeof i && i), t.data(Os, e)), "string" == typeof i) {
                        if (void 0 === e[i]) throw new TypeError('No method named "' + i + '"');
                        e[i](this)
                    }
                })
    ...
    p.fn[As] = Bs._jQueryInterface, p.fn[As].Constructor = Bs, p.fn[As].noConflict = function() {
            return p.fn[As] = Ns, Bs._jQueryInterface
        },
        function() {
            if (void 0 === p) throw new TypeError("Bootstrap's JavaScript requires jQuery. jQuery must be included before Bootstrap's JavaScript.");
            var t = p.fn.jquery.split(" ")[0].split(".");
            if (t[0] < 2 && t[1] < 9 || 1 === t[0] && 9 === t[1] && t[2] < 1 || 4 <= t[0]) throw new Error("Bootstrap's JavaScript requires at least jQuery v1.9.1 but less than v4.0.0")
        }(), t.Util = m, t.Alert = g, t.Button = P, t.Carousel = rt, t.Collapse = Ct, t.Dropdown = Ke, t.Modal = fi, t.Popover = Qi, t.Scrollspy = ps, t.Tab = Ps, t.Toast = Bs, t.Tooltip = Fi, Object.defineProperty(t, "__esModule", {
            value: !0
        })
}),
function(r, t) {
    function s(t, e) {
        ...
        if ("area" !== i) return (/input|select|textarea|button|object/.test(i) ? !t.disabled : "a" == i && t.href || e) && o(t);
        var s, n = t.parentNode,
            a = n.name;
        return !(!t.href || !a || "map" !== n.nodeName.toLowerCase()) && (!!(s = r("img[usemap=#" + a + "]")[0]) && o(s))
    }
    ...
    r.ui = r.ui || {}, r.ui.version || (r.extend(r.ui, {
        ...
        scrollParent: function() {
            var t;
            return t = r.browser.msie && /(static|relative)/.test(this.css("position")) || /absolute/.test(this.css("position")) ? this.parents().filter(function() {
...
function(o, t) {
    ...
    o.widget = function(e, t, i) {
        var s, n = e.split(".")[0];
        s = n + "-" + (e = e.split(".")[1]), i || (i = t, t = o.Widget), o.expr[":"][s] = function(t) {
            return !!o.data(t, e)
        }, o[n] = o[n] || {}, o[n][e] = function(t, e) {
            arguments.length && this._createWidget(t, e)
        };
        var a = new t;
        a.options = o.extend(!0, {}, a.options), o[n][e].prototype = o.extend(!0, a, {
            namespace: n,
            widgetName: e,
            widgetEventPrefix: o[n][e].prototype.widgetEventPrefix || e,
            widgetBaseClass: s
        }, i), o.widget.bridge(e, o[n][e])
        ...
        _mouseDown: function(t) {
            if (!a) {
                ...
                return i && !s && this._mouseCapture(t) && (this.mouseDelayMet = !this.options.delay, this.mouseDelayMet || (this._mouseDelayTimer = setTimeout(function() {
                    ...
                    return e._mouseUp(t)
                }, n(document).bind("mousemove." + this.widgetName, this._mouseMoveDelegate).bind("mouseup." + this.widgetName, this._mouseUpDelegate), t.preventDefault(), a = !0)), !0
            }
        },
...
function(y, t) {
    y.widget("ui.draggable", y.ui.mouse, {
        ...
        _mouseCapture: function(t) {
            var e = this.options;
            return !(this.helper || e.disabled || y(t.target).is(".ui-resizable-handle")) && (this.handle = this._getHandle(t), !!this.handle && (e.iframeFix && y(!0 === e.iframeFix ? "iframe" : e.iframeFix).each(function() {
        ...
        _mouseUp: function(t) {
            return !0 === this.options.iframeFix && y("div.ui-draggable-iframeFix").each(function() {
        ...
        _convertPositionTo: function(t, e) {
            ...
            var i = "absolute" == t ? 1 : -1,
                s = (this.options, "absolute" != this.cssPosition || this.scrollParent[0] != document && y.ui.contains(this.scrollParent[0], this.offsetParent[0]) ? this.scrollParent : this.offsetParent),
                n = /(html|body)/i.test(s[0].tagName);
            return {
                top: e.top + this.offset.relative.top * i + this.offset.parent.top * i - (y.browser.safari && y.browser.version < 526 && "fixed" == this.cssPosition ? 0 : ("fixed" == this.cssPosition ? -this.scrollParent.scrollTop() : n ? 0 : s.scrollTop()) * i),
                left: e.left + this.offset.relative.left * i + this.offset.parent.left * i - (y.browser.safari && y.browser.version < 526 && "fixed" == this.cssPosition ? 0 : ("fixed" == this.cssPosition ? -this.scrollParent.scrollLeft() : n ? 0 : s.scrollLeft()) * i)
            }
        },
        _generatePosition: function(t) {
            ...
            if (this.originalPosition) {
                ...
                if (this.containment) {
                    ...
                    t.pageX - this.offset.click.left < o[0] && (n = o[0] + this.offset.click.left), t.pageY - this.offset.click.top < o[1] && (a = o[1] + this.offset.click.top), t.pageX - this.offset.click.left > o[2] && (n = o[2] + this.offset.click.left), t.pageY - this.offset.click.top > o[3] && (a = o[3] + this.offset.click.top)
                }
                if (e.grid) {
                    var l = e.grid[1] ? this.originalPageY + Math.round((a - this.originalPageY) / e.grid[1]) * e.grid[1] : this.originalPageY;
                    a = o && (l - this.offset.click.top < o[1] || l - this.offset.click.top > o[3]) ? l - this.offset.click.top < o[1] ? l + e.grid[1] : l - e.grid[1] : l;
                    var h = e.grid[0] ? this.originalPageX + Math.round((n - this.originalPageX) / e.grid[0]) * e.grid[0] : this.originalPageX;
                    n = o && (h - this.offset.click.left < o[0] || h - this.offset.click.left > o[2]) ? h - this.offset.click.left < o[0] ? h + e.grid[0] : h - e.grid[0] : h
                }
            }
            return {
                top: a - this.offset.click.top - this.offset.relative.top - this.offset.parent.top + (y.browser.safari && y.browser.version < 526 && "fixed" == this.cssPosition ? 0 : "fixed" == this.cssPosition ? -this.scrollParent.scrollTop() : s ? 0 : i.scrollTop()),
                left: n - this.offset.click.left - this.offset.relative.left - this.offset.parent.left + (y.browser.safari && y.browser.version < 526 && "fixed" == this.cssPosition ? 0 : "fixed" == this.cssPosition ? -this.scrollParent.scrollLeft() : s ? 0 : i.scrollLeft())
            }
        },
        _clear: function() {
        ...
        drag: function(e, i) {
            var s = y(this).data("draggable"),
                n = this;
            y.each(s.sortables, function(t) {
        ...
        drag: function(t, e) {
            for (var i = y(this).data("draggable"), s = i.options, n = s.snapTolerance, a = e.offset.left, o = a + i.helperProportions.width, r = e.offset.top, l = r + i.helperProportions.height, h = i.snapElements.length - 1; 0 <= h; h--) {
                var c = i.snapElements[h].left,
                    d = c + i.snapElements[h].width,
                    u = i.snapElements[h].top,
                    f = u + i.snapElements[h].height;
                if (c - n < a && a < d + n && u - n < r && r < f + n || c - n < a && a < d + n && u - n < l && l < f + n || c - n < o && o < d + n && u - n < r && r < f + n || c - n < o && o < d + n && u - n < l && l < f + n) {
                    if ("inner" != s.snapMode) {
                        var p = Math.abs(u - l) <= n,
                            m = Math.abs(f - r) <= n,
                            g = Math.abs(c - o) <= n,
                            v = Math.abs(d - a) <= n;
                        p && (e.position.top = i._convertPositionTo("relative", {
                            top: u - i.helperProportions.height,
                            left: 0
                        }).top - i.margins.top), m && (e.position.top = i._convertPositionTo("relative", {
                            top: f,
                            left: 0
                        }).top - i.margins.top), g && (e.position.left = i._convertPositionTo("relative", {
                            top: 0,
                    ...
                    var _ = p || m || g || v;
                    if ("outer" != s.snapMode) {
                        p = Math.abs(u - r) <= n, m = Math.abs(f - l) <= n, g = Math.abs(c - a) <= n, v = Math.abs(d - o) <= n;
                        p && (e.position.top = i._convertPositionTo("relative", {
                            top: u,
                            left: 0
                        }).top - i.margins.top), m && (e.position.top = i._convertPositionTo("relative", {
                    ...
                    }!i.snapElements[h].snapping && (p || m || g || v || _) && i.options.snap.snap && i.options.snap.snap.call(i.element, t, y.extend(i._uiHash(), {
                        snapItem: i.snapElements[h].item
                    })), i.snapElements[h].snapping = p || m || g || v || _
                } else i.snapElements[h].snapping && i.options.snap.release && i.options.snap.release.call(i.element, t, y.extend(i._uiHash(), {
                    snapItem: i.snapElements[h].item
...
function(f, t) {
    f.widget("ui.droppable", {
        ...
        _create: function() {
            var t = this.options,
                e = t.accept;
            this.isover = 0, this.isout = 1, this.accept = f.isFunction(e) ? e : function(t) {
                return t.is(e)
            }, this.proportions = {
                width: this.element[0].offsetWidth,
                height: this.element[0].offsetHeight
            }, f.ui.ddmanager.droppables[t.scope] = f.ui.ddmanager.droppables[t.scope] || [], f.ui.ddmanager.droppables[t.scope].push(this), t.addClasses && this.element.addClass("ui-droppable")
        },
        destroy: function() {
        ...
        _setOption: function(t, e) {
            "accept" == t && (this.accept = f.isFunction(e) ? e : function(t) {
                return t.is(e)
        ...
        _drop: function(t, e) {
            ...
            return this.element.find(":data(droppable)").not(".ui-draggable-dragging").each(function() {
                ...
                if (t.options.greedy && !t.options.disabled && t.options.scope == i.options.scope && t.accept.call(t.element[0], i.currentItem || i.element) && f.ui.intersect(i, f.extend(t, {
        ...
        switch (i) {
            ...
            case "pointer":
                var d = (t.positionAbs || t.position.absolute).left + (t.clickOffset || t.offset.click).left,
                    u = (t.positionAbs || t.position.absolute).top + (t.clickOffset || t.offset.click).top;
                return f.ui.isOver(u, d, h, r, e.proportions.height, e.proportions.width);
            case "touch":
        ...
        drop: function(t, e) {
            var i = !1;
            return f.each(f.ui.ddmanager.droppables[t.options.scope] || [], function() {
                this.options && (!this.options.disabled && this.visible && f.ui.intersect(t, this, this.options.tolerance) && (i = this._drop.call(this, e) || i), !this.options.disabled && this.visible && this.accept.call(this.element[0], t.currentItem || t.element) && (this.isout = 1, this.isover = 0, this._deactivate.call(this, e)))
            }), i
        },
        ...
        drag: function(n, a) {
            n.options.refreshPositions && f.ui.ddmanager.prepareOffsets(n, a), f.each(f.ui.ddmanager.droppables[n.options.scope] || [], function() {
                if (!this.options.disabled && !this.greedyChild && this.visible) {
                    ...
                    if (e) {
                        ...
                        i && "isover" == e && (i.isover = 0, i.isout = 1, i._out.call(i, a)), this[e] = 1, this["isout" == e ? "isover" : "isout"] = 0, this["isover" == e ? "_over" : "_out"].call(this, a), i && "isout" == e && (i.isout = 0, i.isover = 1, i._over.call(i, a))
                    }
                }
            })
        },
...
function(p, t) {
    p.widget("ui.resizable", p.ui.mouse, {
        ...
        _create: function() {
            var e = this,
                t = this.options;
            if (this.element.addClass("ui-resizable"), p.extend(this, {
                ...
                }), this._proportionallyResize()), this.handles = t.handles || (p(".ui-resizable-handle", this.element).length ? {
                    n: ".ui-resizable-n",
                    e: ".ui-resizable-e",
                    s: ".ui-resizable-s",
                    w: ".ui-resizable-w",
                ...
                for (var s = 0; s < i.length; s++) {
                    var n = p.trim(i[s]),
                        a = p('<div class="ui-resizable-handle ' + ("ui-resizable-" + n) + '"></div>');
                    a.css({
                        zIndex: t.zIndex
            ...
            this._renderAxis = function(t) {
                for (var e in t = t || this.element, this.handles) {
                    if (this.handles[e].constructor == String && (this.handles[e] = p(this.handles[e], this.element).show()), this.elementIsWrapper && this.originalElement[0].nodeName.match(/textarea|input|select|button/i)) {
                        var i, s = p(this.handles[e], this.element);
            ...
            }, this._renderAxis(this.element), this._handles = p(".ui-resizable-handle", this.element).disableSelection(), this._handles.mouseover(function() {
                if (!e.resizing) {
                    if (this.className) var t = this.className.match(/ui-resizable-(se|sw|ne|nw|n|e|s|w)/i);
                    e.axis = t && t[1] ? t[1] : "se"
                }
            }), t.autoHide && (this._handles.hide(), p(this.element).addClass("ui-resizable-autohide").hover(function() {
        ...
        _mouseStart: function(t) {
            ...
            var n = m(this.helper.css("left")),
                a = m(this.helper.css("top"));
            e.containment && (n += p(e.containment).scrollLeft() || 0, a += p(e.containment).scrollTop() || 0), this.offset = this.helper.offset(), this.position = {
                left: n,
                top: a
            ...
            var o = p(".ui-resizable-" + this.axis).css("cursor");
            return p("body").css("cursor", "auto" == o ? this.axis + "-resize" : o), s.addClass("ui-resizable-resizing"), this._propagate("start", t), !0
        },
        _mouseDrag: function(t) {
            var e = this.helper,
        ...
        _mouseStop: function(t) {
            ...
            if (this._helper) {
                var s = this._proportionallyResizeElements,
                    ...
                    a = n && p.ui.hasScroll(s[0], "left") ? 0 : i.sizeDiff.height,
                ...
                e.animate || this.element.css(p.extend(r, {
                    top: h,
                    left: l
        ...
        _updateVirtualBoundaries: function(t) {
            ...
            a = {
                minWidth: f(o.minWidth) ? o.minWidth : 0,
                maxWidth: f(o.maxWidth) ? o.maxWidth : 1 / 0,
                minHeight: f(o.minHeight) ? o.minHeight : 0,
                maxHeight: f(o.maxHeight) ? o.maxHeight : 1 / 0
        ...
        _updateRatio: function(t, e) {
            ...
            var i = this.position,
                s = this.size,
                n = this.axis;
            return f(t.height) ? t.width = t.height * this.aspectRatio : f(t.width) && (t.height = t.width / this.aspectRatio), "sw" == n && (t.left = i.left + (s.width - t.width), t.top = null), "nw" == n && (t.top = i.top + (s.height - t.height), t.left = i.left + (s.width - t.width)), t
        },
        _respectSize: function(t, e) {
            ...
            var i = this._vBoundaries,
                ...
                a = f(t.height) && i.maxHeight && i.maxHeight < t.height,
                o = f(t.width) && i.minWidth && i.minWidth > t.width,
                r = f(t.height) && i.minHeight && i.minHeight > t.height;
            o && (t.width = i.minWidth), r && (t.height = i.minHeight), n && (t.width = i.maxWidth), a && (t.height = i.maxHeight);
            var l = this.originalPosition.left + this.originalSize.width,
                h = this.position.top + this.size.height,
                c = /sw|nw|w/.test(s),
                d = /nw|ne|n/.test(s);
            o && c && (t.left = l - i.minWidth), n && c && (t.left = l - i.maxWidth), r && d && (t.top = h - i.minHeight), a && d && (t.top = h - i.maxHeight);
            var u = !t.width && !t.height;
            return u && !t.left && t.top ? t.top = null : u && !t.top && t.left && (t.left = null), t
        },
        _proportionallyResize: function() {
            ...
            if (this._proportionallyResizeElements.length)
                for (var t = this.helper || this.element, e = 0; e < this._proportionallyResizeElements.length; e++) {
                    ...
                    p.browser.msie && (p(t).is(":hidden") || p(t).parents(":hidden").length) || i.css({
    ...
    }), p.extend(p.ui.resizable, {
        version: "1.8.22"
    }), p.ui.plugin.add("resizable", "alsoResize", {
        start: function(t, e) {
            var i = p(this).data("resizable").options,
                s = function(t) {
                    p(t).each(function() {
                        var t = p(this);
            ...
            "object" != typeof i.alsoResize || i.alsoResize.parentNode ? s(i.alsoResize) : i.alsoResize.length ? (i.alsoResize = i.alsoResize[0], s(i.alsoResize)) : p.each(i.alsoResize, function(t) {
                s(t)
            })
        },
        resize: function(t, a) {
            ...
            "object" != typeof i.alsoResize || i.alsoResize.nodeType ? r(i.alsoResize) : p.each(i.alsoResize, function(t, e) {
                r(t, e)
            })
        },
        stop: function(t, e) {
        ...
        stop: function(e, t) {
            var i = p(this).data("resizable"),
                ...
                o = a && p.ui.hasScroll(n[0], "left") ? 0 : i.sizeDiff.height,
            ...
            i.element.animate(p.extend(l, c && h ? {
                top: c,
                left: h
            } : {}), {
        ...
        start: function(t, e) {
            var i = p(this).data("resizable"),
                ...
                n = i.element,
                a = s.containment,
                o = a instanceof p ? a.get(0) : /parent/.test(a) ? n.parent().get(0) : a;
            if (o)
                if (i.containerElement = p(o), /document/.test(a) || a == document) i.containerOffset = {
                    left: 0,
                    top: 0
                }, i.containerPosition = {
                    left: 0,
                    ...
                    var h = i.containerOffset,
                        ...
                        u = p.ui.hasScroll(o, "left") ? o.scrollWidth : d,
                        f = p.ui.hasScroll(o) ? o.scrollHeight : c;
                    i.parentData = {
                        element: o,
                        left: h.left,
                        top: h.top,
        ...
        resize: function(t, e) {
            ...
            d && u && (h -= i.parentData.left), h + i.size.width >= i.parentData.width && (i.size.width = i.parentData.width - h, o && (i.size.height = i.size.width / i.aspectRatio)), c + i.size.height >= i.parentData.height && (i.size.height = i.parentData.height - c, o && (i.size.width = i.size.height * i.aspectRatio))
        },
        stop: function(t, e) {
            var i = p(this).data("resizable"),
                s = i.options,
            ...
            i._helper && !s.animate && /relative/.test(o.css("position")) && p(this).css({
                left: l.left - a.left - n.left,
                width: h,
                height: c
            }), i._helper && !s.animate && /static/.test(o.css("position")) && p(this).css({
                left: l.left - a.left - n.left,
                width: h,
                height: c
            })
        ...
        resize: function(t, e) {
            ...
            var l = Math.round((n.width - a.width) / (s.grid[0] || 1)) * (s.grid[0] || 1),
                h = Math.round((n.height - a.height) / (s.grid[1] || 1)) * (s.grid[1] || 1);
            /^(se|s|e)$/.test(r) ? (i.size.width = a.width + l, i.size.height = a.height + h) : /^(ne)$/.test(r) ? (i.size.width = a.width + l, i.size.height = a.height + h, i.position.top = o.top - h) : (/^(sw)$/.test(r) ? (i.size.width = a.width + l, i.size.height = a.height + h) : (i.size.width = a.width + l, i.size.height = a.height + h, i.position.top = o.top - h), i.position.left = o.left - l)
        }
    });
    var m = function(t) {
            ...
            if (this.dragged = !0, !this.options.disabled) {
                ...
                return this.helper.css({
                    ...
                    if (t && t.element != s.element[0]) {
                        var e = !1;
                        "touch" == n.tolerance ? e = !(t.left > r || t.right < a || t.top > l || t.bottom < o) : "fit" == n.tolerance && (e = t.left > a && t.right < r && t.top > o && t.bottom < l), e ? (t.selected && (t.$element.removeClass("ui-selected"), t.selected = !1), t.unselecting && (t.$element.removeClass("ui-unselecting"), t.unselecting = !1), t.selecting || (t.$element.addClass("ui-selecting"), t.selecting = !0, s._trigger("selecting", i, {
                            selecting: t.element
...
function(u, t) {
    u.widget("ui.sortable", u.ui.mouse, {
        ...
        destroy: function() {
            u.Widget.prototype.destroy.call(this), this.element.removeClass("ui-sortable ui-sortable-disabled"), this._mouseDestroy();
            for (var t = this.items.length - 1; 0 <= t; t--) this.items[t].item.removeData(this.widgetName + "-item");
            return this
        },
        _setOption: function(t, e) {
            "disabled" === t ? (this.options[t] = e, this.widget()[e ? "addClass" : "removeClass"]("ui-sortable-disabled")) : u.Widget.prototype._setOption.apply(this, arguments)
        },
        _mouseCapture: function(t, e) {
            ...
            u(t.target).parents().each(function() {
                if (u.data(this, i.widgetName + "-item") == n) return s = u(this), !1
            });
            if (u.data(t.target, i.widgetName + "-item") == n && (s = u(t.target)), !s) return !1;
            if (this.options.handle && !e) {
                var a = !1;
                if (u(this.options.handle, s).find("*").andSelf().each(function() {
                        this == t.target && (a = !0)
                    }), !a) return !1
            }
        ...
        _mouseStart: function(t, e, i) {
            ...
            return u.ui.ddmanager && (u.ui.ddmanager.current = this), u.ui.ddmanager && !s.dropBehaviour && u.ui.ddmanager.prepareOffsets(this, t), this.dragging = !0, this.helper.addClass("ui-sortable-helper"), this._mouseDrag(t), !0
        },
        _mouseDrag: function(t) {
            ...
            for (var s = this.items.length - 1; 0 <= s; s--) {
                ...
                if (o && !(a == this.currentItem[0] || this.placeholder[1 == o ? "next" : "prev"]()[0] == a || u.ui.contains(this.placeholder[0], a) || "semi-dynamic" == this.options.type && u.ui.contains(this.element[0], a))) {
        ...
        _mouseStop: function(t, e) {
            if (t) {
                if (u.ui.ddmanager && !this.options.dropBehaviour && u.ui.ddmanager.drop(this, t), this.options.revert) {
                    ...
                    i.reverting = !0, u(this.helper).animate({
        ...
        _intersectsWithPointer: function(t) {
            var e = "x" === this.options.axis || u.ui.isOverAxis(this.positionAbs.top + this.offset.click.top, t.top, t.height),
                i = "y" === this.options.axis || u.ui.isOverAxis(this.positionAbs.left + this.offset.click.left, t.left, t.width),
                s = e && i,
        ...
        _intersectsWithSides: function(t) {
            var e = u.ui.isOverAxis(this.positionAbs.top + this.offset.click.top, t.top + t.height / 2, t.height),
                i = u.ui.isOverAxis(this.positionAbs.left + this.offset.click.left, t.left + t.width / 2, t.width),
        ...
        _getItemsAsjQuery: function(t) {
            ...
            if (s && t)
                for (var n = s.length - 1; 0 <= n; n--)
                    for (var a = u(s[n]), o = a.length - 1; 0 <= o; o--) {
                        var r = u.data(a[o], this.widgetName);
                        r && r != this && !r.options.disabled && i.push([u.isFunction(r.options.items) ? r.options.items.call(r.element) : u(r.options.items, r.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), r])
                    }
            i.push([u.isFunction(this.options.items) ? this.options.items.call(this.element, null, {
        ...
        _refreshItems: function(t) {
            ...
            if (s && this.ready)
                for (var n = s.length - 1; 0 <= n; n--)
                    for (var a = u(s[n]), o = a.length - 1; 0 <= o; o--) {
                        var r = u.data(a[o], this.widgetName);
                        r && r != this && !r.options.disabled && (i.push([u.isFunction(r.options.items) ? r.options.items.call(r.element[0], t, {
                            item: this.currentItem
                        }) : u(r.options.items, r.element), r]), this.containers.push(r))
                    }
            for (n = i.length - 1; 0 <= n; n--)
                for (var l = i[n][1], h = i[n][0], c = (o = 0, h.length); o < c; o++) {
                    var d = u(h[o]);
                    d.data(this.widgetName + "-item", l), e.push({
                        item: d,
                        instance: l,
                        width: 0,
                        height: 0,
        ...
        refreshPositions: function(t) {
            ...
            for (var e = this.items.length - 1; 0 <= e; e--) {
                ...
                if (i.instance == this.currentContainer || !this.currentContainer || i.item[0] == this.currentItem[0]) {
                    var s = this.options.toleranceElement ? u(this.options.toleranceElement, i.item) : i.item;
        ...
        _createPlaceholder: function(t) {
            ...
            if (!s.placeholder || s.placeholder.constructor == String) {
                ...
                s.placeholder = {
                    element: function() {
                        var t = u(document.createElement(i.currentItem[0].nodeName)).addClass(n || i.currentItem[0].className + " ui-sortable-placeholder").removeClass("ui-sortable-helper")[0];
            ...
            i.placeholder = u(s.placeholder.element.call(i.element, i.currentItem)), i.currentItem.after(i.placeholder), s.placeholder.update(i, i.placeholder)
        },
        _contactContainers: function(t) {
            for (var e = null, i = null, s = this.containers.length - 1; 0 <= s; s--)
                if (!u.ui.contains(this.currentItem[0], this.containers[s].element[0]))
                    if (this._intersectsWith(this.containers[s].containerCache)) {
                        if (e && u.ui.contains(this.containers[s].element[0], e.element[0])) continue;
            ...
            if (e)
                ...
                for (var n = 1e4, a = null, o = this.positionAbs[this.containers[i].floating ? "left" : "top"], r = this.items.length - 1; 0 <= r; r--)
                    if (u.ui.contains(this.containers[i].element[0], this.items[r].item[0])) {
                        var l = this.containers[i].floating ? this.items[r].item.offset().left : this.items[r].item.offset().top;
                        Math.abs(l - o) < n && (n = Math.abs(l - o), a = this.items[r], this.direction = 0 < l - o ? "down" : "up")
                    }
        ...
        _getParentOffset: function() {
            this.offsetParent = this.helper.offsetParent();
            var t = this.offsetParent.offset();
            return "absolute" == this.cssPosition && this.scrollParent[0] != document && u.ui.contains(this.scrollParent[0], this.offsetParent[0]) && (t.left += this.scrollParent.scrollLeft(), t.top += this.scrollParent.scrollTop()), (this.offsetParent[0] == document.body || this.offsetParent[0].tagName && "html" == this.offsetParent[0].tagName.toLowerCase() && u.browser.msie) && (t = {
                top: 0,
                left: 0
            }), {
                top: t.top + (parseInt(this.offsetParent.css("borderTopWidth"), 10) || 0),
        ...
        _setContainment: function() {
            ...
            if ("parent" == t.containment && (t.containment = this.helper[0].parentNode), "document" != t.containment && "window" != t.containment || (this.containment = [0 - this.offset.relative.left - this.offset.parent.left, 0 - this.offset.relative.top - this.offset.parent.top, u("document" == t.containment ? document : window).width() - this.helperProportions.width - this.margins.left, (u("document" == t.containment ? document : window).height() || document.body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top]), !/^(document|window|parent)$/.test(t.containment)) {
                var e = u(t.containment)[0],
                    i = u(t.containment).offset(),
                    s = "hidden" != u(e).css("overflow");
        ...
        _convertPositionTo: function(t, e) {
            e || (e = this.position);
            var i = "absolute" == t ? 1 : -1,
                s = (this.options, "absolute" != this.cssPosition || this.scrollParent[0] != document && u.ui.contains(this.scrollParent[0], this.offsetParent[0]) ? this.scrollParent : this.offsetParent),
                n = /(html|body)/i.test(s[0].tagName);
            return {
                top: e.top + this.offset.relative.top * i + this.offset.parent.top * i - (u.browser.safari && "fixed" == this.cssPosition ? 0 : ("fixed" == this.cssPosition ? -this.scrollParent.scrollTop() : n ? 0 : s.scrollTop()) * i),
                left: e.left + this.offset.relative.left * i + this.offset.parent.left * i - (u.browser.safari && "fixed" == this.cssPosition ? 0 : ("fixed" == this.cssPosition ? -this.scrollParent.scrollLeft() : n ? 0 : s.scrollLeft()) * i)
            }
        },
        _generatePosition: function(t) {
            var e = this.options,
                i = "absolute" != this.cssPosition || this.scrollParent[0] != document && u.ui.contains(this.scrollParent[0], this.offsetParent[0]) ? this.scrollParent : this.offsetParent,
                s = /(html|body)/i.test(i[0].tagName);
            ...
            if (this.originalPosition && (this.containment && (t.pageX - this.offset.click.left < this.containment[0] && (n = this.containment[0] + this.offset.click.left), t.pageY - this.offset.click.top < this.containment[1] && (a = this.containment[1] + this.offset.click.top), t.pageX - this.offset.click.left > this.containment[2] && (n = this.containment[2] + this.offset.click.left), t.pageY - this.offset.click.top > this.containment[3] && (a = this.containment[3] + this.offset.click.top)), e.grid)) {
                var o = this.originalPageY + Math.round((a - this.originalPageY) / e.grid[1]) * e.grid[1];
                a = this.containment && (o - this.offset.click.top < this.containment[1] || o - this.offset.click.top > this.containment[3]) ? o - this.offset.click.top < this.containment[1] ? o + e.grid[1] : o - e.grid[1] : o;
            ...
            return {
                top: a - this.offset.click.top - this.offset.relative.top - this.offset.parent.top + (u.browser.safari && "fixed" == this.cssPosition ? 0 : "fixed" == this.cssPosition ? -this.scrollParent.scrollTop() : s ? 0 : i.scrollTop()),
                left: n - this.offset.click.left - this.offset.relative.left - this.offset.parent.left + (u.browser.safari && "fixed" == this.cssPosition ? 0 : "fixed" == this.cssPosition ? -this.scrollParent.scrollLeft() : s ? 0 : i.scrollLeft())
            }
        },
        ...
        _clear: function(t, e) {
            ...
            if (this.fromOutside && !e && i.push(function(t) {
                ...
                }), !u.ui.contains(this.element[0], this.currentItem[0])) {
                e || i.push(function(t) {
                    this._trigger("remove", t, this._uiHash())
                });
                for (s = this.containers.length - 1; 0 <= s; s--) u.ui.contains(this.containers[s].element[0], this.currentItem[0]) && !e && (i.push(function(e) {
                    return function(t) {
        ...
        function d(t) {
            var e, i;
            for (e in t)(null == (i = t[e]) || h.isFunction(i) || e in a || /scrollbar/.test(e) || !/color/i.test(e) && isNaN(parseFloat(i))) && delete t[e];
            return t
        }
        ...
        h.effects.animateClass = function(a, o, r, l) {
            return h.isFunction(r) && (l = r, r = null), this.queue(function() {
                var t, i = h(this),
                    ...
                    s = d(c.call(this)),
                    n = i.attr("class") || "";
                h.each(u, function(t, e) {
                    a[e] && i[e + "Class"](a[e])
                }), t = d(c.call(this)), i.attr("class", n), i.animate(function(t, e) {
                    var i, s = {
                        _: 0
                    };
            ...
            effect: function(t, e, i, s) {
                var n = l.apply(this, arguments),
                    ...
                    o = a.options.mode,
                    r = h.effects[t];
                return h.fx.off || !r ? o ? this[o](a.duration, a.callback) : this.each(function() {
            ...
            easeInElastic: function(t, e, i, s, n) {
                ...
                if (o || (o = .3 * n), r < Math.abs(s)) {
                    r = s;
                    a = o / 4
                } else a = o / (2 * Math.PI) * Math.asin(s / r);
                return -r * Math.pow(2, 10 * (e -= 1)) * Math.sin(2 * (e * n - a) * Math.PI / o) + i
            },
            easeOutElastic: function(t, e, i, s, n) {
                ...
                return r * Math.pow(2, -10 * e) * Math.sin(2 * (e * n - a) * Math.PI / o) + s + i
            },
            easeInOutElastic: function(t, e, i, s, n) {
                ...
                return e < 1 ? -.5 * r * Math.pow(2, 10 * (e -= 1)) * Math.sin(2 * (e * n - a) * Math.PI / o) + i : r * Math.pow(2, -10 * (e -= 1)) * Math.sin(2 * (e * n - a) * Math.PI / o) * .5 + s + i
            },
    ...
    function(h, t) {
        h.effects.blind = function(l) {
            return this.queue(function() {
                ...
                "show" == i && n.css(a, 0);
                var r = {};
                r[a] = "show" == i ? o : 0, n.animate(r, l.duration, l.options.easing, function() {
    ...
    function(p, t) {
        p.effects.bounce = function(f) {
            return this.queue(function() {
                ...
                n = f.options.distance || ("top" == r ? t.outerHeight(!0) / 3 : t.outerWidth(!0) / 3);
                ("show" == i && t.css("opacity", 0).css(r, "pos" == l ? -n : n), "hide" == i && (n /= 2 * a), "hide" != i && a--, "show" == i) && ((d = {
                    opacity: 1
                })[r] = ("pos" == l ? "+=" : "-=") + n, t.animate(d, o / 2, f.options.easing), n /= 2, a--);
                for (var h = 0; h < a; h++) {
                    var c = {};
                    (u = {})[r] = ("pos" == l ? "-=" : "+=") + n, c[r] = ("pos" == l ? "+=" : "-=") + n, t.animate(u, o / 2, f.options.easing).animate(c, o / 2, f.options.easing), n = "hide" == i ? 2 * n : n / 2
                }
                if ("hide" == i) {
                    var d;
                    (d = {
                        opacity: 0
                    })[r] = ("pos" == l ? "-=" : "+=") + n, t.animate(d, o / 2, f.options.easing, function() {
                        t.hide(), p.effects.restore(t, e), p.effects.removeWrapper(t), f.callback && f.callback.apply(this, arguments)
                    })
                } else {
                    var u;
                    c = {};
                    (u = {})[r] = ("pos" == l ? "-=" : "+=") + n, c[r] = ("pos" == l ? "+=" : "-=") + n, t.animate(u, o / 2, f.options.easing).animate(c, o / 2, f.options.easing, function() {
        ...
        h.effects.drop = function(l) {
            return this.queue(function() {
                ...
                var n = "up" == s || "down" == s ? "top" : "left",
                    ...
                    o = l.options.distance || ("top" == n ? t.outerHeight(!0) / 2 : t.outerWidth(!0) / 2);
                "show" == i && t.css("opacity", 0).css(n, "pos" == a ? -o : o);
                var r = {
                    opacity: "show" == i ? 1 : 0
                };
                r[n] = ("show" == i ? "pos" == a ? "+=" : "-=" : "pos" == a ? "-=" : "+=") + o, t.animate(r, {
                    queue: !1,
                    duration: l.duration,
        ...
        p.effects.fold = function(f) {
            return this.queue(function() {
                var t = p(this),
                    ...
                    a = f.duration ? f.duration / 2 : p.fx.speeds._default / 2;
                p.effects.save(t, e), t.show();
                var o = p.effects.createWrapper(t).css({
                        overflow: "hidden"
                    }),
                    r = "show" == i != n,
                    ...
                    c = /([0-9]+)%/.exec(s);
                c && (s = parseInt(c[1], 10) / 100 * h["hide" == i ? 0 : 1]), "show" == i && o.css(n ? {
                    height: 0,
                    width: s
                } : {
                    height: s,
                ...
                var d = {},
                    u = {};
                d[l[0]] = "show" == i ? h[0] : s, u[l[1]] = "show" == i ? h[1] : 0, o.animate(d, a, f.options.easing).animate(u, a, f.options.easing, function() {
    ...
    function(m, t) {
        m.effects.puff = function(a) {
            return this.queue(function() {
                var t = m(this),
                    e = m.effects.setMode(t, a.options.mode || "hide"),
        ...
        }, m.effects.scale = function(h) {
            return this.queue(function() {
                var t = m(this),
                    e = m.extend(!0, {}, h.options),
                    i = m.effects.setMode(t, h.options.mode || "effect"),
            ...
            return this.queue(function() {
                var t = m(this),
                    ...
                    r = m.effects.setMode(t, p.options.mode || "effect"),
                ...
                if (t.from = p.options.from || d, t.to = p.options.to || d, c) {
                    var u = m.effects.getBaseline(c, d);
                    t.from.top = (d.height - t.from.height) * u.y, t.from.left = (d.width - t.from.width) * u.x, t.to.top = (d.height - t.to.height) * u.y, t.to.left = (d.width - t.to.width) * u.x
                }
                var f = {
                    from: {
                        y: t.from.height / d.height,
                        x: t.from.width / d.width
                    },
                    to: {
                        y: t.to.height / d.height,
                        x: t.to.width / d.width
                    }
                };
                "box" != h && "both" != h || (f.from.y != f.to.y && (e = e.concat(a), t.from = m.effects.setTransition(t, a, f.from.y, t.from), t.to = m.effects.setTransition(t, a, f.to.y, t.to)), f.from.x != f.to.x && (e = e.concat(o), t.from = m.effects.setTransition(t, o, f.from.x, t.from), t.to = m.effects.setTransition(t, o, f.to.x, t.to))), ("content" == h || "both" == h) && f.from.y != f.to.y && (e = e.concat(n), t.from = m.effects.setTransition(t, n, f.from.y, t.from), t.to = m.effects.setTransition(t, n, f.to.y, t.to)), m.effects.save(t, l ? e : i), t.show(), m.effects.createWrapper(t), t.css("overflow", "hidden").css(t.from), "content" != h && "both" != h || (a = a.concat(["marginTop", "marginBottom"]).concat(n), o = o.concat(["marginLeft", "marginRight"]), s = e.concat(a).concat(o), t.find("*[width]").each(function() {
                    var t = m(this);
                    l && m.effects.save(t, s);
                    var e = t.height(),
                        i = t.width();
                    t.from = {
                        height: e * f.from.y,
                        ...
                        height: e * f.to.y,
                        width: i * f.to.x
                    }, f.from.y != f.to.y && (t.from = m.effects.setTransition(t, a, f.from.y, t.from), t.to = m.effects.setTransition(t, a, f.to.y, t.to)), f.from.x != f.to.x && (t.from = m.effects.setTransition(t, o, f.from.x, t.from), t.to = m.effects.setTransition(t, o, f.to.x, t.to)), t.css(t.from), t.animate(t.to, p.duration, p.options.easing, function() {
                        l && m.effects.restore(t, s)
                    })
                })), t.animate(t.to, {
                    queue: !1,
                    duration: p.duration,
                    ...
                    complete: function() {
                        0 === t.to.opacity && t.css("opacity", t.from.opacity), "hide" == r && t.hide(), m.effects.restore(t, l ? e : i), m.effects.removeWrapper(t), p.callback && p.callback.apply(this, arguments), t.dequeue()
                    }
                })
            })
        }
    ...
    function(f, t) {
        f.effects.shake = function(u) {
            return this.queue(function() {
                var t = f(this),
                    e = ["position", "top", "bottom", "left", "right"],
                    i = (f.effects.setMode(t, u.options.mode || "effect"), u.options.direction || "left"),
                ...
                var o = "up" == i || "down" == i ? "top" : "left",
                    ...
                    h = {},
                    c = {};
                l[o] = ("pos" == r ? "-=" : "+=") + s, h[o] = ("pos" == r ? "+=" : "-=") + 2 * s, c[o] = ("pos" == r ? "-=" : "+=") + 2 * s, t.animate(l, a, u.options.easing);
                for (var d = 1; d < n; d++) t.animate(h, a, u.options.easing).animate(c, a, u.options.easing);
                t.animate(h, a, u.options.easing).animate(l, a / 2, u.options.easing, function() {
                    f.effects.restore(t, e), f.effects.removeWrapper(t), u.callback && u.callback.apply(this, arguments)
                }), t.queue("fx", function() {
                    t.dequeue()
                }), t.dequeue()
            })
    ...
    function(h, t) {
        h.effects.slide = function(l) {
            return this.queue(function() {
                ...
                var n = "up" == s || "down" == s ? "top" : "left",
                    a = "up" == s || "left" == s ? "pos" : "neg",
                    o = l.options.distance || ("top" == n ? t.outerHeight(!0) : t.outerWidth(!0));
        ...
        r.effects.transfer = function(o) {
            return this.queue(function() {
                var t = r(this),
                    ...
                    n = t.offset(),
                    a = r('<div class="ui-effects-transfer"></div>').appendTo(document.body).addClass(o.options.className).css({
                        top: n.top,
                        left: n.left,
                        height: t.innerHeight(),
                        width: t.innerWidth(),
                        position: "absolute"
                    }).animate(s, o.duration, o.options.easing, function() {
                        a.remove(), o.callback && o.callback.apply(t[0], arguments), t.dequeue()
                    })
            })
        }
    }(jQuery),
    function(u, t) {
        u.widget("ui.accordion", {
            options: {
                active: 0,
                animated: "slide",
                autoHeight: !0,
            ...
            _create: function() {
                ...
                if (e.running = 0, e.element.addClass("ui-accordion ui-widget ui-helper-reset").children("li").addClass("ui-accordion-li-fix"), e.headers = e.element.find(t.header).addClass("ui-accordion-header ui-helper-reset ui-state-default ui-corner-all").bind("mouseenter.accordion", function() {
                        ...
                        t.disabled || u(this).removeClass("ui-state-hover")
                    }).bind("focus.accordion", function() {
                        t.disabled || u(this).addClass("ui-state-focus")
                    }).bind("blur.accordion", function() {
                        t.disabled || u(this).removeClass("ui-state-focus")
                ...
                e.active = e._findActive(e.active || t.active).addClass("ui-state-default ui-state-active").toggleClass("ui-corner-all").toggleClass("ui-corner-top"), e.active.next().addClass("ui-accordion-content-active"), e._createIcons(), e.resize(), e.element.attr("role", "tablist"), e.headers.attr("role", "tab").bind("keydown.accordion", function(t) {
                    ...
                    "aria-selected": "true",
                    tabIndex: 0
                }) : e.headers.eq(0).attr("tabIndex", 0), u.browser.safari || e.headers.find("a").attr("tabIndex", -1), t.event && e.headers.bind(t.event.split(" ").join(".accordion ") + ".accordion", function(t) {
                    e._clickHandler.call(e, t, this), t.preventDefault()
                })
            },
            _createIcons: function() {
                var t = this.options;
                t.icons && (u("<span></span>").addClass("ui-icon " + t.icons.header).prependTo(this.headers), this.active.children(".ui-icon").toggleClass(t.icons.header).toggleClass(t.icons.headerSelected), this.element.addClass("ui-accordion-icons"))
            },
            ...
            destroy: function() {
                ...
                return (t.autoHeight || t.fillHeight) && e.css("height", ""), u.Widget.prototype.destroy.call(this)
            },
            _setOption: function(t, e) {
                u.Widget.prototype._setOption.apply(this, arguments), "active" == t && this.activate(e), "icons" == t && (this._destroyIcons(), e && this._createIcons()), "disabled" == t && this.headers.add(this.headers.next())[e ? "addClass" : "removeClass"]("ui-accordion-disabled ui-state-disabled")
            },
            _keydown: function(t) {
                if (!(this.options.disabled || t.altKey || t.ctrlKey)) {
                    ...
                    return !n || (u(t.target).attr("tabIndex", -1), u(n).attr("tabIndex", 0), n.focus(), !1)
                }
            },
            resize: function() {
                ...
                if (e.fillSpace) {
                    ...
                    t = this.element.parent().height(), u.browser.msie && this.element.parent().css("overflow", i), this.headers.each(function() {
                        t -= u(this).outerHeight(!0)
                    }), this.headers.next().each(function() {
                        u(this).height(Math.max(0, t - u(this).innerHeight() + u(this).height()))
                    }).css("overflow", "auto")
                } else e.autoHeight && (t = 0, this.headers.next().each(function() {
                    t = Math.max(t, u(this).height("").height())
                }).height(t));
                return this
            },
            activate: function(t) {
            ...
            _toggle: function(t, e, i, s, n) {
                ...
                if (a._trigger("changestart", null, a.data), a.running = 0 === e.size() ? t.size() : e.size(), o.animated) {
                    var l = {};
                    l = o.collapsible && s ? {
                        toShow: u([]),
                        toHide: e,
                        ...
                        down: n,
                        autoHeight: o.autoHeight || o.fillSpace
                    }, o.proxied || (o.proxied = o.animated), o.proxiedDuration || (o.proxiedDuration = o.duration), o.animated = u.isFunction(o.proxied) ? o.proxied(l) : o.proxied, o.duration = u.isFunction(o.proxiedDuration) ? o.proxiedDuration(l) : o.proxiedDuration;
                    var h = u.ui.accordion.animations,
                        c = o.duration,
                        d = o.animated;
                    d && !h[d] && !u.easing[d] && (d = "slide"), h[d] || (h[d] = function(t) {
                        this.slide(t, {
                            easing: d,
                            duration: c || 700
                        })
                    }), h[d](l)
                } else o.collapsible && s ? t.toggle() : (e.hide(), t.show()), r(!0);
                e.prev().attr({
                    "aria-expanded": "false",
                    "aria-selected": "false",
                    tabIndex: -1
                    ...
                    if ((s = u.extend({
                        ...
                        if (s.toShow.size()) {
                            var e, i = s.toShow.css("overflow"),
                                ...
                                o = {},
                                r = s.toShow;
                            e = r[0].style.width, r.width(r.parent().width() - parseFloat(r.css("paddingLeft")) - parseFloat(r.css("paddingRight")) - (parseFloat(r.css("borderLeftWidth")) || 0) - (parseFloat(r.css("borderRightWidth")) || 0)), u.each(["height", "paddingTop", "paddingBottom"], function(t, e) {
                                o[e] = "hide";
                                var i = ("" + u.css(s.toShow[0], e)).match(/^([\d+-.]+)(.*)$/);
                                a[e] = {
                                    value: i[1],
                                    unit: i[2] || "px"
                                }
                                ...
                                step: function(t, e) {
                                    "height" == e.prop && (n = e.end - e.start == 0 ? 0 : (e.now - e.start) / (e.end - e.start)), s.toShow[0].style[e.prop] = n * a[e.prop].value + a[e.prop].unit
                                },
                                duration: s.duration,
                                easing: s.easing,
                                complete: function() {
    ...
    function(o, t) {
        ...
        o.widget("ui.autocomplete", {
            ...
            _suggest: function(t) {
                ...
                this._renderMenu(e, t), this.menu.deactivate(), this.menu.refresh(), e.show(), this._resizeMenu(), e.position(o.extend({
                    of: this.element
    ...
    function(a, t) {
        var o, r, l, h, c = "ui-button ui-widget ui-state-default ui-corner-all",
        ...
        a.widget("ui.button", {
            ...
            _create: function() {
                this.element.closest("form").unbind("reset.button").bind("reset.button", u), "boolean" != typeof this.options.disabled ? this.options.disabled = !!this.element.propAttr("disabled") : this.element.propAttr("disabled", this.options.disabled), this._determineButtonType(), this.hasTitle = !!this.buttonElement.attr("title");
                var e = this,
                    i = this.options,
                ...
                null === i.label && (i.label = this.buttonElement.html()), this.buttonElement.addClass(c).attr("role", "button").bind("mouseenter.button", function() {
                    i.disabled || (a(this).addClass("ui-state-hover"), this === o && a(this).addClass("ui-state-active"))
                    ...
                    i.disabled || (h = !1, r = t.pageX, l = t.pageY)
                }).bind("mouseup.button", function(t) {
                    i.disabled || r === t.pageX && l === t.pageY || (h = !0)
                })), "checkbox" === this.type ? this.buttonElement.bind("click.button", function() {
                    if (i.disabled || h) return !1;
                    a(this).toggleClass("ui-state-active"), e.buttonElement.attr("aria-pressed", e.element[0].checked)
                    ...
                    a(this).addClass("ui-state-active"), o = this, a(document).one("mouseup", function() {
                        o = null
                    })
                    ...
                    if (i.disabled) return !1;
                    (t.keyCode == a.ui.keyCode.SPACE || t.keyCode == a.ui.keyCode.ENTER) && a(this).addClass("ui-state-active")
            ...
            destroy: function() {
                this.element.removeClass("ui-helper-hidden-accessible"), this.buttonElement.removeClass(c + " ui-state-hover ui-state-active  " + d).removeAttr("role").removeAttr("aria-pressed").html(this.buttonElement.find(".ui-button-text").html()), this.hasTitle || this.buttonElement.removeAttr("title"), a.Widget.prototype.destroy.call(this)
            },
            _setOption: function(t, e) {
            ...
            _resetButton: function() {
                if ("input" !== this.type) {
                    var t = this.buttonElement.removeClass(d),
                        e = a("<span></span>", this.element[0].ownerDocument).addClass("ui-button-text").html(this.options.label).appendTo(t.empty()).text(),
    ...
    function($, undefined) {
        ...
        $.extend(Datepicker.prototype, {
                ...
                if ("input" != (t = t.target || t).nodeName.toLowerCase() && (t = $("input", t.parentNode)[0]), !$.datepicker._isDisabledDatepicker(t) && $.datepicker._lastInput != t) {
                    ...
                    if (!1 !== s) {
                        ...
                        if ($.datepicker._pos = null, i.dpDiv.empty(), i.dpDiv.css({
                                ...
                                display: "block",
                                top: "-1000px"
                            }), $.datepicker._updateDatepicker(i), a = $.datepicker._checkOffset(i, a, n), i.dpDiv.css({
                                position: $.datepicker._inDialog && $.blockUI ? "static" : n ? "fixed" : "absolute",
                                display: "none",
                                left: a.left + "px",
                                top: a.top + "px"
                            }), !i.inline) {
                            var o = $.datepicker._get(i, "showAnim"),
                            ...
                            i.dpDiv.zIndex($(t).zIndex() + 1), $.datepicker._datepickerShowing = !0, $.effects && $.effects[o] ? i.dpDiv.show(o, $.datepicker._get(i, "showOptions"), r, l) : i.dpDiv[o || "show"](o ? r : null, l), (!o || !r) && l(), i.input.is(":visible") && !i.input.is(":disabled") && i.input.focus(), $.datepicker._curInst = i
                        }
                    }
                }
            },
            ...
            parseDate: function(i, a, t) {
                ...
                for (var s = (t ? t.dayNamesShort : null) || this._defaults.dayNamesShort, n = (t ? t.dayNames : null) || this._defaults.dayNames, o = (t ? t.monthNamesShort : null) || this._defaults.monthNamesShort, r = (t ? t.monthNames : null) || this._defaults.monthNames, l = -1, h = -1, c = -1, d = -1, u = !1, f = function(t) {
                        var e = _ + 1 < i.length && i.charAt(_ + 1) == t;
                        return e && _++, e
                    }, p = function(t) {
                        var e = f(t),
                            i = new RegExp("^\\d{1," + ("@" == t ? 14 : "!" == t ? 20 : "y" == t && e ? 4 : "o" == t ? 3 : 2) + "}"),
                            s = a.substring(v).match(i);
                        if (!s) throw "Missing number at position " + v;
                        return v += s[0].length, parseInt(s[0], 10)
                    }, m = function(t, e, i) {
                        var s = $.map(f(t) ? i : e, function(t, e) {
                                return [
                                    [e, t]
                                ]
                            }).sort(function(t, e) {
                        ...
                        if ($.each(s, function(t, e) {
                                var i = e[1];
                                if (a.substr(v, i.length).toLowerCase() == i.toLowerCase()) return n = e[0], v += i.length, !1
                            }), -1 != n) return n + 1;
                        throw "Unknown name at position " + v
                    }, g = function() {
                        if (a.charAt(v) != i.charAt(_)) throw "Unexpected literal at position " + v;
                        v++
                    }, v = 0, _ = 0; _ < i.length; _++)
                    if (u) "'" != i.charAt(_) || f("'") ? g() : u = !1;
                        ...
                        case "y":
                            ...
                            break;
                        case "@":
                            l = (y = new Date(p("@"))).getFullYear(), h = y.getMonth() + 1, c = y.getDate();
                            break;
                        case "!":
                            var y;
                            l = (y = new Date((p("!") - this._ticksTo1970) / 1e4)).getFullYear(), h = y.getMonth() + 1, c = y.getDate();
                            break;
                        case "'":
                            f("'") ? g() : u = !0;
                            break;
                ...
                if (-1 == l ? l = (new Date).getFullYear() : l < 100 && (l += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (l <= e ? 0 : -100)), -1 < d)
                    for (h = 1, c = d;;) {
                        var b = this._getDaysInMonth(l, h - 1);
                        if (c <= b) break;
                        h++, c -= b
                    }
                if ((y = this._daylightSavingAdjust(new Date(l, h - 1, c))).getFullYear() != l || y.getMonth() + 1 != h || y.getDate() != c) throw "Invalid date";
                return y
            },
            ATOM: "yy-mm-dd",
            COOKIE: "D, dd M yy",
            ...
            formatDate: function(i, t, e) {
                ...
                var s = (e ? e.dayNamesShort : null) || this._defaults.dayNamesShort,
                    ...
                    r = function(t) {
                        var e = u + 1 < i.length && i.charAt(u + 1) == t;
                        return e && u++, e
                    },
                    l = function(t, e, i) {
                        var s = "" + e;
                ...
                if (t)
                    for (var u = 0; u < i.length; u++)
                        if (d) "'" != i.charAt(u) || r("'") ? c += i.charAt(u) : d = !1;
                        else switch (i.charAt(u)) {
                            case "d":
                                c += l("d", t.getDate(), 2);
                                break;
                            case "D":
            ...
            _generateHTML: function(t) {
                ...
                if (f < 0 && (f += 12, p--), u) {
                    ...
                    for (m = d && m < d ? d : m; this._daylightSavingAdjust(new Date(p, f, 1)) > m;) --f < 0 && (f = 11, p--)
                }
                ...
                _ = a ? this.formatDate(_, this._daylightSavingAdjust(new Date(p, f + l, 1)), this._getFormatConfig(t)) : _;
                ...
                b = a ? this.formatDate(b, w, this._getFormatConfig(t)) : b;
                var D = t.inline ? "" : '<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" data-handler="hide" data-event="click">' + this._get(t, "closeText") + "</button>",
                    C = s ? '<div class="ui-datepicker-buttonpane ui-widget-content">' + (i ? D : "") + (this._isInRange(t, w) ? '<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" data-handler="today" data-event="click">' + b + "</button>" : "") + (i ? "" : D) + "</div>" : "",
                    k = parseInt(this._get(t, "firstDay"), 10);
                k = isNaN(k) ? 0 : k;
                for (var x = this._get(t, "showWeek"), S = this._get(t, "dayNames"), I = (this._get(t, "dayNamesShort"), this._get(t, "dayNamesMin")), T = this._get(t, "monthNames"), M = this._get(t, "monthNamesShort"), E = this._get(t, "beforeShowDay"), P = this._get(t, "showOtherMonths"), A = this._get(t, "selectOtherMonths"), O = (this._get(t, "calculateWeek") || this.iso8601Week, this._getDefaultDate(t)), F = "", N = 0; N < o[0]; N++) {
                    var Y = "";
                    this.maxRows = 4;
                    for (var H = 0; H < o[1]; H++) {
                        var z = this._daylightSavingAdjust(new Date(p, f, t.selectedDay)),
                            W = " ui-corner-all",
                            L = "";
                        if (h) {
                            if (L += '<div class="ui-datepicker-group', 1 < o[1]) switch (H) {
                                case 0:
                        ...
                        L += '<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix' + W + '">' + (/all|left/.test(W) && 0 == N ? i ? y : v : "") + (/all|right/.test(W) && 0 == N ? i ? v : y : "") + this._generateMonthYearHeader(t, f, p, d, u, 0 < N || 0 < H, T, M) + '</div><table class="ui-datepicker-calendar"><thead><tr>';
                        for (var R = x ? '<th class="ui-datepicker-week-col">' + this._get(t, "weekHeader") + "</th>" : "", j = 0; j < 7; j++) {
                            var B = (j + k) % 7;
                            R += "<th" + (5 <= (j + k + 6) % 7 ? ' class="ui-datepicker-week-end"' : "") + '><span title="' + S[B] + '">' + I[B] + "</span></th>"
                        }
                        L += R + "</tr></thead><tbody>";
                        var q = this._getDaysInMonth(p, f);
                        p == t.selectedYear && f == t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, q));
                        var U = (this._getFirstDayOfMonth(p, f) - k + 7) % 7,
                            V = Math.ceil((U + q) / 7),
                            Q = h && this.maxRows > V ? this.maxRows : V;
                        this.maxRows = Q;
                        for (var K = this._daylightSavingAdjust(new Date(p, f, 1 - U)), G = 0; G < Q; G++) {
                            L += "<tr>";
                            var X = x ? '<td class="ui-datepicker-week-col">' + this._get(t, "calculateWeek")(K) + "</td>" : "";
                            for (j = 0; j < 7; j++) {
                                var Z = E ? E.apply(t.input ? t.input[0] : null, [K]) : [!0, ""],
                                    J = K.getMonth() != f,
                                    tt = J && !A || !Z[0] || d && K < d || u && u < K;
                                X += '<td class="' + (5 <= (j + k + 6) % 7 ? " ui-datepicker-week-end" : "") + (J ? " ui-datepicker-other-month" : "") + (K.getTime() == z.getTime() && f == t.selectedMonth && t._keyEvent || O.getTime() == K.getTime() && O.getTime() == z.getTime() ? " " + this._dayOverClass : "") + (tt ? " " + this._unselectableClass + " ui-state-disabled" : "") + (J && !P ? "" : " " + Z[1] + (K.getTime() == c.getTime() ? " " + this._currentClass : "") + (K.getTime() == e.getTime() ? " ui-datepicker-today" : "")) + '"' + (J && !P || !Z[2] ? "" : ' title="' + Z[2] + '"') + (tt ? "" : ' data-handler="selectDay" data-event="click" data-month="' + K.getMonth() + '" data-year="' + K.getFullYear() + '"') + ">" + (J && !P ? "&#xa0;" : tt ? '<span class="ui-state-default">' + K.getDate() + "</span>" : '<a class="ui-state-default' + (K.getTime() == e.getTime() ? " ui-state-highlight" : "") + (K.getTime() == c.getTime() ? " ui-state-active" : "") + (J ? " ui-priority-secondary" : "") + '" href="#">' + K.getDate() + "</a>") + "</td>", K.setDate(K.getDate() + 1), K = this._daylightSavingAdjust(K)
                            }
                            L += X + "</tr>"
                        }
                        11 < ++f && (f = 0, p++), Y += L += "</tbody></table>" + (h ? "</div>" + (0 < o[0] && H == o[1] - 1 ? '<div class="ui-datepicker-row-break"></div>' : "") : "")
                    }
                    F += Y
                }
                return F += C + ($.browser.msie && parseInt($.browser.version, 10) < 7 && !t.inline ? '<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>' : ""), t._keyEvent = !1, F
            },
            _generateMonthYearHeader: function(t, e, i, s, n, a, o, r) {
                var l = this._get(t, "changeMonth"),
                    ...
                    u = "";
                if (a || !l) u += '<span class="ui-datepicker-month">' + o[e] + "</span>";
                else {
                    var f = s && s.getFullYear() == i,
                        p = n && n.getFullYear() == i;
                    u += '<select class="ui-datepicker-month" data-handler="selectMonth" data-event="change">';
                    for (var m = 0; m < 12; m++)(!f || m >= s.getMonth()) && (!p || m <= n.getMonth()) && (u += '<option value="' + m + '"' + (m == e ? ' selected="selected"' : "") + ">" + r[m] + "</option>");
                    u += "</select>"
                }
                if (c || (d += u + (!a && l && h ? "" : "&#xa0;")), !t.yearshtml)
                    if (t.yearshtml = "", a || !h) d += '<span class="ui-datepicker-year">' + i + "</span>";
                    else {
                        var g = this._get(t, "yearRange").split(":"),
                            ...
                            y = _(g[0]),
                            b = Math.max(y, _(g[1] || ""));
                        for (y = s ? Math.max(y, s.getFullYear()) : y, b = n ? Math.min(b, n.getFullYear()) : b, t.yearshtml += '<select class="ui-datepicker-year" data-handler="selectYear" data-event="change">'; y <= b; y++) t.yearshtml += '<option value="' + y + '"' + (y == i ? ' selected="selected"' : "") + ">" + y + "</option>";
                        t.yearshtml += "</select>", d += t.yearshtml, t.yearshtml = null
                    }
                return d += this._get(t, "yearSuffix"), c && (d += (!a && l && h ? "" : "&#xa0;") + u), d += "</div>"
            },
        ...
        r.widget("ui.dialog", {
            ...
            _makeResizable: function(t) {
                ...
                var s = this,
                    ...
                    a = "string" == typeof t ? t : "n,e,s,w,se,sw,ne,nw";
            ...
            _setOption: function(t, e) {
                ...
                switch (t) {
                    ...
                    case "position":
                        ...
                        break;
                    case "resizable":
                        var a = s.is(":data(resizable)");
                        a && !e && s.resizable("destroy"), a && "string" == typeof e && s.resizable("option", "handles", e), !a && !1 !== e && i._makeResizable(e);
                        break;
                    case "title":
            ...
            _size: function() {
                ...
                if (this.element.show().css({
                    ...
                    if (r.support.minHeight) this.element.css({
                        minHeight: e,
                        height: "auto"
                    });
                    else {
    ...
    function(m, t) {
        ...
        m.fn.position = function(h) {
                ...
                return u = 9 === e.nodeType ? (c = t.width(), d = t.height(), {
                    top: 0,
                    left: 0
                }) : e.setTimeout ? (c = t.width(), d = t.height(), {
                    top: t.scrollTop(),
                    left: t.scrollLeft()
                }) : e.preventDefault ? (h.at = "left top", c = d = 0, {
                    top: h.of.pageY,
                    left: h.of.pageX
                }) : (c = t.outerWidth(), d = t.outerHeight(), t.offset()), m.each(["my", "at"], function() {
                    var t = (h[this] || "").split(" ");
                    1 === t.length && (t = i.test(t[0]) ? t.concat([g]) : s.test(t[0]) ? [g].concat(t) : [g, g]), t[0] = i.test(t[0]) ? t[0] : g, t[1] = s.test(t[1]) ? t[1] : g, h[this] = t
                }), 1 === f.length && (f[1] = f[0]), p[0] = parseInt(p[0], 10) || 0, 1 === p.length && (p[1] = p[0]), p[1] = parseInt(p[1], 10) || 0, "right" === h.at[0] ? u.left += c : h.at[0] === g && (u.left += c / 2), "bottom" === h.at[1] ? u.top += d : h.at[1] === g && (u.top += d / 2), u.left += p[0], u.top += p[1], this.each(function() {
                    var i, t = m(this),
                        s = t.outerWidth(),
                        n = t.outerHeight(),
                        e = parseInt(m.curCSS(this, "marginLeft", !0)) || 0,
                        a = parseInt(m.curCSS(this, "marginTop", !0)) || 0,
                        o = s + e + (parseInt(m.curCSS(this, "marginRight", !0)) || 0),
                        r = n + a + (parseInt(m.curCSS(this, "marginBottom", !0)) || 0),
                        l = m.extend({}, u);
                    "right" === h.my[0] ? l.left -= s : h.my[0] === g && (l.left -= s / 2), "bottom" === h.my[1] ? l.top -= n : h.my[1] === g && (l.top -= n / 2), v.fractions || (l.left = Math.round(l.left), l.top = Math.round(l.top)), i = {
                        left: l.left - e,
                        top: l.top - a
                    }, m.each(["left", "top"], function(t, e) {
                        m.ui.position[f[t]] && m.ui.position[f[t]][e](l, {
                            targetWidth: c,
                            targetHeight: d,
                            elemWidth: s,
                            elemHeight: n,
                    ...
                    }), m.fn.bgiframe && t.bgiframe(), t.offset(m.extend(l, {
                        using: h.using
                    }))
                })
            }, m.ui.position = {
                    ...
                    left: function(t, e) {
                        if (e.at[0] !== g) {
                            var i = m(window),
                                ...
                                a = "left" === e.at[0] ? e.targetWidth : -e.targetWidth,
                                o = -2 * e.offset[0];
                            t.left += e.collisionPosition.left < 0 ? n + a + o : 0 < s ? n + a + o : 0
                        }
                    },
                    top: function(t, e) {
                        if (e.at[1] !== g) {
                            var i = m(window),
                                ...
                                a = "top" === e.at[1] ? e.targetHeight : -e.targetHeight,
                                o = -2 * e.offset[1];
                            t.top += e.collisionPosition.top < 0 ? n + a + o : 0 < s ? n + a + o : 0
                        }
                    }
                }
                ...
                var i = m(t),
                    ...
                    a = parseInt(m.curCSS(t, "left", !0), 10) || 0,
                    o = {
                        top: e.top - s.top + n,
                        left: e.left - s.left + a
                    };
                "using" in e ? e.using.call(t, o) : i.css(o)
            }, m.fn.offset = function(e) {
                var t = this[0];
                return t && t.ownerDocument ? e ? m.isFunction(e) ? this.each(function(t) {
                    m(this).offset(e.call(this, t, m(this).offset()))
                }) : this.each(function() {
                    m.offset.setOffset(this, e)
                }) : a.call(this) : null
            }),
            function() {
                var t, e, i, s, n, a = document.getElementsByTagName("body")[0],
                    o = document.createElement("div");
                for (var r in t = document.createElement(a ? "div" : "body"), i = {
                        visibility: "hidden",
                        width: 0,
                        height: 0,
                        border: 0,
                ...
                t.appendChild(o), (e = a || document.documentElement).insertBefore(t, e.firstChild), o.style.cssText = "position: absolute; left: 10.7432222px; top: 10.432325px; height: 30px; width: 201px;", s = m(o).offset(function(t, e) {
                    return e
                }).offset(), t.innerHTML = "", e.removeChild(t), n = s.top + s.left + (a ? 2e3 : 0), v.fractions = 21 < n && n < 22
            }()
    }(jQuery),
    function(i, t) {
    ...
    function(c, t) {
        c.widget("ui.slider", c.ui.mouse, {
            ...
            _mouseCapture: function(t) {
                ...
                }), !0 === h.range && this.values(1) === h.min && (o += 1, n = c(this.handles[o])), !1 !== this._start(t, o) && (this._mouseSliding = !0, a._handleIndex = o, n.addClass("ui-state-active").focus(), r = n.offset(), l = !c(t.target).parents().andSelf().is(".ui-slider-handle"), this._clickOffset = l ? {
                    left: 0,
                    top: 0
                } : {
            ...
            _slide: function(t, e, i) {
                var s, n, a;
                this.options.values && this.options.values.length ? (s = this.values(e ? 0 : 1), 2 === this.options.values.length && !0 === this.options.range && (0 === e && s < i || 1 === e && i < s) && (i = s), i !== this.values(e) && ((n = this.values())[e] = i, a = this._trigger("slide", t, {
                    handle: this.handles[e],
                    value: i,
                    values: n
        ...
        f.widget("ui.tabs", {
            ...
            _tabify: function(t) {
                ...
                var s, n, r = this,
                    l = this.options,
                    h = /^#.+/;
                this.list = this.element.find("ol,ul").eq(0), this.lis = f(" > li:has(a[href])", this.list), this.anchors = this.lis.map(function() {
                    return f("a", this)[0]
                }), this.panels = f([]), this.anchors.each(function(t, e) {
                    var i, s = f(e).attr("href"),
                        n = s.split("#")[0];
                    if (n && (n === location.toString().split("#")[0] || (i = f("base")[0]) && n === i.href) && (s = e.hash, e.href = s), h.test(s)) r.panels = r.panels.add(r.element.find(r._sanitizeSelector(s)));
                    else if (s && "#" !== s) {
                        f.data(e, "href.tabs", s), f.data(e, "load.tabs", s.replace(/#.*$/, ""));
                        var a = r._tabId(e);
                        e.href = "#" + a;
                        var o = r.element.find("#" + a);
                        o.length || (o = f(l.panelTemplate).attr("id", a).addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").insertAfter(r.panels[t - 1] || r.list)).data("destroy.tabs", !0), r.panels = r.panels.add(o)
                ...
                }), "number" != typeof l.selected && l.cookie && (l.selected = parseInt(r._cookie(), 10)), "number" != typeof l.selected && this.lis.filter(".ui-tabs-selected").length && (l.selected = this.lis.index(this.lis.filter(".ui-tabs-selected"))), l.selected = l.selected || (this.lis.length ? 0 : -1)) : null === l.selected && (l.selected = -1), l.selected = 0 <= l.selected && this.anchors[l.selected] || l.selected < 0 ? l.selected : 0, l.disabled = f.unique(l.disabled.concat(f.map(this.lis.filter(".ui-state-disabled"), function(t, e) {
                    return r.lis.index(t)
                }))).sort(), -1 != f.inArray(l.selected, l.disabled) && l.disabled.splice(f.inArray(l.selected, l.disabled), 1), this.panels.addClass("ui-tabs-hide"), this.lis.removeClass("ui-tabs-selected ui-state-active"), 0 <= l.selected && this.anchors.length && (r.element.find(r._sanitizeSelector(r.anchors[l.selected].hash)).removeClass("ui-tabs-hide"), this.lis.eq(l.selected).addClass("ui-tabs-selected ui-state-active"), r.element.queue("tabs", function() {
                    r._trigger("show", null, r._ui(r.anchors[l.selected], r.element.find(r._sanitizeSelector(r.anchors[l.selected].hash))[0]))
                }), this.load(l.selected)), f(window).bind("unload", function() {
                ...
                for (var e, a = 0; e = this.lis[a]; a++) f(e)[-1 == f.inArray(a, l.disabled) || f(e).hasClass("ui-tabs-selected") ? "removeClass" : "addClass"]("ui-state-disabled");
                ...
                var d = n ? function(t, e) {
                        f(t).closest("li").addClass("ui-tabs-selected ui-state-active"), e.hide().removeClass("ui-tabs-hide").animate(n, n.duration || "normal", function() {
                            i(e, n), r._trigger("show", null, r._ui(t, e[0]))
                        })
                    } : function(t, e) {
                        f(t).closest("li").addClass("ui-tabs-selected ui-state-active"), e.removeClass("ui-tabs-hide"), r._trigger("show", null, r._ui(t, e[0]))
                    },
                    u = s ? function(t, e) {
                        e.animate(s, s.duration || "normal", function() {
                            r.lis.removeClass("ui-tabs-selected ui-state-active"), e.addClass("ui-tabs-hide"), i(e, s), r.element.dequeue("tabs")
                        })
                    } : function(t, e, i) {
                ...
                this.anchors.bind(l.event + ".tabs", function() {
                    ...
                    i.length && r.element.queue("tabs", function() {
                        ...
                        d(t, s)
                    }), r.load(r.anchors.index(this)), f.browser.msie && this.blur()
            ...
            destroy: function() {
                ...
                return this.abort(), this.element.unbind(".tabs").removeClass("ui-tabs ui-widget ui-widget-content ui-corner-all ui-tabs-collapsible").removeData("tabs"), this.list.removeClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all"), this.anchors.each(function() {
                    ...
                    f.data(this, "destroy.tabs") ? f(this).remove() : f(this).removeClass(["ui-state-default", "ui-corner-top", "ui-tabs-selected", "ui-state-active", "ui-state-hover", "ui-state-focus", "ui-state-disabled", "ui-tabs-panel", "ui-widget-content", "ui-corner-bottom", "ui-tabs-hide"].join(" "))
            ...
            add: function(t, e, i) {
                ...
                var s = this,
                    n = this.options,
                    a = f(n.tabTemplate.replace(/#\{href\}/g, t).replace(/#\{label\}/g, e)),
                    o = t.indexOf("#") ? this._tabId(f("a", a)[0]) : t.replace("#", "");
                a.addClass("ui-state-default ui-corner-top").data("destroy.tabs", !0);
                var r = s.element.find("#" + o);
                return r.length || (r = f(n.panelTemplate).attr("id", o).data("destroy.tabs", !0)), r.addClass("ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide"), i >= this.lis.length ? (a.appendTo(this.list), r.appendTo(this.list[0].parentNode)) : (a.insertBefore(this.lis[i]), r.insertBefore(this.panels[i])), n.disabled = f.map(n.disabled, function(t, e) {
                    return i <= t ? ++t : t
                }), this._tabify(), 1 == this.anchors.length && (n.selected = 0, a.addClass("ui-tabs-selected ui-state-active"), r.removeClass("ui-tabs-hide"), this.element.queue("tabs", function() {
            ...
            remove: function(i) {
                ...
                return e.hasClass("ui-tabs-selected") && 1 < this.anchors.length && this.select(i + (i + 1 < this.anchors.length ? 1 : -1)), t.disabled = f.map(f.grep(t.disabled, function(t, e) {
                    return t != i
                }), function(t, e) {
                    return i <= t ? --t : t
            ...
            enable: function(i) {
                i = this._getIndex(i);
                var t = this.options;
                if (-1 != f.inArray(i, t.disabled)) return this.lis.eq(i).removeClass("ui-state-disabled"), t.disabled = f.grep(t.disabled, function(t, e) {
                    return t != i
            ...
            load: function(s) {
                ...
                var n = this,
                    ...
                    t = f.data(o, "load.tabs");
                if (this.abort(), t && (0 === this.element.queue("tabs").length || !f.data(o, "cache.tabs"))) {
                    if (this.lis.eq(s).addClass("ui-state-processing"), a.spinner) {
                        var e = f("span", o);
                        e.data("label.tabs", e.html()).html(a.spinner)
                    }
                    return this.xhr = f.ajax(f.extend({}, a.ajaxOptions, {
                        url: t,
                        success: function(t, e) {
                            n.element.find(n._sanitizeSelector(o.hash)).html(t), n._cleanup(), a.cache && f.data(o, "cache.tabs", !0), n._trigger("load", null, n._ui(n.anchors[s], n.panels[s]));
                            try {
            ...
            rotate: function(e, t) {
                var i = this,
                    ...
                    a = i._unrotate || (i._unrotate = t ? function(t) {
                        n()
                    } : function(t) {
                        t.clientX && i.rotate(null)
                    });
                return e ? (this.element.bind("tabsshow", n), this.anchors.bind(s.event + ".tabs", a), n()) : (clearTimeout(i.rotation), this.element.unbind("tabsshow", n), this.anchors.unbind(s.event + ".tabs", a), delete this._rotate, delete this._unrotate), this
            }
        })
    }(jQuery),
    function(d, c) {
        var o = 0,
            ...
            m = "number",
            g = "boolean";
        d.each("branch form header step wrapper".split(" "), function() {
            l[this] = "." + (r[this] = f + "-" + this)
        }), d.widget("kf." + f, {
            version: "1.0.0",
            options: {
                animations: {
            ...
            _create: function() {
                ...
                n[0].elements ? t = n : (t = n.find("form")).length || (t = n.closest("form")), (e = n.find(s.header)).length || (e = t.find(s.header)), i.elements = {
                    ...
                    wizard: n.addClass(f)
                }, a.attr("id") || a.attr("id", f + "-" + ++o), i.elements.forward.click(function(t) {
                    ...
                    i._branchLabels[t] = d(this).parent().attr("id")
                }), i._excludesFilter = function() {
                    return !d(this).hasClass(s.stepClasses.exclude)
                }, s.transitions[p] || (s.transitions[p] = function(t) {
                    return i.stepIndex(t.nextAll(l.step))
                }), i.select.apply(i, u(s.initialStep))
            },
            _fastForward: function(s, n, a) {
                var o = 0,
                    ...
                    h = [l];
                d.isFunction(n) && (a = n, n = c),
                    function i() {
                        r._transition(l, function(t, e) {
                            if (-1 === (l = r.stepIndex(t, e))) throw new Error('[_fastForward]: Invalid step "' + t + '"');
                            if (0 <= d.inArray(l, h)) throw new Error('[_fastForward]: Recursion detected on step "' + t + '"');
            ...
            _find: function(t, e, i) {
                var s, n, a, o, r, l = [],
                    h = e instanceof jQuery ? e : d(e);

                function c(t, e) {
                    if (e === o) return s = e, !1
                }
                if (null !== t && h.length)
                    for (n = 0, a = (t = u(t)).length; n < a; n++) s = null, (r = typeof(o = t[n])) === m ? s = h.get(o) : "string" === r ? s = document.getElementById(o.replace("#", "")) : "object" === r && (o instanceof jQuery && o.length && (o = o[0]), o.nodeType && h.each(c)), s && l.push(s);
                return !1 === i ? l : d(l)
            },
            _move: function(t, e, i, s, n) {
                ...
                function r(t, e) {
                    n.call(a, t, d.isArray(s) ? s : !1 !== s ? e : c)
                }
            ...
            _state: function(t, e) {
                ...
                this.options;
                var i = d.extend(!0, {}, this._currentState);
                e = u(e || t), i.step = this.elements.steps.eq(t), i.branch = i.step.parent(), i.branchStepCount = i.branch.children(l.step).length, i.isMovingForward = t > i.stepIndex, i.stepIndexInBranch = i.branch.children(l.step).index(i.step);
                for (var s, n, a, o = 0, r = e.length; o < r; o++) t = e[o], s = this._branchLabels[t], !i.stepIndex || i.stepIndex < t ? d.inArray(t, i.stepsActivated) < 0 && (i.stepsActivated.push(t), d.inArray(s, i.branchesActivated) < 0 && i.branchesActivated.push(s)) : i.stepIndex > t && (n = d.inArray(s, i.branchesActivated) + 1, a = d.inArray(t, i.stepsActivated) + 1, 0 < n && i.branchesActivated.splice(n, i.branchesActivated.length - 1), 0 < a && i.stepsActivated.splice(a, i.stepsActivated.length - 1)), i.stepIndex = t, i.branchLabel = s;
                return i.stepsComplete = Math.max(0, this._find(i.stepsActivated, this.elements.steps).filter(this._excludesFilter).length - 1), i.stepsPossible = Math.max(0, this._find(i.branchesActivated, this.elements.branches).children(l.step).filter(this._excludesFilter).length - 1), d.extend(i, {
            ...
            _transition: function(t, e, i) {
                var s = this;
                d.isFunction(t) ? (i = t, t = s._currentState.stepIndex, e = c) : d.isFunction(e) && (i = e, e = c);
                var n, a = s.options,
                    o = s.step(t, e),
                    r = o.attr(a.stateAttribute),
                    l = r ? a.transitions[r] : a.transitions[p];
                return (n = d.isFunction(l) ? l.call(s, o, function() {
                    return i.apply(s, h.call(arguments))
                }) : r) !== c && !1 !== n && i.apply(s, u(n)), n
            },
            _update: function(t, e) {
                ...
                if (i.step) {
                    ...
                    i.step.removeClass(s.stepClasses.current).animate(s.animations.hide.properties, d.extend({}, s.animations.hide.options))
                }(this._currentState = e).step.addClass(s.stepClasses.current).animate(s.animations.show.properties, d.extend({}, s.animations.show.options)), e.isFirstStep || s.unidirectional || e.step.hasClass(s.stepClasses.unidirectional) ? this.elements.backward.attr(n, !0) : this.elements.backward.removeAttr(n), e.isLastStepInBranch && !e.step.attr(s.stateAttribute) || e.step.hasClass(s.stepClasses.stop) ? this.elements.forward.attr(n, !0) : this.elements.forward.removeAttr(n), s.enableSubmit || e.step.hasClass(s.stepClasses.submit) ? this.elements.submit.removeAttr(n) : this.elements.submit.attr(n, !0), i.step && (this._trigger("afterSelect", t, e), this._trigger(e.isMovingForward ? "afterForward" : "afterBackward", t, e))
            },
            backward: function(i, t) {
                typeof i === m && (t = i, i = c), t === c && (t = 1), this._currentState.isFirstStep || typeof t !== m || this._move(-t, !0, !1, function(t, e) {
            ...
            destroy: function() {
                var t = this.elements;
                this._trigger("beforeDestroy", null, this.state()) && (this.element.removeClass(f), t.form.removeClass(r.form), t.header.removeClass(r.header), t.steps.show().removeClass(r.step), t.stepsWrapper.removeClass(r.wrapper), t.branches.removeClass(r.branch), d.Widget.prototype.destroy.call(this), this._trigger("afterDestroy"))
            },
            form: function() {
                return this.elements.form
            },
            forward: function(i, t, e) {
                typeof i === m && (e = t, t = i, i = c), t === c && (t = 1), this._currentState.isLastStep || typeof t !== m || this._move(t, !0, e, function(t, e) {
                    this._update(i, this._state(t, e))
                })
            },
            ...
            isValidStepIndex: function(t) {
                return typeof t === m && 0 <= t && t <= this._lastStepIndex
            },
            stepCount: function() {
                return this._stepCount
            },
            select: function(i, t, e, s, n) {
                i instanceof d.Event || (n = s, s = e, e = t, t = i, i = c), t !== c && (d.isArray(t) ? (n = s, s = e, e = t[1], t = t[0]) : typeof e === g ? (n = s, s = e, e = c) : d.isArray(e) && (n = e, e = c), this._move(t, e, s, n, function(t, e) {
                    this._update(i, this._state(t, e))
                }))
            },
            state: function(t, e, i) {
                return arguments.length ? (d.isArray(t) ? (i = e, e = t[1], t = t[0]) : d.isArray(e) && (i = e, e = c), this._state(this.stepIndex(t, e), i)) : this._currentState
            },
            step: function(t, e) {
                return arguments.length ? (d.isArray(t) && (e = t[1], t = t[0]), typeof t === m ? i = this._find(t, e !== c ? this.steps(e) : this.elements.steps) : (i = this._find(t, this.elements.steps.add(this.elements.branches))) && i.hasClass(r.branch) && (i = this._find(e || 0, this.steps(i))), i) : this._currentState.step;
                var i
            },
            stepIndex: function(t, e, i) {
                return arguments.length ? (d.isArray(t) ? (i = e, e = t[1], t = t[0]) : typeof e === g && (i = e, e = c), (s = this.step(t, e)) ? (i ? s.siblings(l.step).andSelf() : this.elements.steps).index(s) : -1) : this._currentState.stepIndex;
                var s
            },
            steps: function(t) {
    ...
    function(h) {
        h.extend(h.fn, {
            ...
            rules: function(t, e) {
                ...
                if (t) {
                    var s = h.data(i.form, "validator").settings,
                        n = s.rules,
                        a = h.validator.staticRules(i);
                    switch (t) {
                        case "add":
                            h.extend(a, h.validator.normalizeRule(e)), delete a.messages, n[i.name] = a, e.messages && (s.messages[i.name] = h.extend(s.messages[i.name], e.messages));
                            break;
                        case "remove":
                ...
                var r = h.validator.normalizeRules(h.extend({}, h.validator.classRules(i), h.validator.attributeRules(i), h.validator.dataRules(i), h.validator.staticRules(i)), i);
                if (r.required) {
                    var l = r.required;
                    delete r.required, r = h.extend({
                        required: l
                    }, r)
                }
                return r
            ...
            messages: {
                ...
                number: "Ingresa un numero de telefono valido.",
                digits: "Ingresa un numero.",
            ...
            prototype: {
                ...
                check: function(e) {
                    ...
                    for (var a in i) {
                        ...
                        try {
                            if ("dependency-mismatch" === (t = h.validator.methods[a].call(this, n, e, o.parameters))) {
                                s = !0;
                                continue
                            }
            ...
            attributeRules: function(t) {
                ...
                for (var n in h.validator.methods) {
                    var a;
                    a = "required" === n ? ("" === (a = i.get(0).getAttribute(n)) && (a = !0), !!a) : i.attr(n), /min|max/.test(n) && (null === s || /number|range|text/.test(s)) && (a = Number(a)), a ? e[n] = a : s === n && "range" !== s && (e[n] = !0)
                }
            ...
            methods: {
                ...
                creditcard: function(t, e) {
                    ...
                    for (var i = 0, s = 0, n = !1, a = (t = t.replace(/\D/g, "")).length - 1; 0 <= a; a--) {
                        var o = t.charAt(a);
                        s = parseInt(o, 10), n && 9 < (s *= 2) && (s -= 9), i += s, n = !n
                    }
                    return i % 10 == 0
                },
                ...
                remote: function(a, o, t) {
                    if (this.optional(o)) return "dependency-mismatch";
                    var r = this.previousValue(o);
                    if (this.settings.messages[o.name] || (this.settings.messages[o.name] = {}), r.originalMessage = this.settings.messages[o.name].remote, this.settings.messages[o.name].remote = r.message, t = "string" == typeof t && {
                            url: t
                        } || t, r.old === a) return r.valid;
                    r.old = a;
                    var l = this;
                    this.startRequest(o);
                    var e = {};
                    return e[o.name] = a, h.ajax(h.extend(!0, {
                        url: t,
                        mode: "abort",
                        ...
                        data: e,
                        success: function(t) {
                            l.settings.messages[o.name].remote = r.originalMessage;
                            var e = !0 === t || "true" === t;
                            if (e) {
                                var i = l.formSubmitted;
                                l.prepareElement(o), l.formSubmitted = i, l.successList.push(o), delete l.invalid[o.name], l.showErrors()
                            } else {
                                var s = {},
                                    n = t || l.defaultMessage(o, "remote");
                                s[o.name] = r.message = h.isFunction(n) ? n(a) : n, l.invalid[o.name] = !0, l.showErrors(s)
                            }
                            r.valid = e, l.stopRequest(o, e)
                        }
                    }, t)), "pending"
                }
            }
    ...
    function(s) {
        ...
        if (s.ajaxPrefilter) s.ajaxPrefilter(function(t, e, i) {
            ...
            s.ajax = function(t) {
                ...
                return "abort" === e ? (n[i] && n[i].abort(), n[i] = a.apply(this, arguments), n[i]) : a.apply(this, arguments)
            }
        }
    }(jQuery),
    function(n) {
    ...
    function(l) {
        l.fn.ddslick = function(t) {
            return e[t] ? e[t].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof t && t ? void l.error("Method " + t + " does not exists.") : e.init.apply(this, arguments)
        };
        var e = {},
            t = {
                data: [],
        ...
        function h(t, e) {
            var i, s, n, a, o = t.data("ddslick"),
                r = t.find(".dd-selected"),
                l = r.siblings(".dd-selected-value"),
                h = (t.find(".dd-options"), r.siblings(".dd-pointer"), t.find(".dd-option").eq(e)),
                c = h.closest("li"),
                d = o.settings,
                u = o.settings.data[e];
            t.find(".dd-option").removeClass("dd-option-selected"), h.addClass("dd-option-selected"), o.selectedIndex = e, o.selectedItem = c, o.selectedData = u, d.showSelectedHTML ? r.html((u.imageSrc ? '<img class="dd-selected-image' + ("right" == d.imagePosition ? " dd-image-right" : "") + '" src="' + u.imageSrc + '" />' : "") + (u.text ? '<label class="dd-selected-text">' + u.text + "</label>" : "") + (u.description ? '<small class="dd-selected-description dd-desc' + (d.truncateDescription ? " dd-selected-description-truncated" : "") + '" >' + u.description + "</small>" : "")) : r.html(u.text), l.val(u.value), o.original.val(u.value), t.data("ddslick", o), f(t), s = (i = t).find(".dd-select").css("height"), n = i.find(".dd-selected-description"), a = i.find(".dd-selected-image"), n.length <= 0 && 0 < a.length && i.find(".dd-selected-text").css("lineHeight", s), "function" == typeof d.onSelected && d.onSelected.call(this, o)
        }

        function c(t) {
            var n, e = t.find(".dd-select"),
                i = e.siblings(".dd-options"),
                s = e.find(".dd-pointer"),
                a = i.is(":visible");
            l(".dd-click-off-close").not(i).slideUp(50), l(".dd-pointer").removeClass("dd-pointer-up"), a ? (i.slideUp("fast"), s.removeClass("dd-pointer-up")) : (i.slideDown("fast"), s.addClass("dd-pointer-up")), (n = t).find(".dd-option").each(function() {
                var t = l(this),
                    e = t.css("height"),
                    i = t.find(".dd-option-description"),
                    s = n.find(".dd-option-image");
                i.length <= 0 && 0 < s.length && t.find(".dd-option-text").css("lineHeight", e)
            })
        }
        ...
        l("#css-ddslick").length <= 0 && l('<style id="css-ddslick" type="text/css">.dd-select{ border-radius:4px; border:solid 1px #ededed; position:relative; cursor:pointer; }.dd-desc { color:#aaa; display:block; overflow: hidden; font-weight:normal; line-height: 1em; }.dd-selected{ overflow:hidden; display:block; padding:10px; font-weight:normal;}.dd-pointer{ width:0; height:0; position:absolute; right:10px; top:50%; margin-top:-3px;}.dd-pointer-down{ border:solid 5px transparent; border-top:solid 5px #000; }.dd-pointer-up{border:solid 5px transparent !important; border-bottom:solid 5px #000 !important; margin-top:-8px;}.dd-options{ border:solid 1px #ededed; list-style:none; box-shadow:none; display:none; position:absolute; z-index:2000; margin:5px 0 0 0; padding:0;background:#fff; overflow:auto;}.dd-option{ padding:10px; display:block; border-bottom:solid 1px #ededed; overflow:hidden; text-decoration:none; color:#999; cursor:pointer;-webkit-transition: all 0.25s ease-in-out; -moz-transition: all 0.25s ease-in-out;-o-transition: all 0.25s ease-in-out;-ms-transition: all 0.25s ease-in-out; }.dd-options > li:last-child > .dd-option{ border-bottom:none;}.dd-option:hover{ background:#f3f3f3; color:#000;}.dd-selected-description-truncated { text-overflow: ellipsis; white-space:nowrap; }.dd-option-selected { background:#f6f6f6; }.dd-option-image, .dd-selected-image { vertical-align:middle; float:left; margin-right:5px; max-width:64px;}.dd-image-right { float:right; margin-right:10px; margin-left:5px;}.dd-container{ position:relative;}​ .dd-selected-text { font-weight:normal}​</style>').appendTo("head"), e.init = function(r) {
            ...
            return this.each(function() {
                ...
                if (!t.data("ddslick")) {
                    ...
                    }), r.keepJSONItemsOnTop ? l.merge(r.data, i) : r.data = l.merge(i, r.data);
                    var e = t,
                        s = l('<div id="' + t.attr("id") + '"></div>');
                    t.replaceWith(s), (t = s).addClass("dd-container").append('<div class="dd-select"><input class="dd-selected-value required" type="hidden" /><a class="dd-selected"></a></div>').append('<ul class="dd-options"></ul>'), t.find("input.dd-selected-value").attr("name", l(e).attr("name"));
                    i = t.find(".dd-select");
                    var n = t.find(".dd-options");
                    n.css({
                        width: r.width
                    }), i.css({
                        width: r.width,
                        ...
                        height: r.height,
                        overflow: "auto"
                    }), l.each(r.data, function(t, e) {
                        e.selected && (r.defaultSelectedIndex = t), n.append('<li><a class="dd-option">' + (e.value ? ' <input class="dd-option-value" type="hidden" value="' + e.value + '" />' : "") + (e.imageSrc ? ' <img class="dd-option-image' + ("right" == r.imagePosition ? " dd-image-right" : "") + '" src="' + e.imageSrc + '" />' : "") + (e.text ? ' <label class="dd-option-text">' + e.text + "</label>" : "") + (e.description ? ' <small class="dd-option-description dd-desc">' + e.description + "</small>" : "") + "</a></li>")
                    });
                    var a = {
                        settings: r,
                        original: e,
                    ...
                    if (t.data("ddslick", a), 0 < r.selectText.length && null == r.defaultSelectedIndex) t.find(".dd-selected").html(r.selectText);
                    else {
                        var o = null != r.defaultSelectedIndex && 0 <= r.defaultSelectedIndex && r.defaultSelectedIndex < r.data.length ? r.defaultSelectedIndex : 0;
                        h(t, o)
                    }
                    t.find(".dd-select").on("click.ddslick", function() {
                        c(t)
                    }), t.find(".dd-option").on("click.ddslick", function() {
                        h(t, l(this).closest("li").index())
                    }), r.clickOffToClose && (n.addClass("dd-click-off-close"), t.on("click.ddslick", function(t) {
                        t.stopPropagation()
                    }), l("body").on("click", function() {
                        l(".dd-click-off-close").slideUp(50).siblings(".dd-select").find(".dd-pointer").removeClass("dd-pointer-up")
                    }))
                }
            })
        }, e.select = function(t) {
            return this.each(function() {
                t.index && h(l(this), t.index)
            })
        }, e.open = function() {
            return this.each(function() {
                var t = l(this);
        ...
        a.fn.niceSelect = function(t) {
            ...
            function s(t) {
                ...
                s.find(".current").html(i.data("display") || i.text()), e.each(function(t) {
                    var e = a(this),
                        i = e.data("display");
                    s.find("ul").append(a("<li></li>").attr("data-value", e.val()).attr("data-display", i || null).addClass("option" + (e.is(":selected") ? " selected" : "") + (e.is(":disabled") ? " disabled" : "")).html(e.text()))
                })
            }
            this.hide(), this.each(function() {
                ...
                var e = a(this),
                    i = a(e.find(".focus") || e.find(".list .option.selected"));
    ...
    function(t, e) {
        ...
        function m(t) {
            if (null == t._isValid) {
                var e = _(t),
                    i = Vt.call(e.parsedDateParts, function(t) {
                        return null != t
                    }),
        ...
        function b(t, e) {
            var i, s, n;
            if (h(e._isAMomentObject) || (t._isAMomentObject = e._isAMomentObject), h(e._i) || (t._i = e._i), h(e._f) || (t._f = e._f), h(e._l) || (t._l = e._l), h(e._strict) || (t._strict = e._strict), h(e._tzm) || (t._tzm = e._tzm), h(e._isUTC) || (t._isUTC = e._isUTC), h(e._offset) || (t._offset = e._offset), h(e._pf) || (t._pf = _(e)), h(e._locale) || (t._locale = e._locale), 0 < Qt.length)
                for (i = 0; i < Qt.length; i++) h(n = e[s = Qt[i]]) || (t[s] = n);
            return t
        }

        function w(t) {
            b(this, t), this._d = new Date(null != t._d ? t._d.getTime() : NaN), this.isValid() || (this._d = new Date(NaN)), !1 === Kt && (Kt = !0, g.updateOffset(this), Kt = !1)
        }
        ...
        function o(t, e, i) {
            var s, n = Math.min(t.length, e.length),
                ...
                o = 0;
            for (s = 0; s < n; s++)(i && t[s] !== e[s] || !i && k(t[s]) !== k(e[s])) && o++;
            return o + a
        }

        function x(t) {
            !1 === g.suppressDeprecationWarnings && "undefined" != typeof console && console.warn && console.warn("Deprecation warning: " + t)
        }

        function t(n, a) {
            var o = !0;
            return f(function() {
                if (null != g.deprecationHandler && g.deprecationHandler(null, n), o) {
        ...
        function a(t, e) {
            null != g.deprecationHandler && g.deprecationHandler(t, e), Gt[t] || (x(e), Gt[t] = !0)
        }
        ...
        function n(t, e) {
            var i, s = f({}, t);
            for (i in e) v(e, i) && (l(t[i]) && l(e[i]) ? (s[i] = {}, f(s[i], t[i]), f(s[i], e[i])) : null != e[i] ? s[i] = e[i] : delete s[i]);
            for (i in t) v(t, i) && !v(e, i) && l(t[i]) && (s[i] = f({}, s[i]));
            return s
        }
        ...
        function M(t) {
            var e, i, s = {};
            for (i in t) v(t, i) && ((e = T(i)) && (s[e] = t[i]));
            return s
        }
        ...
        function s(e, i) {
            return function(t) {
                return null != t ? (P(this, e, t), g.updateOffset(this, i), this) : E(this, e)
            }
        }
        ...
        function F(t, e) {
            return t.isValid() ? (e = N(e, t.localeData()), ie[e] = ie[e] || function(s) {
                var t, n, e, a = s.match(te);
                for (t = 0, n = a.length; t < n; t++) se[a[t]] ? a[t] = se[a[t]] : a[t] = (e = a[t]).match(/\[[\s\S]/) ? e.replace(/^\[|\]$/g, "") : e.replace(/\\/g, "");
                return function(t) {
                    var e, i = "";
                    for (e = 0; e < n; e++) i += S(a[e]) ? a[e].call(t, s) : a[e];
                    return i
                }
        ...
        function N(t, e) {
            ...
            var s = 5;
            for (ee.lastIndex = 0; 0 <= s && ee.test(t);) t = t.replace(ee, i), ee.lastIndex = 0, s -= 1;
            return t
        }

        function Y(t, i, s) {
            be[t] = S(i) ? i : function(t, e) {
                return t && s ? s : i
            }
        }

        function H(t, e) {
            return v(be, t) ? be[t](e._strict, e._locale) : new RegExp(z(t.replace("\\", "").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g, function(t, e, i, s, n) {
                return e || i || s || n
            })))
        }
        ...
        function W(t, i) {
            ...
            for ("string" == typeof t && (t = [t]), c(i) && (s = function(t, e) {
                    e[i] = k(t)
                }), e = 0; e < t.length; e++) we[t[e]] = s
        }

        function L(t, n) {
            W(t, function(t, e, i, s) {
        ...
        function $(t, e) {
            ...
            return i = Math.min(t.date(), R(t.year(), e)), t._d["set" + (t._isUTC ? "UTC" : "") + "Month"](e, i), t
        }

        function j(t) {
            return null != t ? ($(this, t), g.updateOffset(this, !0), this) : E(this, "Month")
        }
        ...
        function B() {
            ...
            var e, i, s = [],
                n = [],
                a = [];
            for (e = 0; e < 12; e++) i = p([2e3, e]), s.push(this.monthsShort(i, "")), n.push(this.months(i, "")), a.push(this.months(i, "")), a.push(this.monthsShort(i, ""));
            for (s.sort(t), n.sort(t), a.sort(t), e = 0; e < 12; e++) s[e] = z(s[e]), n[e] = z(n[e]);
            for (e = 0; e < 24; e++) a[e] = z(a[e]);
        ...
        function Q(t, e, i) {
            var s = 7 + e - i;
            return -((7 + V(t, 0, s).getUTCDay() - e) % 7) + s - 1
        }

        function K(t, e, i, s, n) {
            var a, o, r = 1 + 7 * (e - 1) + (7 + i - s) % 7 + Q(t, s, n);
            return o = r <= 0 ? q(a = t - 1) + r : r > q(t) ? (a = t + 1, r - q(t)) : (a = t, r), {
                year: a,
                dayOfYear: o
            }
        }
        ...
        function G(t, e, i) {
            var s, n, a = Q(t.year(), e, i),
                o = Math.floor((t.dayOfYear() - a - 1) / 7) + 1;
            return o < 1 ? s = o + X(n = t.year() - 1, e, i) : o > X(t.year(), e, i) ? (s = o - X(t.year(), e, i), n = t.year() + 1) : (n = t.year(), s = o), {
                week: s,
                year: n
            }
        }
        ...
        function Z() {
            ...
            var e, i, s, n, a, o = [],
                ...
                l = [],
                h = [];
            for (e = 0; e < 7; e++) i = p([2e3, 1]).day(e), s = this.weekdaysMin(i, ""), n = this.weekdaysShort(i, ""), a = this.weekdays(i, ""), o.push(s), r.push(n), l.push(a), h.push(s), h.push(n), h.push(a);
            for (o.sort(t), r.sort(t), l.sort(t), h.sort(t), e = 0; e < 7; e++) r[e] = z(r[e]), l[e] = z(l[e]), h[e] = z(h[e]);
        ...
        function st(t) {
            var e = null;
            if (!Ve[t] && "undefined" != typeof module && module && module.exports) try {
                e = Be._abbr, require("./locale/" + t), nt(e)
            } catch (t) {}
            return Ve[t]
        }
        ...
        function nt(t, e) {
            var i;
            return t && ((i = h(e) ? ot(t) : at(t, e)) && (Be = i)), Be._abbr
        }

        function at(t, e) {
            if (null === e) return delete Ve[t], null;
            var i = Ue;
            if (e.abbr = t, null != Ve[t]) a("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."), i = Ve[t]._config;
            else if (null != e.parentLocale) {
                if (null == Ve[e.parentLocale]) return Qe[e.parentLocale] || (Qe[e.parentLocale] = []), Qe[e.parentLocale].push({
                    name: t,
                    config: e
                }), null;
                i = Ve[e.parentLocale]._config
            }
            return Ve[t] = new I(n(i, e)), Qe[t] && Qe[t].forEach(function(t) {
                at(t.name, t.config)
            }), nt(t), Ve[t]
        }
        ...
        function ot(t) {
            var e;
            if (t && t._locale && t._locale._abbr && (t = t._locale._abbr), !t) return Be;
            if (!r(t)) {
                if (e = st(t)) return e;
                t = [t]
            }
            return function(t) {
                for (var e, i, s, n, a = 0; a < t.length;) {
                    for (e = (n = it(t[a]).split("-")).length, i = (i = it(t[a + 1])) ? i.split("-") : null; 0 < e;) {
                        if (s = st(n.slice(0, e).join("-"))) return s;
        ...
        function rt(t) {
            var e, i = t._a;
            return i && -2 === _(t).overflow && (e = i[Ce] < 0 || 11 < i[Ce] ? Ce : i[ke] < 1 || i[ke] > R(i[De], i[Ce]) ? ke : i[xe] < 0 || 24 < i[xe] || 24 === i[xe] && (0 !== i[Se] || 0 !== i[Ie] || 0 !== i[Te]) ? xe : i[Se] < 0 || 59 < i[Se] ? Se : i[Ie] < 0 || 59 < i[Ie] ? Ie : i[Te] < 0 || 999 < i[Te] ? Te : -1, _(t)._overflowDayOfYear && (e < De || ke < e) && (e = ke), _(t)._overflowWeeks && -1 === e && (e = Me), _(t)._overflowWeekday && -1 === e && (e = Ee), _(t).overflow = e), t
        }

        function lt(t) {
            var e, i, s, n, a, o, r = t._i,
                l = Ke.exec(r) || Ge.exec(r);
            if (l) {
                for (_(t).iso = !0, e = 0, i = Ze.length; e < i; e++)
                    if (Ze[e][1].exec(l[1])) {
                        n = Ze[e][0], s = !1 !== Ze[e][2];
                        break
                    }
        ...
        function ht(t) {
            ...
            if (e = t._i.replace(/\([^\)]*\)|[\n\t]/g, " ").replace(/(\s\s+)/g, " ").replace(/^\s|\s$/g, ""), i = ei.exec(e)) {
                if (s = i[1] ? "ddd" + (5 === i[1].length ? ", " : " ") : "", n = "D MMM " + (10 < i[2].length ? "YYYY " : "YY "), a = "HH:mm" + (i[4] ? ":ss" : ""), i[1]) {
                    var h = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"][new Date(i[2]).getDay()];
                    if (i[1].substr(0, 3) !== h) return _(t).weekdayMismatch = !0, void(t._isValid = !1)
                }
                switch (i[5].length) {
                    case 2:
                        o = 0 === r ? " +0000" : ((r = "YXWVUTSRQPONZABCDEFGHIKLM".indexOf(i[5][1].toUpperCase()) - 12) < 0 ? " -" : " +") + ("" + r).replace(/^-?/, "0").match(/..$/)[0] + "00";
                        break;
                    case 4:
                        o = l[i[5]];
                        break;
                ...
                i[5] = o, t._i = i.splice(1).join(""), " ZZ", t._f = s + n + a + " ZZ", ut(t), _(t).rfc2822 = !0
            } else t._isValid = !1
        }
        ...
        function dt(t) {
            var e, i, s, n, a, o, r = [];
            if (!t._d) {
                for (a = t, o = void 0, o = new Date(g.now()), s = a._useUTC ? [o.getUTCFullYear(), o.getUTCMonth(), o.getUTCDate()] : [o.getFullYear(), o.getMonth(), o.getDate()], t._w && null == t._a[ke] && null == t._a[Ce] && function(t) {
                        var e, i, s, n, a, o, r, l;
                        if (null != (e = t._w).GG || null != e.W || null != e.E) a = 1, o = 4, i = ct(e.GG, t._a[De], G(mt(), 1, 4).year), s = ct(e.W, 1), ((n = ct(e.E, 1)) < 1 || 7 < n) && (l = !0);
                        else {
                            a = t._locale._week.dow, o = t._locale._week.doy;
                            var h = G(mt(), a, o);
                            i = ct(e.gg, t._a[De], h.year), s = ct(e.w, h.week), null != e.d ? ((n = e.d) < 0 || 6 < n) && (l = !0) : null != e.e ? (n = e.e + a, (e.e < 0 || 6 < e.e) && (l = !0)) : n = a
                        }
                        s < 1 || s > X(i, a, o) ? _(t)._overflowWeeks = !0 : null != l ? _(t)._overflowWeekday = !0 : (r = K(i, s, n, a, o), t._a[De] = r.year, t._dayOfYear = r.dayOfYear)
                    }(t), null != t._dayOfYear && (n = ct(t._a[De], s[De]), (t._dayOfYear > q(n) || 0 === t._dayOfYear) && (_(t)._overflowDayOfYear = !0), i = V(n, 0, t._dayOfYear), t._a[Ce] = i.getUTCMonth(), t._a[ke] = i.getUTCDate()), e = 0; e < 3 && null == t._a[e]; ++e) t._a[e] = r[e] = s[e];
                for (; e < 7; e++) t._a[e] = r[e] = null == t._a[e] ? 2 === e ? 1 : 0 : t._a[e];
                24 === t._a[xe] && 0 === t._a[Se] && 0 === t._a[Ie] && 0 === t._a[Te] && (t._nextDay = !0, t._a[xe] = 0), t._d = (t._useUTC ? V : function(t, e, i, s, n, a, o) {
                    var r = new Date(t, e, i, s, n, a, o);
                    return t < 100 && 0 <= t && isFinite(r.getFullYear()) && r.setFullYear(t), r
                }).apply(null, r), null != t._tzm && t._d.setUTCMinutes(t._d.getUTCMinutes() - t._tzm), t._nextDay && (t._a[xe] = 24)
            }
        }
        ...
        function ut(t) {
            if (t._f !== g.ISO_8601)
                if (t._f !== g.RFC_2822) {
                    t._a = [], _(t).empty = !0;
                    var e, i, s, n, a, o, r, l, h, c, d, u, f = "" + t._i,
                        p = f.length,
                        m = 0;
                    for (s = N(t._f, t._locale).match(te) || [], e = 0; e < s.length; e++) n = s[e], (i = (f.match(H(n, t)) || [])[0]) && (0 < (a = f.substr(0, f.indexOf(i))).length && _(t).unusedInput.push(a), f = f.slice(f.indexOf(i) + i.length), m += i.length), se[n] ? (i ? _(t).empty = !1 : _(t).unusedTokens.push(n), o = n, l = t, null != (r = i) && v(we, o) && we[o](r, l._a, l, o)) : t._strict && !i && _(t).unusedTokens.push(n);
                    _(t).charsLeftOver = p - m, 0 < f.length && _(t).unusedInput.push(f), t._a[xe] <= 12 && !0 === _(t).bigHour && 0 < t._a[xe] && (_(t).bigHour = void 0), _(t).parsedDateParts = t._a.slice(0), _(t).meridiem = t._meridiem, t._a[xe] = (h = t._locale, c = t._a[xe], null == (d = t._meridiem) ? c : null != h.meridiemHour ? h.meridiemHour(c, d) : (null != h.isPM && ((u = h.isPM(d)) && c < 12 && (c += 12), u || 12 !== c || (c = 0)), c)), dt(t), rt(t)
                } else ht(t);
            else lt(t)
        }
        ...
        function ft(t) {
            var e, i, s, n, a = t._i,
                o = t._f;
            return t._locale = t._locale || ot(t._l), null === a || void 0 === o && "" === a ? y({
                nullInput: !0
            }) : ("string" == typeof a && (t._i = a = t._locale.preparse(a)), D(a) ? new w(rt(a)) : (d(a) ? t._d = a : r(o) ? function(t) {
                var e, i, s, n, a;
                if (0 === t._f.length) return _(t).invalidFormat = !0, t._d = new Date(NaN);
                for (n = 0; n < t._f.length; n++) a = 0, e = b({}, t), null != t._useUTC && (e._useUTC = t._useUTC), e._f = t._f[n], ut(e), m(e) && (a += _(e).charsLeftOver, a += 10 * _(e).unusedTokens.length, _(e).score = a, (null == s || a < s) && (s = a, i = e));
                f(t, i || e)
            }(t) : o ? ut(t) : h(i = (e = t)._i) ? e._d = new Date(g.now()) : d(i) ? e._d = new Date(i.valueOf()) : "string" == typeof i ? (s = e, null !== (n = ti.exec(s._i)) ? s._d = new Date(+n[1]) : (lt(s), !1 === s._isValid && (delete s._isValid, ht(s), !1 === s._isValid && (delete s._isValid, g.createFromInputFallback(s))))) : r(i) ? (e._a = u(i.slice(0), function(t) {
            ...
            }(e) : c(i) ? e._d = new Date(i) : g.createFromInputFallback(e), m(t) || (t._d = null), t))
        }
        ...
        function pt(t, e, i, s, n) {
            ...
            return !0 !== i && !1 !== i || (s = i, i = void 0), (l(t) && function(t) {
                ...
                for (e in t) return !1;
                return !0
            }(t) || r(t) && 0 === t.length) && (t = void 0), o._isAMomentObject = !0, o._useUTC = o._isUTC = n, o._l = i, o._i = t, o._f = e, o._strict = s, (a = new w(rt(ft(o))))._nextDay && (a.add(1, "d"), a._nextDay = void 0), a
        }
        ...
        function vt(t) {
            ...
            this._isValid = function(t) {
                for (var e in t)
                    if (-1 === ni.indexOf(e) || null != t[e] && isNaN(t[e])) return !1;
                for (var i = !1, s = 0; s < ni.length; ++s)
                    if (t[ni[s]]) {
                        if (i) return !1;
                        parseFloat(t[ni[s]]) !== k(t[ni[s]]) && (i = !0)
                    }
                return !0
            }(e), this._milliseconds = +c + 1e3 * h + 6e4 * l + 1e3 * r * 60 * 60, this._days = +o + 7 * a, this._months = +n + 3 * s + 12 * i, this._data = {}, this._locale = ot(), this._bubble()
        }
        ...
        function bt(t, i) {
            O(t, 0, 0, function() {
                var t = this.utcOffset(),
                    e = "+";
                return t < 0 && (t = -t, e = "-"), e + A(~~(t / 60), 2) + i + A(~~t % 60, 2)
            })
        }
        ...
        function Dt(t, e) {
            var i, s;
            return e._isUTC ? (i = e.clone(), s = (D(t) || d(t) ? t.valueOf() : mt(t).valueOf()) - i.valueOf(), i._d.setTime(i._d.valueOf() + s), g.updateOffset(i, !1), i) : mt(t).local()
        }
        ...
        function xt(t, e) {
            ...
            return _t(t) ? l = {
                ...
                d: t._days,
                M: t._months
            } : c(t) ? (l = {}, e ? l[e] = t : l.milliseconds = t) : (h = oi.exec(t)) ? (i = "-" === h[1] ? -1 : 1, l = {
                y: 0,
                d: k(h[ke]) * i,
                h: k(h[xe]) * i,
                m: k(h[Se]) * i,
                ...
                m: St(h[7], i),
                s: St(h[8], i)
            }) : null == l ? l = {} : "object" == typeof l && ("from" in l || "to" in l) && (a = mt(l.from), o = mt(l.to), n = a.isValid() && o.isValid() ? (o = Dt(o, a), a.isBefore(o) ? r = It(a, o) : ((r = It(o, a)).milliseconds = -r.milliseconds, r.months = -r.months), r) : {
                milliseconds: 0,
                months: 0
            }, (l = {}).ms = n.milliseconds, l.M = n.months), s = new vt(l), _t(t) && v(t, "_locale") && (s._locale = t._locale), s
        }
        ...
        function Tt(s, n) {
            return function(t, e) {
                var i;
                return null === e || isNaN(+e) || (a(n, "moment()." + n + "(period, number) is deprecated. Please use moment()." + n + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."), i = t, t = e, e = i), Mt(this, xt(t = "string" == typeof t ? +t : t, e), s), this
            }
        }
        ...
        function Mt(t, e, i, s) {
            var n = e._milliseconds,
                a = yt(e._days),
                o = yt(e._months);
            t.isValid() && (s = null == s || s, n && t._d.setTime(t._d.valueOf() + n * i), a && P(t, "Date", E(t, "Date") + a * i), o && $(t, E(t, "Month") + o * i), s && g.updateOffset(t, a || o))
        }
        ...
        function Ot(t, e, i, s, n) {
            var a;
            return null == t ? G(this, s, n).year : ((a = X(t, s, n)) < e && (e = a), function(t, e, i, s, n) {
                var a = K(t, e, i, s, n),
                    o = V(a.year, 0, a.dayOfYear);
        ...
        function Ht(t, e, i) {
            if (c(t) && (e = t, t = void 0), t = t || "", null != e) return Yt(t, e, i, "month");
            var s, n = [];
            for (s = 0; s < 12; s++) n[s] = Yt(t, s, i, "month");
            return n
        }

        function zt(t, e, i, s) {
            e = ("boolean" == typeof t || (i = e = t, t = !1), c(e) && (i = e, e = void 0), e || "");
            var n = ot(),
                a = t ? n._week.dow : 0;
            if (null != i) return Yt(e, (i + a) % 7, s, "day");
            var o, r = [];
            for (o = 0; o < 7; o++) r[o] = Yt(e, (o + a) % 7, s, "day");
            return r
        }
        ...
        function qt() {
            ...
            var t, e, i = Yi(this._milliseconds) / 1e3,
                s = Yi(this._days),
                n = Yi(this._months);
            ...
            var a = C(n / 12),
                ...
                c = i,
                d = this.asSeconds();
            return d ? (d < 0 ? "-" : "") + "P" + (a ? a + "Y" : "") + (o ? o + "M" : "") + (r ? r + "D" : "") + (l || h || c ? "T" : "") + (l ? l + "H" : "") + (h ? h + "M" : "") + (c ? c + "S" : "") : "P0D"
        }
        var Ut, Vt = Array.prototype.some ? Array.prototype.some : function(t) {
                for (var e = Object(this), i = e.length >>> 0, s = 0; s < i; s++)
                    if (s in e && t.call(this, e[s], s, e)) return !0;
                return !1
            },
            Qt = g.momentProperties = [],
            Kt = !1,
            Gt = {};
        g.suppressDeprecationWarnings = !1, g.deprecationHandler = null;
        var Xt = Object.keys ? Object.keys : function(t) {
                var e, i = [];
            ...
            Zt = {},
            Jt = {},
            te = /(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g,
        ...
        }), e("month", "M"), i("month", 8), Y("M", he), Y("MM", he, ae), Y("MMM", function(t, e) {
            return e.monthsShortRegex(t)
        }), Y("MMMM", function(t, e) {
            return e.monthsRegex(t)
        }), W(["M", "MM"], function(t, e) {
            e[Ce] = k(t) - 1
        }), W(["MMM", "MMMM"], function(t, e, i, s) {
            var n = i._locale.monthsParse(t, s, i._strict);
            null != n ? e[Ce] = n : _(i).invalidMonth = t
        });
        var Ae = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
        ...
        }), O(0, ["YYYY", 4], 0, "year"), O(0, ["YYYYY", 5], 0, "year"), O(0, ["YYYYYY", 6, !0], 0, "year"), e("year", "y"), i("year", 1), Y("Y", ge), Y("YY", he, ae), Y("YYYY", fe, re), Y("YYYYY", pe, le), Y("YYYYYY", pe, le), W(["YYYYY", "YYYYYY"], De), W("YYYY", function(t, e) {
            e[De] = 2 === t.length ? g.parseTwoDigitYear(t) : k(t)
        }), W("YY", function(t, e) {
            e[De] = g.parseTwoDigitYear(t)
        }), W("Y", function(t, e) {
            e[De] = parseInt(t, 10)
        }), g.parseTwoDigitYear = function(t) {
            return k(t) + (68 < k(t) ? 1900 : 2e3)
        };
        var He = s("FullYear", !0);
        O("w", ["ww", 2], "wo", "week"), O("W", ["WW", 2], "Wo", "isoWeek"), e("week", "w"), e("isoWeek", "W"), i("week", 5), i("isoWeek", 5), Y("w", he), Y("ww", he, ae), Y("W", he), Y("WW", he, ae), L(["w", "ww", "W", "WW"], function(t, e, i, s) {
            e[s.substr(0, 1)] = k(t)
        });
        ...
        }), O("e", 0, 0, "weekday"), O("E", 0, 0, "isoWeekday"), e("day", "d"), e("weekday", "e"), e("isoWeekday", "E"), i("day", 11), i("weekday", 11), i("isoWeekday", 11), Y("d", he), Y("e", he), Y("E", he), Y("dd", function(t, e) {
            return e.weekdaysMinRegex(t)
        }), Y("ddd", function(t, e) {
            return e.weekdaysShortRegex(t)
        }), Y("dddd", function(t, e) {
            return e.weekdaysRegex(t)
        }), L(["dd", "ddd", "dddd"], function(t, e, i, s) {
            var n = i._locale.weekdaysParse(t, s, i._strict);
            null != n ? e.d = n : _(i).invalidWeekday = t
        }), L(["d", "e", "E"], function(t, e, i, s) {
            e[s] = k(t)
        });
        ...
        }), tt("a", !0), tt("A", !1), e("hour", "h"), i("hour", 13), Y("a", et), Y("A", et), Y("H", he), Y("h", he), Y("k", he), Y("HH", he, ae), Y("hh", he, ae), Y("kk", he, ae), Y("hmm", ce), Y("hmmss", de), Y("Hmm", ce), Y("Hmmss", de), W(["H", "HH"], xe), W(["k", "kk"], function(t, e, i) {
            var s = k(t);
            e[xe] = 24 === s ? 0 : s
        }), W(["a", "A"], function(t, e, i) {
            i._isPm = i._locale.isPM(t), i._meridiem = t
        }), W(["h", "hh"], function(t, e, i) {
            e[xe] = k(t), _(i).bigHour = !0
        }), W("hmm", function(t, e, i) {
            var s = t.length - 2;
            e[xe] = k(t.substr(0, s)), e[Se] = k(t.substr(s)), _(i).bigHour = !0
        }), W("hmmss", function(t, e, i) {
            var s = t.length - 4,
                n = t.length - 2;
            e[xe] = k(t.substr(0, s)), e[Se] = k(t.substr(s, 2)), e[Ie] = k(t.substr(n)), _(i).bigHour = !0
        }), W("Hmm", function(t, e, i) {
            var s = t.length - 2;
            e[xe] = k(t.substr(0, s)), e[Se] = k(t.substr(s))
        }), W("Hmmss", function(t, e, i) {
            var s = t.length - 4,
                n = t.length - 2;
            e[xe] = k(t.substr(0, s)), e[Se] = k(t.substr(s, 2)), e[Ie] = k(t.substr(n))
        });
        var Be, qe = s("Hours", !0),
            Ue = {
                calendar: {
            ...
            ti = /^\/?Date\((\-?\d+)/i,
            ei = /^((?:Mon|Tue|Wed|Thu|Fri|Sat|Sun),?\s)?(\d?\d\s(?:Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\s(?:\d\d)?\d\d\s)(\d\d:\d\d)(\:\d\d)?(\s(?:UT|GMT|[ECMP][SD]T|[A-IK-Za-ik-z]|[+-]\d{4}))$/;
        g.createFromInputFallback = t("value provided is not in a recognized RFC2822 or ISO format. moment construction falls back to js Date(), which is not reliable across all browsers and versions. Non RFC2822/ISO date formats are discouraged and will be removed in an upcoming major release. Please refer to http://momentjs.com/guides/#/warnings/js-date/ for more info.", function(t) {
            t._d = new Date(t._i + (t._useUTC ? " UTC" : ""))
        }), g.ISO_8601 = function() {}, g.RFC_2822 = function() {};
        var ii = t("moment().min is deprecated, use moment.max instead. http://momentjs.com/guides/#/warnings/min-max/", function() {
                var t = mt.apply(null, arguments);
                return this.isValid() && t.isValid() ? t < this ? this : t : y()
            }),
            si = t("moment().max is deprecated, use moment.min instead. http://momentjs.com/guides/#/warnings/min-max/", function() {
                var t = mt.apply(null, arguments);
                return this.isValid() && t.isValid() ? this < t ? this : t : y()
            }),
            ni = ["year", "quarter", "month", "week", "day", "hour", "minute", "second", "millisecond"];
        bt("Z", ":"), bt("ZZ", ""), Y("Z", _e), Y("ZZ", _e), W(["Z", "ZZ"], function(t, e, i) {
            i._useUTC = !0, i._tzm = wt(_e, t)
        });
        var ai = /([\+\-]|\d\d)/gi;
        ...
        var ci = t("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.", function(t) {
        ...
        }), At("gggg", "weekYear"), At("ggggg", "weekYear"), At("GGGG", "isoWeekYear"), At("GGGGG", "isoWeekYear"), e("weekYear", "gg"), e("isoWeekYear", "GG"), i("weekYear", 1), i("isoWeekYear", 1), Y("G", ge), Y("g", ge), Y("GG", he, ae), Y("gg", he, ae), Y("GGGG", fe, re), Y("gggg", fe, re), Y("GGGGG", pe, le), Y("ggggg", pe, le), L(["gggg", "ggggg", "GGGG", "GGGGG"], function(t, e, i, s) {
            e[s.substr(0, 2)] = k(t)
        }), L(["gg", "GG"], function(t, e, i, s) {
            e[s] = g.parseTwoDigitYear(t)
        }), O("Q", 0, "Qo", "quarter"), e("quarter", "Q"), i("quarter", 7), Y("Q", ne), W("Q", function(t, e) {
            e[Ce] = 3 * (k(t) - 1)
        }), O("D", ["DD", 2], "Do", "date"), e("date", "D"), i("date", 9), Y("D", he), Y("DD", he, ae), Y("Do", function(t, e) {
            return t ? e._dayOfMonthOrdinalParse || e._ordinalParse : e._dayOfMonthOrdinalParseLenient
        }), W(["D", "DD"], ke), W("Do", function(t, e) {
            e[ke] = k(t.match(he)[0])
        });
        var di = s("Date", !0);
        O("DDD", ["DDDD", 3], "DDDo", "dayOfYear"), e("dayOfYear", "DDD"), i("dayOfYear", 4), Y("DDD", ue), Y("DDDD", oe), W(["DDD", "DDDD"], function(t, e, i) {
            i._dayOfYear = k(t)
        }), O("m", ["mm", 2], 0, "minute"), e("minute", "m"), i("minute", 14), Y("m", he), Y("mm", he, ae), W(["m", "mm"], Se);
        var ui = s("Minutes", !1);
        O("s", ["ss", 2], 0, "second"), e("second", "s"), i("second", 15), Y("s", he), Y("ss", he, ae), W(["s", "ss"], Ie);
        var fi, pi = s("Seconds", !1);
        for (O("S", 0, 0, function() {
            ...
            }), e("millisecond", "ms"), i("millisecond", 16), Y("S", ue, ne), Y("SS", ue, ae), Y("SSS", ue, oe), fi = "SSSS"; fi.length <= 9; fi += "S") Y(fi, me);
        for (fi = "S"; fi.length <= 9; fi += "S") W(fi, Ft);
        var mi = s("Milliseconds", !1);
        O("z", 0, 0, "zoneAbbr"), O("zz", 0, 0, "zoneName");
        var gi = w.prototype;
        gi.add = li, gi.calendar = function(t, e) {
            var i = t || mt(),
                s = Dt(i, this).startOf("day"),
                n = g.calendarFormat(this, s) || "sameElse",
                a = e && (S(e[n]) ? e[n].call(this, i) : e[n]);
            return this.format(a || this.localeData().calendar(n, this, mt(i)))
        }, gi.clone = function() {
            return new w(this)
        }, gi.diff = function(t, e, i) {
            var s, n, a, o, r, l, h, c, d, u;
            return this.isValid() && (s = Dt(t, this)).isValid() ? (n = 6e4 * (s.utcOffset() - this.utcOffset()), "year" === (e = T(e)) || "month" === e || "quarter" === e ? (r = this, d = 12 * ((l = s).year() - r.year()) + (l.month() - r.month()), u = r.clone().add(d, "months"), c = l - u < 0 ? (h = r.clone().add(d - 1, "months"), (l - u) / (u - h)) : (h = r.clone().add(d + 1, "months"), (l - u) / (h - u)), o = -(d + c) || 0, "quarter" === e ? o /= 3 : "year" === e && (o /= 12)) : (a = this - s, o = "second" === e ? a / 1e3 : "minute" === e ? a / 6e4 : "hour" === e ? a / 36e5 : "day" === e ? (a - n) / 864e5 : "week" === e ? (a - n) / 6048e5 : a), i ? o : C(o)) : NaN
        }, gi.endOf = function(t) {
            return void 0 === (t = T(t)) || "millisecond" === t ? this : ("date" === t && (t = "day"), this.startOf(t).add(1, "isoWeek" === t ? "week" : t).subtract(1, "ms"))
        }, gi.format = function(t) {
            t || (t = this.isUtc() ? g.defaultFormatUtc : g.defaultFormat);
            var e = F(this, t);
            return this.localeData().postformat(e)
        }, gi.from = function(t, e) {
            return this.isValid() && (D(t) && t.isValid() || mt(t).isValid()) ? xt({
                to: this,
                from: t
            }).locale(this.locale()).humanize(!e) : this.localeData().invalidDate()
        }, gi.fromNow = function(t) {
        ...
        }, gi.invalidAt = function() {
            return _(this).overflow
        }, gi.isAfter = function(t, e) {
            var i = D(t) ? t : mt(t);
            return !(!this.isValid() || !i.isValid()) && ("millisecond" === (e = T(h(e) ? "millisecond" : e)) ? this.valueOf() > i.valueOf() : i.valueOf() < this.clone().startOf(e).valueOf())
        }, gi.isBefore = function(t, e) {
            var i = D(t) ? t : mt(t);
            return !(!this.isValid() || !i.isValid()) && ("millisecond" === (e = T(h(e) ? "millisecond" : e)) ? this.valueOf() < i.valueOf() : this.clone().endOf(e).valueOf() < i.valueOf())
        }, gi.isBetween = function(t, e, i, s) {
            return ("(" === (s = s || "()")[0] ? this.isAfter(t, i) : !this.isBefore(t, i)) && (")" === s[1] ? this.isBefore(e, i) : !this.isAfter(e, i))
        }, gi.isSame = function(t, e) {
            var i, s = D(t) ? t : mt(t);
            return !(!this.isValid() || !s.isValid()) && ("millisecond" === (e = T(e || "millisecond")) ? this.valueOf() === s.valueOf() : (i = s.valueOf(), this.clone().startOf(e).valueOf() <= i && i <= this.clone().endOf(e).valueOf()))
        }, gi.isSameOrAfter = function(t, e) {
            return this.isSame(t, e) || this.isAfter(t, e)
        }, gi.isSameOrBefore = function(t, e) {
            return this.isSame(t, e) || this.isBefore(t, e)
        }, gi.isValid = function() {
            return m(this)
        }, gi.lang = ci, gi.locale = Et, gi.localeData = Pt, gi.max = si, gi.min = ii, gi.parsingFlags = function() {
            return f({}, _(this))
        }, gi.set = function(t, e) {
            if ("object" == typeof t)
                for (var i = function(t) {
                    ...
                    }(t = M(t)), s = 0; s < i.length; s++) this[i[s].unit](t[i[s].unit]);
            else if (S(this[t = T(t)])) return this[t](e);
            return this
        }, gi.startOf = function(t) {
            switch (t = T(t)) {
                case "year":
                    this.month(0);
                case "quarter":
        ...
        }, gi.subtract = hi, gi.toArray = function() {
            return [this.year(), this.month(), this.date(), this.hour(), this.minute(), this.second(), this.millisecond()]
        }, gi.toObject = function() {
            return {
                years: this.year(),
                months: this.month(),
                date: this.date(),
        ...
        }, gi.toISOString = function() {
            if (!this.isValid()) return null;
            var t = this.clone().utc();
            return t.year() < 0 || 9999 < t.year() ? F(t, "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]") : S(Date.prototype.toISOString) ? this.toDate().toISOString() : F(t, "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]")
        }, gi.inspect = function() {
        ...
        }, gi.toString = function() {
            return this.clone().locale("en").format("ddd MMM DD YYYY HH:mm:ss [GMT]ZZ")
        }, gi.unix = function() {
            return Math.floor(this.valueOf() / 1e3)
        }, gi.valueOf = function() {
            return this._d.valueOf() - 6e4 * (this._offset || 0)
        }, gi.creationData = function() {
            return {
                input: this._i,
                format: this._f,
                locale: this._locale,
        ...
        }, gi.year = He, gi.isLeapYear = function() {
            return U(this.year())
        }, gi.weekYear = function(t) {
            return Ot.call(this, t, this.week(), this.weekday(), this.localeData()._week.dow, this.localeData()._week.doy)
        }, gi.isoWeekYear = function(t) {
            return Ot.call(this, t, this.isoWeek(), this.isoWeekday(), 1, 4)
        }, gi.quarter = gi.quarters = function(t) {
            return null == t ? Math.ceil((this.month() + 1) / 3) : this.month(3 * (t - 1) + this.month() % 3)
        }, gi.month = j, gi.daysInMonth = function() {
            return R(this.year(), this.month())
        }, gi.week = gi.weeks = function(t) {
            var e = this.localeData().week(this);
            return null == t ? e : this.add(7 * (t - e), "d")
        }, gi.isoWeek = gi.isoWeeks = function(t) {
            var e = G(this, 1, 4).week;
            return null == t ? e : this.add(7 * (t - e), "d")
        }, gi.weeksInYear = function() {
            var t = this.localeData()._week;
            return X(this.year(), t.dow, t.doy)
        }, gi.isoWeeksInYear = function() {
            return X(this.year(), 1, 4)
        }, gi.date = di, gi.day = gi.days = function(t) {
        ...
        }, gi.weekday = function(t) {
            if (!this.isValid()) return null != t ? this : NaN;
            var e = (this.day() + 7 - this.localeData()._week.dow) % 7;
            return null == t ? e : this.add(t - e, "d")
        }, gi.isoWeekday = function(t) {
            if (!this.isValid()) return null != t ? this : NaN;
            if (null == t) return this.day() || 7;
            var e, i, s = (e = t, i = this.localeData(), "string" == typeof e ? i.weekdaysParse(e) % 7 || 7 : isNaN(e) ? null : e);
            return this.day(this.day() % 7 ? s : s - 7)
        }, gi.dayOfYear = function(t) {
            var e = Math.round((this.clone().startOf("day") - this.clone().startOf("year")) / 864e5) + 1;
            return null == t ? e : this.add(t - e, "d")
        }, gi.hour = gi.hours = qe, gi.minute = gi.minutes = ui, gi.second = gi.seconds = pi, gi.millisecond = gi.milliseconds = mi, gi.utcOffset = function(t, e, i) {
            var s, n = this._offset || 0;
            if (!this.isValid()) return null != t ? this : NaN;
            if (null == t) return this._isUTC ? n : Ct(this);
            if ("string" == typeof t) {
                if (null === (t = wt(_e, t))) return this
            } else Math.abs(t) < 16 && !i && (t *= 60);
            return !this._isUTC && e && (s = Ct(this)), this._offset = t, this._isUTC = !0, null != s && this.add(s, "m"), n !== t && (!e || this._changeInProgress ? Mt(this, xt(t - n, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, g.updateOffset(this, !0), this._changeInProgress = null)), this
        }, gi.utc = function(t) {
            return this.utcOffset(0, t)
        }, gi.local = function(t) {
            return this._isUTC && (this.utcOffset(0, t), this._isUTC = !1, t && this.subtract(Ct(this), "m")), this
        }, gi.parseZone = function() {
            ...
            return this
        }, gi.hasAlignedHourOffset = function(t) {
            return !!this.isValid() && (t = t ? mt(t).utcOffset() : 0, (this.utcOffset() - t) % 60 == 0)
        }, gi.isDST = function() {
            return this.utcOffset() > this.clone().month(0).utcOffset() || this.utcOffset() > this.clone().month(5).utcOffset()
        }, gi.isLocal = function() {
            return !!this.isValid() && !this._isUTC
        }, gi.isUtcOffset = function() {
            return !!this.isValid() && this._isUTC
        }, gi.isUtc = kt, gi.isUTC = kt, gi.zoneAbbr = function() {
            return this._isUTC ? "UTC" : ""
        }, gi.zoneName = function() {
            return this._isUTC ? "Coordinated Universal Time" : ""
        }, gi.dates = t("dates accessor is deprecated. Use date instead.", di), gi.months = t("months accessor is deprecated. Use month instead", j), gi.years = t("years accessor is deprecated. Use year instead", He), gi.zone = t("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", function(t, e) {
            return null != t ? ("string" != typeof t && (t = -t), this.utcOffset(t, e), this) : -this.utcOffset()
        }), gi.isDSTShifted = t("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information", function() {
            if (!h(this._isDSTShifted)) return this._isDSTShifted;
            var t = {};
            if (b(t, this), (t = ft(t))._a) {
                var e = t._isUTC ? p(t._a) : mt(t._a);
                this._isDSTShifted = this.isValid() && 0 < o(t._a, e.toArray())
            } else this._isDSTShifted = !1;
            return this._isDSTShifted
        });
        var vi = I.prototype;
        vi.calendar = function(t, e, i) {
            var s = this._calendar[t] || this._calendar.sameElse;
            return S(s) ? s.call(e, i) : s
        }, vi.longDateFormat = function(t) {
            var e = this._longDateFormat[t],
                i = this._longDateFormat[t.toUpperCase()];
            return e || !i ? e : (this._longDateFormat[t] = i.replace(/MMMM|MM|DD|dddd/g, function(t) {
                return t.slice(1)
            }), this._longDateFormat[t])
        }, vi.invalidDate = function() {
            return this._invalidDate
        }, vi.ordinal = function(t) {
            return this._ordinal.replace("%d", t)
        }, vi.preparse = Nt, vi.postformat = Nt, vi.relativeTime = function(t, e, i, s) {
            var n = this._relativeTime[i];
            return S(n) ? n(t, e, i, s) : n.replace(/%d/i, t)
        }, vi.pastFuture = function(t, e) {
        ...
        }, vi.monthsParse = function(t, e, i) {
            var s, n, a;
            if (this._monthsParseExact) return function(t, e, i) {
                var s, n, a, o = t.toLocaleLowerCase();
                if (!this._monthsParse)
                    for (this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = [], s = 0; s < 12; ++s) a = p([2e3, s]), this._shortMonthsParse[s] = this.monthsShort(a, "").toLocaleLowerCase(), this._longMonthsParse[s] = this.months(a, "").toLocaleLowerCase();
                return i ? -1 !== (n = "MMM" === e ? Pe.call(this._shortMonthsParse, o) : Pe.call(this._longMonthsParse, o)) ? n : null : "MMM" === e ? -1 !== (n = Pe.call(this._shortMonthsParse, o)) ? n : -1 !== (n = Pe.call(this._longMonthsParse, o)) ? n : null : -1 !== (n = Pe.call(this._longMonthsParse, o)) ? n : -1 !== (n = Pe.call(this._shortMonthsParse, o)) ? n : null
            }.call(this, t, e, i);
            for (this._monthsParse || (this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = []), s = 0; s < 12; s++) {
                if (n = p([2e3, s]), i && !this._longMonthsParse[s] && (this._longMonthsParse[s] = new RegExp("^" + this.months(n, "").replace(".", "") + "$", "i"), this._shortMonthsParse[s] = new RegExp("^" + this.monthsShort(n, "").replace(".", "") + "$", "i")), i || this._monthsParse[s] || (a = "^" + this.months(n, "") + "|^" + this.monthsShort(n, ""), this._monthsParse[s] = new RegExp(a.replace(".", ""), "i")), i && "MMMM" === e && this._longMonthsParse[s].test(t)) return s;
                if (i && "MMM" === e && this._shortMonthsParse[s].test(t)) return s;
                if (!i && this._monthsParse[s].test(t)) return s
            }
        }, vi.monthsRegex = function(t) {
            return this._monthsParseExact ? (v(this, "_monthsRegex") || B.call(this), t ? this._monthsStrictRegex : this._monthsRegex) : (v(this, "_monthsRegex") || (this._monthsRegex = Ye), this._monthsStrictRegex && t ? this._monthsStrictRegex : this._monthsRegex)
        }, vi.monthsShortRegex = function(t) {
            return this._monthsParseExact ? (v(this, "_monthsRegex") || B.call(this), t ? this._monthsShortStrictRegex : this._monthsShortRegex) : (v(this, "_monthsShortRegex") || (this._monthsShortRegex = Ne), this._monthsShortStrictRegex && t ? this._monthsShortStrictRegex : this._monthsShortRegex)
        }, vi.week = function(t) {
            return G(t, this._week.dow, this._week.doy).week
        }, vi.firstDayOfYear = function() {
            return this._week.doy
        }, vi.firstDayOfWeek = function() {
            return this._week.dow
        }, vi.weekdays = function(t, e) {
        ...
        }, vi.weekdaysMin = function(t) {
            return t ? this._weekdaysMin[t.day()] : this._weekdaysMin
        }, vi.weekdaysShort = function(t) {
            return t ? this._weekdaysShort[t.day()] : this._weekdaysShort
        }, vi.weekdaysParse = function(t, e, i) {
            var s, n, a;
            if (this._weekdaysParseExact) return function(t, e, i) {
                var s, n, a, o = t.toLocaleLowerCase();
                if (!this._weekdaysParse)
                    for (this._weekdaysParse = [], this._shortWeekdaysParse = [], this._minWeekdaysParse = [], s = 0; s < 7; ++s) a = p([2e3, 1]).day(s), this._minWeekdaysParse[s] = this.weekdaysMin(a, "").toLocaleLowerCase(), this._shortWeekdaysParse[s] = this.weekdaysShort(a, "").toLocaleLowerCase(), this._weekdaysParse[s] = this.weekdays(a, "").toLocaleLowerCase();
                return i ? -1 !== (n = "dddd" === e ? Pe.call(this._weekdaysParse, o) : "ddd" === e ? Pe.call(this._shortWeekdaysParse, o) : Pe.call(this._minWeekdaysParse, o)) ? n : null : "dddd" === e ? -1 !== (n = Pe.call(this._weekdaysParse, o)) ? n : -1 !== (n = Pe.call(this._shortWeekdaysParse, o)) ? n : -1 !== (n = Pe.call(this._minWeekdaysParse, o)) ? n : null : "ddd" === e ? -1 !== (n = Pe.call(this._shortWeekdaysParse, o)) ? n : -1 !== (n = Pe.call(this._weekdaysParse, o)) ? n : -1 !== (n = Pe.call(this._minWeekdaysParse, o)) ? n : null : -1 !== (n = Pe.call(this._minWeekdaysParse, o)) ? n : -1 !== (n = Pe.call(this._weekdaysParse, o)) ? n : -1 !== (n = Pe.call(this._shortWeekdaysParse, o)) ? n : null
            }.call(this, t, e, i);
            for (this._weekdaysParse || (this._weekdaysParse = [], this._minWeekdaysParse = [], this._shortWeekdaysParse = [], this._fullWeekdaysParse = []), s = 0; s < 7; s++) {
                if (n = p([2e3, 1]).day(s), i && !this._fullWeekdaysParse[s] && (this._fullWeekdaysParse[s] = new RegExp("^" + this.weekdays(n, "").replace(".", ".?") + "$", "i"), this._shortWeekdaysParse[s] = new RegExp("^" + this.weekdaysShort(n, "").replace(".", ".?") + "$", "i"), this._minWeekdaysParse[s] = new RegExp("^" + this.weekdaysMin(n, "").replace(".", ".?") + "$", "i")), this._weekdaysParse[s] || (a = "^" + this.weekdays(n, "") + "|^" + this.weekdaysShort(n, "") + "|^" + this.weekdaysMin(n, ""), this._weekdaysParse[s] = new RegExp(a.replace(".", ""), "i")), i && "dddd" === e && this._fullWeekdaysParse[s].test(t)) return s;
        ...
        }, vi.weekdaysRegex = function(t) {
            return this._weekdaysParseExact ? (v(this, "_weekdaysRegex") || Z.call(this), t ? this._weekdaysStrictRegex : this._weekdaysRegex) : (v(this, "_weekdaysRegex") || (this._weekdaysRegex = Re), this._weekdaysStrictRegex && t ? this._weekdaysStrictRegex : this._weekdaysRegex)
        }, vi.weekdaysShortRegex = function(t) {
            return this._weekdaysParseExact ? (v(this, "_weekdaysRegex") || Z.call(this), t ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex) : (v(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = $e), this._weekdaysShortStrictRegex && t ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex)
        }, vi.weekdaysMinRegex = function(t) {
            return this._weekdaysParseExact ? (v(this, "_weekdaysRegex") || Z.call(this), t ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (v(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = je), this._weekdaysMinStrictRegex && t ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex)
        }, vi.isPM = function(t) {
            return "p" === (t + "").toLowerCase().charAt(0)
        }, vi.meridiem = function(t, e, i) {
        ...
        }), g.lang = t("moment.lang is deprecated. Use moment.locale instead.", nt), g.langData = t("moment.langData is deprecated. Use moment.localeData instead.", ot);
        var _i = Math.abs,
            yi = jt("ms"),
            bi = jt("s"),
            wi = jt("m"),
        ...
        return Hi.isValid = function() {
            ...
            return Wt(this, t, e, 1)
        }, Hi.subtract = function(t, e) {
            return Wt(this, t, e, -1)
        }, Hi.as = function(t) {
            if (!this.isValid()) return NaN;
            var e, i, s = this._milliseconds;
            if ("month" === (t = T(t)) || "year" === t) return e = this._days + s / 864e5, i = this._months + Rt(e), "month" === t ? i : i / 12;
        ...
        }, Hi.asMilliseconds = yi, Hi.asSeconds = bi, Hi.asMinutes = wi, Hi.asHours = Di, Hi.asDays = Ci, Hi.asWeeks = ki, Hi.asMonths = xi, Hi.asYears = Si, Hi.valueOf = function() {
            return this.isValid() ? this._milliseconds + 864e5 * this._days + this._months % 12 * 2592e6 + 31536e6 * k(this._months / 12) : NaN
        }, Hi._bubble = function() {
            var t, e, i, s, n, a = this._milliseconds,
                o = this._days,
                r = this._months,
                l = this._data;
            return 0 <= a && 0 <= o && 0 <= r || a <= 0 && o <= 0 && r <= 0 || (a += 864e5 * Lt($t(r) + o), r = o = 0), l.milliseconds = a % 1e3, t = C(a / 1e3), l.seconds = t % 60, e = C(t / 60), l.minutes = e % 60, i = C(e / 60), l.hours = i % 24, r += n = C(Rt(o += C(i / 24))), o -= Lt($t(n)), s = C(r / 12), r %= 12, l.days = o, l.months = r, l.years = s, this
        }, Hi.get = function(t) {
            return t = T(t), this.isValid() ? this[t + "s"]() : NaN
        }, Hi.milliseconds = Ii, Hi.seconds = Ti, Hi.minutes = Mi, Hi.hours = Ei, Hi.days = Pi, Hi.weeks = function() {
            return C(this.days() / 7)
        }, Hi.months = Ai, Hi.years = Oi, Hi.humanize = function(t) {
            if (!this.isValid()) return this.localeData().invalidDate();
            var e, i, s, n, a, o, r, l, h, c, d, u = this.localeData(),
                f = (i = !t, s = u, n = xt(e = this).abs(), a = Fi(n.as("s")), o = Fi(n.as("m")), r = Fi(n.as("h")), l = Fi(n.as("d")), h = Fi(n.as("M")), c = Fi(n.as("y")), (d = a <= Ni.ss && ["s", a] || a < Ni.s && ["ss", a] || o <= 1 && ["m"] || o < Ni.m && ["mm", o] || r <= 1 && ["h"] || r < Ni.h && ["hh", r] || l <= 1 && ["d"] || l < Ni.d && ["dd", l] || h <= 1 && ["M"] || h < Ni.M && ["MM", h] || c <= 1 && ["y"] || ["yy", c])[2] = i, d[3] = 0 < +e, d[4] = s, function(t, e, i, s, n) {
                    return n.relativeTime(e || 1, !!i, t, s)
                }.apply(null, d));
            return t && (f = u.pastFuture(+this, f)), u.postformat(f)
        }, Hi.toISOString = qt, Hi.toString = qt, Hi.toJSON = qt, Hi.locale = Et, Hi.localeData = Pt, Hi.toIsoString = t("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", qt), Hi.lang = ci, O("X", 0, 0, "unix"), O("x", 0, 0, "valueOf"), Y("x", ge), Y("X", /[+-]?\d+(\.\d{1,3})?/), W("X", function(t, e, i) {
            i._d = new Date(1e3 * parseFloat(t, 10))
        }), W("x", function(t, e, i) {
            i._d = new Date(k(t))
        }), g.version = "2.18.1", Ut = mt, g.fn = gi, g.min = function() {
            return gt("isBefore", [].slice.call(arguments, 0))
        }, g.max = function() {
            return gt("isAfter", [].slice.call(arguments, 0))
        }, g.now = function() {
            return Date.now ? Date.now() : +new Date
        }, g.utc = p, g.unix = function(t) {
            return mt(1e3 * t)
        }, g.months = function(t, e) {
            return Ht(t, e, "months")
        }, g.isDate = d, g.locale = nt, g.invalid = y, g.duration = xt, g.isMoment = D, g.weekdays = function(t, e, i) {
            return zt(t, e, i, "weekdays")
        }, g.parseZone = function() {
            return mt.apply(null, arguments).parseZone()
        }, g.localeData = ot, g.isDuration = _t, g.monthsShort = function(t, e) {
            return Ht(t, e, "monthsShort")
        }, g.weekdaysMin = function(t, e, i) {
            return zt(t, e, i, "weekdaysMin")
        }, g.defineLocale = at, g.updateLocale = function(t, e) {
            if (null != e) {
                var i, s = Ue;
                null != Ve[t] && (s = Ve[t]._config), (i = new I(e = n(s, e))).parentLocale = Ve[t], Ve[t] = i, nt(t)
            } else null != Ve[t] && (null != Ve[t].parentLocale ? Ve[t] = Ve[t].parentLocale : null != Ve[t] && delete Ve[t]);
            return Ve[t]
        }, g.locales = function() {
            return Xt(Ve)
        }, g.weekdaysShort = function(t, e, i) {
            return zt(t, e, i, "weekdaysShort")
        }, g.normalizeUnits = T, g.relativeTimeRounding = function(t) {
            return void 0 === t ? Fi : "function" == typeof t && (Fi = t, !0)
        }, g.relativeTimeThreshold = function(t, e) {
            return void 0 !== Ni[t] && (void 0 === e ? Ni[t] : (Ni[t] = e, "s" === t && (Ni.ss = e - 1), !0))
        }, g.calendarFormat = function(t, e) {
    ...
    function(t, i) {
        ...
        var s = function(t, e, i) {
            ...
            var a, o, r;
            if (void 0 === e.startDate && void 0 === e.endDate && W(this.element).is("input[type=text]")) {
                var l = W(this.element).val(),
                    h = l.split(this.locale.separator);
                a = o = null, 2 == h.length ? (a = z(h[0], this.locale.format), o = z(h[1], this.locale.format)) : this.singleDatePicker && "" !== l && (a = z(l, this.locale.format), o = z(l, this.locale.format)), null !== a && null !== o && (this.setStartDate(a), this.setEndDate(o))
            }
            if ("object" == typeof e.ranges) {
                for (r in e.ranges) {
                    a = "string" == typeof e.ranges[r][0] ? z(e.ranges[r][0], this.locale.format) : z(e.ranges[r][0]), o = "string" == typeof e.ranges[r][1] ? z(e.ranges[r][1], this.locale.format) : z(e.ranges[r][1]), this.minDate && a.isBefore(this.minDate) && (a = this.minDate.clone());
                    var c = this.maxDate;
                    if (this.maxSpan && c && a.clone().add(this.maxSpan).isAfter(c) && (c = a.clone().add(this.maxSpan)), c && o.isAfter(c) && (o = c.clone()), !(this.minDate && o.isBefore(this.minDate, this.timepicker ? "minute" : "day") || c && a.isAfter(c, this.timepicker ? "minute" : "day"))) {
                        var d;
                        (d = document.createElement("textarea")).innerHTML = r;
                        s = d.value;
                        this.ranges[s] = [a, o]
                    }
                }
                var u = "<ul>";
                for (r in this.ranges) u += '<li data-range-key="' + r + '">' + r + "</li>";
            ...
            "function" == typeof i && (this.callback = i), this.timePicker || (this.startDate = this.startDate.startOf("day"), this.endDate = this.endDate.endOf("day"), this.container.find(".calendar-time").hide()), this.timePicker && this.autoApply && (this.autoApply = !1), this.autoApply && this.container.addClass("auto-apply"), "object" == typeof e.ranges && this.container.addClass("show-ranges"), (this.singleDatePicker || this.singleCalendar) && (this.container.addClass("single"), this.container.find(".calendar.left").addClass("single"), this.container.find(".calendar.left").show(), this.container.find(".calendar.right").hide(), this.timePicker || this.container.addClass("auto-apply")), (void 0 === e.ranges && !this.singleDatePicker || this.alwaysShowCalendars) && this.container.addClass("show-calendar"), this.container.addClass("opens" + this.opens), this.container.find(".applyBtn, .cancelBtn").addClass(this.buttonClasses), this.applyButtonClasses.length && this.container.find(".applyBtn").addClass(this.applyButtonClasses), this.cancelButtonClasses.length && this.container.find(".cancelBtn").addClass(this.cancelButtonClasses), this.container.find(".applyBtn").html(this.locale.applyLabel), this.container.find(".cancelBtn").html(this.locale.cancelLabel), this.container.find(".calendar").on("click.daterangepicker", ".prev", W.proxy(this.clickPrev, this)).on("click.daterangepicker", ".next", W.proxy(this.clickNext, this)).on("mousedown.daterangepicker", "td.available", W.proxy(this.clickDate, this)).on("change.daterangepicker", "select.yearselect", W.proxy(this.monthOrYearChanged, this)).on("change.daterangepicker", "select.monthselect", W.proxy(this.monthOrYearChanged, this)).on("change.daterangepicker", "select.hourselect,select.minuteselect,select.secondselect,select.ampmselect", W.proxy(this.timeChanged, this)), this.container.find(".ranges").on("click.daterangepicker", "li", W.proxy(this.clickRange, this)), this.container.find(".drp-buttons").on("click.daterangepicker", "button.applyBtn", W.proxy(this.clickApply, this)).on("click.daterangepicker", "button.cancelBtn", W.proxy(this.clickCancel, this)), this.element.is("input") || this.element.is("button") ? this.element.on({
                "click.daterangepicker": W.proxy(this.show, this),
                "focus.daterangepicker": W.proxy(this.show, this),
                "keyup.daterangepicker": W.proxy(this.elementChanged, this),
                "keydown.daterangepicker": W.proxy(this.keydown, this)
            }) : (this.element.on("click.daterangepicker", W.proxy(this.toggle, this)), this.element.on("keydown.daterangepicker", W.proxy(this.toggle, this))), this.element.is("input") && !this.singleDatePicker && this.autoUpdateInput ? (this.element.val(this.startDate.format(this.locale.format) + this.locale.separator + this.endDate.format(this.locale.format)), this.element.trigger("change")) : this.element.is("input") && this.autoUpdateInput && (this.element.val(this.startDate.format(this.locale.format)), this.element.trigger("change"))
        };
        return s.prototype = {
            constructor: s,
            setStartDate: function(t) {
                "string" == typeof t && (this.startDate = z(t, this.locale.format)), "object" == typeof t && (this.startDate = z(t)), this.timePicker || (this.startDate = this.startDate.startOf("day")), this.timePicker && this.timePickerIncrement && this.startDate.minute(Math.round(this.startDate.minute() / this.timePickerIncrement) * this.timePickerIncrement), this.minDate && this.startDate.isBefore(this.minDate) && (this.startDate = this.minDate.clone(), this.timePicker && this.timePickerIncrement && this.startDate.minute(Math.round(this.startDate.minute() / this.timePickerIncrement) * this.timePickerIncrement)), this.maxDate && this.startDate.isAfter(this.maxDate) && (this.startDate = this.maxDate.clone(), this.timePicker && this.timePickerIncrement && this.startDate.minute(Math.floor(this.startDate.minute() / this.timePickerIncrement) * this.timePickerIncrement)), this.isShowing || this.updateElement(), this.updateMonthsInView()
            },
            setEndDate: function(t) {
                "string" == typeof t && (this.endDate = z(t, this.locale.format)), "object" == typeof t && (this.endDate = z(t)), this.timePicker || (this.endDate = this.endDate.add(1, "d").startOf("day").subtract(1, "second")), this.timePicker && this.timePickerIncrement && this.endDate.minute(Math.round(this.endDate.minute() / this.timePickerIncrement) * this.timePickerIncrement), this.endDate.isBefore(this.startDate) && (this.endDate = this.startDate.clone()), this.maxDate && this.endDate.isAfter(this.maxDate) && (this.endDate = this.maxDate.clone()), this.maxSpan && this.startDate.clone().add(this.maxSpan).isBefore(this.endDate) && (this.endDate = this.startDate.clone().add(this.maxSpan)), this.previousRightTime = this.endDate.clone(), this.container.find(".drp-selected").html(this.startDate.format(this.locale.format) + this.locale.separator + this.endDate.format(this.locale.format)), this.isShowing || this.updateElement(), this.updateMonthsInView()
            },
            ...
            updateCalendars: function() {
                if (this.timePicker) {
                    var t, e, i, s;
                    if (this.endDate) {
                        if (t = parseInt(this.container.find(".left .hourselect").val(), 10), e = parseInt(this.container.find(".left .minuteselect").val(), 10), i = this.timePickerSeconds ? parseInt(this.container.find(".left .secondselect").val(), 10) : 0, !this.timePicker24Hour) "PM" === (s = this.container.find(".left .ampmselect").val()) && t < 12 && (t += 12), "AM" === s && 12 === t && (t = 0)
                    } else if (t = parseInt(this.container.find(".right .hourselect").val(), 10), e = parseInt(this.container.find(".right .minuteselect").val(), 10), i = this.timePickerSeconds ? parseInt(this.container.find(".right .secondselect").val(), 10) : 0, !this.timePicker24Hour) "PM" === (s = this.container.find(".right .ampmselect").val()) && t < 12 && (t += 12), "AM" === s && 12 === t && (t = 0);
            ...
            renderCalendar: function(t) {
                var e, i = (e = "left" == t ? this.leftCalendar : this.rightCalendar).month.month(),
                    s = e.month.year(),
                    n = e.month.hour(),
                    a = e.month.minute(),
                    o = e.month.second(),
                    ...
                    l = z([s, i, 1]),
                    h = z([s, i, r]),
                    c = z(l).subtract(1, "month").month(),
                    d = z(l).subtract(1, "month").year(),
                    u = z([d, c]).daysInMonth(),
                    f = l.day();
                (e = []).firstDay = l, e.lastDay = h;
                for (var p = 0; p < 6; p++) e[p] = [];
                var m = u - f + this.locale.firstDay + 1;
                u < m && (m -= 7), f == this.locale.firstDay && (m = u - 6);
                for (var g = z([d, c, m, 12, a, o]), v = (p = 0, 0), _ = 0; p < 42; p++, v++, g = z(g).add(24, "hour")) 0 < p && v % 7 == 0 && (v = 0, _++), e[_][v] = g.clone().hour(n).minute(a).second(o), g.hour(12), this.minDate && e[_][v].format("YYYY-MM-DD") == this.minDate.format("YYYY-MM-DD") && e[_][v].isBefore(this.minDate) && "left" == t && (e[_][v] = this.minDate.clone()), this.maxDate && e[_][v].format("YYYY-MM-DD") == this.maxDate.format("YYYY-MM-DD") && e[_][v].isAfter(this.maxDate) && "right" == t && (e[_][v] = this.maxDate.clone());
                "left" == t ? this.leftCalendar.calendar = e : this.rightCalendar.calendar = e;
                var y = "left" == t ? this.minDate : this.startDate,
                    b = this.maxDate,
                    w = ("left" == t ? this.startDate : this.endDate, this.locale.direction, '<table class="table-condensed">');
                w += "<thead>", w += "<tr>", (this.showWeekNumbers || this.showISOWeekNumbers) && (w += "<th></th>"), y && !y.isBefore(e.firstDay) || this.linkedCalendars && "left" != t ? w += "<th></th>" : w += '<th class="prev available"><span></span></th>';
                var D = this.locale.monthNames[e[1][1].month()] + e[1][1].format(" YYYY");
                if (this.showDropdowns) {
                    for (var C = e[1][1].month(), k = e[1][1].year(), x = b && b.year() || this.maxYear, S = y && y.year() || this.minYear, I = k == S, T = k == x, M = '<select class="monthselect">', E = 0; E < 12; E++)(!I || E >= y.month()) && (!T || E <= b.month()) ? M += "<option value='" + E + "'" + (E === C ? " selected='selected'" : "") + ">" + this.locale.monthNames[E] + "</option>" : M += "<option value='" + E + "'" + (E === C ? " selected='selected'" : "") + " disabled='disabled'>" + this.locale.monthNames[E] + "</option>";
                    M += "</select>";
                    for (var P = '<select class="yearselect">', A = S; A <= x; A++) P += '<option value="' + A + '"' + (A === k ? ' selected="selected"' : "") + ">" + A + "</option>";
                    D = M + (P += "</select>")
                }
                if (w += '<th colspan="5" class="month">' + D + "</th>", b && !b.isAfter(e.lastDay) || this.linkedCalendars && "right" != t && !this.singleDatePicker && !this.singleCalendar ? w += "<th></th>" : w += '<th class="next available"><span></span></th>', w += "</tr>", w += "<tr>", (this.showWeekNumbers || this.showISOWeekNumbers) && (w += '<th class="week">' + this.locale.weekLabel + "</th>"), W.each(this.locale.daysOfWeek, function(t, e) {
                        w += "<th>" + e + "</th>"
                ...
                for (_ = 0; _ < 6; _++) {
                    w += "<tr>", this.showWeekNumbers ? w += '<td class="week">' + e[_][0].week() + "</td>" : this.showISOWeekNumbers && (w += '<td class="week">' + e[_][0].isoWeek() + "</td>");
                    for (v = 0; v < 7; v++) {
                        var F = [];
                        e[_][v].isSame(new Date, "day") && F.push("today"), 5 < e[_][v].isoWeekday() && F.push("weekend"), e[_][v].month() != e[1][1].month() && F.push("off"), this.minDate && e[_][v].isBefore(this.minDate, "day") && F.push("off", "disabled"), b && e[_][v].isAfter(b, "day") && F.push("off", "disabled"), this.isInvalidDate(e[_][v]) && F.push("off", "disabled"), e[_][v].format("YYYY-MM-DD") == this.startDate.format("YYYY-MM-DD") && F.push("active", "start-date"), null != this.endDate && e[_][v].format("YYYY-MM-DD") == this.endDate.format("YYYY-MM-DD") && F.push("active", "end-date"), null != this.endDate && e[_][v] > this.startDate && e[_][v] < this.endDate && F.push("in-range");
                        var N = this.isCustomDate(e[_][v]);
                        !1 !== N && ("string" == typeof N ? F.push(N) : Array.prototype.push.apply(F, N));
                        var Y = "",
                            H = !1;
                        for (p = 0; p < F.length; p++) Y += F[p] + " ", "disabled" == F[p] && (H = !0);
                        H || (Y += "available"), w += '<td class="' + Y.replace(/^\s+|\s+$/g, "") + '" data-title="r' + _ + "c" + v + '">' + e[_][v].date() + "</td>"
                    }
                    w += "</tr>"
                }
            ...
            renderTimePicker: function(t) {
                if ("right" != t || this.endDate) {
                    ...
                    if (!this.maxSpan || this.maxDate && !this.startDate.clone().add(this.maxSpan).isAfter(this.maxDate) || (n = this.startDate.clone().add(this.maxSpan)), "left" == t) i = this.startDate.clone(), s = this.minDate;
                        ...
                        var a = this.container.find(".calendar.right .calendar-time");
                        if ("" != a.html() && (i.hour(i.hour() || a.find(".hourselect option:selected").val()), i.minute(i.minute() || a.find(".minuteselect option:selected").val()), i.second(i.second() || a.find(".secondselect option:selected").val()), !this.timePicker24Hour)) {
                    ...
                    for (var r = this.timePicker24Hour ? 0 : 1, l = this.timePicker24Hour ? 23 : 12, h = r; h <= l; h++) {
                        var c = h;
                        this.timePicker24Hour || (c = 12 <= i.hour() ? 12 == h ? 12 : h + 12 : 12 == h ? 0 : h);
                        var d = i.clone().hour(c),
                            u = !1;
                        s && d.minute(59).isBefore(s) && (u = !0), n && d.minute(0).isAfter(n) && (u = !0), c != i.hour() || u ? e += u ? '<option value="' + h + '" disabled="disabled" class="disabled">' + h + "</option>" : '<option value="' + h + '">' + h + "</option>" : e += '<option value="' + h + '" selected="selected">' + h + "</option>"
                    }
                    e += "</select> ", e += ': <select class="minuteselect">';
                    for (h = 0; h < 60; h += this.timePickerIncrement) {
                        var f = h < 10 ? "0" + h : h;
                        d = i.clone().minute(h), u = !1;
                        s && d.second(59).isBefore(s) && (u = !0), n && d.second(0).isAfter(n) && (u = !0), i.minute() != h || u ? e += u ? '<option value="' + h + '" disabled="disabled" class="disabled">' + f + "</option>" : '<option value="' + h + '">' + f + "</option>" : e += '<option value="' + h + '" selected="selected">' + f + "</option>"
                    }
                    if (e += "</select> ", this.timePickerSeconds) {
                        e += ': <select class="secondselect">';
                        for (h = 0; h < 60; h++) {
                            f = h < 10 ? "0" + h : h, d = i.clone().second(h), u = !1;
                            s && d.isBefore(s) && (u = !0), n && d.isAfter(n) && (u = !0), i.second() != h || u ? e += u ? '<option value="' + h + '" disabled="disabled" class="disabled">' + f + "</option>" : '<option value="' + h + '">' + f + "</option>" : e += '<option value="' + h + '" selected="selected">' + f + "</option>"
                        }
                        e += "</select> "
                    }
                    if (!this.timePicker24Hour) {
                        ...
                        var p = "",
                            m = "";
                        s && i.clone().hour(12).minute(0).second(0).isBefore(s) && (p = ' disabled="disabled" class="disabled"'), n && i.clone().hour(0).minute(0).second(0).isAfter(n) && (m = ' disabled="disabled" class="disabled"'), 12 <= i.hour() ? e += '<option value="AM"' + p + '>AM</option><option value="PM" selected="selected"' + m + ">PM</option>" : e += '<option value="AM" selected="selected"' + p + '>AM</option><option value="PM"' + m + ">PM</option>", e += "</select>"
                    }
            ...
            move: function() {
                ...
                this.parentEl.is("body") || (e = {
                ...
                }, i = this.parentEl[0].clientWidth + this.parentEl.offset().left), t = "up" == this.drops ? this.element.offset().top - this.container.outerHeight() - e.top : this.element.offset().top + this.element.outerHeight() - e.top, this.container["up" == this.drops ? "addClass" : "removeClass"]("drop-up"), "left" == this.opens ? (this.container.css({
                    top: t,
                    ...
                    right: "auto"
                }), this.container.offset().left + this.container.outerWidth() > W(window).width() && this.container.css({
                    left: "auto",
                    right: 0
                }))
            },
            show: function(t) {
                this.isShowing || (this._outsideClickProxy = W.proxy(function(t) {
                    this.outsideClick(t)
                }, this), W(document).on("mousedown.daterangepicker", this._outsideClickProxy).on("touchend.daterangepicker", this._outsideClickProxy).on("click.daterangepicker", "[data-toggle=dropdown]", this._outsideClickProxy).on("focusin.daterangepicker", this._outsideClickProxy), W(window).on("resize.daterangepicker", W.proxy(function(t) {
                    this.move(t)
                }, this)), this.oldStartDate = this.startDate.clone(), this.oldEndDate = this.endDate.clone(), this.previousRightTime = this.endDate.clone(), this.updateView(), this.container.show(), this.move(), this.element.trigger("show.daterangepicker", this), this.isShowing = !0)
            },
            hide: function(t) {
                this.isShowing && (this.endDate || (this.startDate = this.oldStartDate.clone(), this.endDate = this.oldEndDate.clone()), this.startDate.isSame(this.oldStartDate) && this.endDate.isSame(this.oldEndDate) || this.callback(this.startDate.clone(), this.endDate.clone(), this.chosenLabel), this.updateElement(), W(document).off(".daterangepicker"), W(window).off(".daterangepicker"), this.container.hide(), this.element.trigger("hide.daterangepicker", this), this.isShowing = !1)
            },
            toggle: function(t) {
            ...
            clickPrev: function(t) {
                W(t.target).parents(".calendar").hasClass("left") ? (this.leftCalendar.month.subtract(1, "month"), this.linkedCalendars && this.rightCalendar.month.subtract(1, "month")) : this.rightCalendar.month.subtract(1, "month"), this.updateCalendars()
            },
            clickNext: function(t) {
                W(t.target).parents(".calendar").hasClass("left") ? this.leftCalendar.month.add(1, "month") : (this.rightCalendar.month.add(1, "month"), this.linkedCalendars && this.leftCalendar.month.add(1, "month")), this.updateCalendars()
            },
            hoverDate: function(t) {
                if (W(t.target).hasClass("available")) {
                    var e = W(t.target).attr("data-title"),
                        i = e.substr(1, 1),
                        s = e.substr(3, 1),
                        o = W(t.target).parents(".calendar").hasClass("left") ? this.leftCalendar.calendar[i][s] : this.rightCalendar.calendar[i][s],
                        r = this.leftCalendar,
                        l = this.rightCalendar,
                        h = this.startDate;
                    this.endDate || this.container.find(".calendar tbody td").each(function(t, e) {
                        if (!W(e).hasClass("week")) {
                            var i = W(e).attr("data-title"),
                                s = i.substr(1, 1),
                                n = i.substr(3, 1),
                                a = W(e).parents(".calendar").hasClass("left") ? r.calendar[s][n] : l.calendar[s][n];
                            a.isAfter(h) && a.isBefore(o) || a.isSame(o, "day") ? W(e).addClass("in-range") : W(e).removeClass("in-range")
                        }
                    })
                }
            },
            clickDate: function(t) {
                if (W(t.target).hasClass("available")) {
                    var e = W(t.target).attr("data-title"),
                        i = e.substr(1, 1),
                        s = e.substr(3, 1),
                        n = W(t.target).parents(".calendar").hasClass("left") ? this.leftCalendar.calendar[i][s] : this.rightCalendar.calendar[i][s];
                    if (this.endDate || n.isBefore(this.startDate, "day")) {
                        if (this.timePicker) {
                            var a = parseInt(this.container.find(".left .hourselect").val(), 10);
                            if (!this.timePicker24Hour) "PM" === (l = this.container.find(".left .ampmselect").val()) && a < 12 && (a += 12), "AM" === l && 12 === a && (a = 0);
                            var o = parseInt(this.container.find(".left .minuteselect").val(), 10),
                                r = this.timePickerSeconds ? parseInt(this.container.find(".left .secondselect").val(), 10) : 0;
                            n = n.clone().hour(a).minute(o).second(r)
                        }
                        ...
                        if (this.timePicker) {
                            ...
                            if (!this.timePicker24Hour) "PM" === (l = this.container.find(".right .ampmselect").val()) && a < 12 && (a += 12), "AM" === l && 12 === a && (a = 0);
            ...
            timeChanged: function(t) {
                ...
                if (i) {
                    ...
                    r.hour(s), r.minute(n), r.second(a), this.setStartDate(r), this.singleDatePicker ? this.endDate = this.startDate.clone() : this.endDate && this.endDate.format("YYYY-MM-DD") == r.format("YYYY-MM-DD") && this.endDate.isBefore(r) && this.setEndDate(r.clone())
                } else if (this.endDate) {
                    var l = this.endDate.clone();
                    l.hour(s), l.minute(n), l.second(a), this.setEndDate(l)
                }
            ...
            elementChanged: function() {
                if (this.element.is("input") && this.element.val().length) {
                    var t = this.element.val().split(this.locale.separator),
                        e = null,
                        i = null;
                    2 === t.length && (e = z(t[0], this.locale.format), i = z(t[1], this.locale.format)), (this.singleDatePicker || null === e || null === i) && (i = e = z(this.element.val(), this.locale.format)), e.isValid() && i.isValid() && (this.setStartDate(e), this.setEndDate(i), this.updateView())
                }
            },
            keydown: function(t) {
        ...
        }, W.fn.daterangepicker = function(t, e) {
            var i = W.extend(!0, {}, W.fn.daterangepicker.defaultOptions, t);
            return this.each(function() {
                var t = W(this);
    ...
    function(o, r, l, h) {
        function c(t, e) {
            ...
            this.$mirror = o("<div />").prependTo(this.mirrorContainer);
            var n = this.$element.find(">.parallax-slider"),
                a = !1;
            0 == n.length ? this.$slider = o("<img />").prependTo(this.$mirror) : (this.$slider = n.prependTo(this.$mirror), a = !0), this.$mirror.addClass("parallax-mirror").css({
                visibility: "hidden",
                zIndex: this.zIndex,
                position: "fixed",
                top: 0,
            ...
            }), a || (this.$slider[0].src = this.imageSrc), (this.naturalHeight && this.naturalWidth || this.$slider[0].complete || 0 < n.length) && this.$slider.trigger("load")
        }! function() {
            ...
            setup: function() {
                if (!this.isReady) {
                    ...
                    var a = -1;
                    ! function t() {
                        if (a == r.pageYOffset) return r.requestAnimationFrame(t), !1;
                        a = r.pageYOffset, e.render(), r.requestAnimationFrame(t)
                    }()
                }
            },
            ...
            destroy: function(t) {
                ...
                o(t).data("px.parallax", !1), 0 === this.sliders.length && (o(r).off("scroll.px.parallax resize.px.parallax load.px.parallax"), this.isReady = !1, c.isSetup = !1)
            }
        });
        var t = o.fn.parallax;
        o.fn.parallax = function(i) {
            return this.each(function() {
                var t = o(this),
                    e = "object" == typeof i && i;
                this == r || this == l || t.is("body") ? c.configure(e) : t.data("px.parallax") ? "object" == typeof i && o.extend(t.data("px.parallax"), e) : (e = o.extend({}, t.data(), e), t.data("px.parallax", new c(this, e))), "string" == typeof i && ("destroy" == i ? c.destroy(this) : c[i]())
            })
        }, o.fn.parallax.Constructor = c, o.fn.parallax.noConflict = function() {
            return o.fn.parallax = t, this
        }, o(function() {
        ...
        h.Defaults = {
            ...
            run: function(t) {
                ...
                for (t.items = {
                        merge: !1,
                        width: e
                    }; s--;) i = this._mergers[s], i = this.settings.mergeFit && Math.min(i, this.settings.items) || i, t.items.merge = 1 < i || t.items.merge, a[s] = n ? e * i : this._items[s].width();
                this._widths = a
            }
        }, {
            filter: ["items", "settings"],
            ...
            run: function() {
                var t, e, i, s, n = this.settings.rtl ? 1 : -1,
                    ...
                    r = o + this.width() * n,
                    l = [];
                for (i = 0, s = this._coordinates.length; i < s; i++) t = this._coordinates[i - 1] || 0, e = Math.abs(this._coordinates[i]) + a * n, (this.op(t, "<=", o) && this.op(t, ">", r) || this.op(e, "<", o) && this.op(e, ">", r)) && l.push(i);
            ...
            return this.settings.freeDrag || l.each(o, l.proxy(function(t, e) {
                return "left" === s && e - 30 < i && i < e + 30 ? n = t : "right" === s && e - a - 30 < i && i < e - a + 30 ? n = t + 1 : this.op(i, "<", e) && this.op(i, ">", o[t + 1] || e - a) && (n = "left" === s ? t + 1 : t), -1 === n
            }, this)), this.settings.loop || (this.op(i, ">", o[this.minimum()]) ? n = i = this.minimum() : this.op(i, "<", o[this.maximum()]) && (n = i = this.maximum())), n
            ...
            var i = this.current(),
                ...
                r = this.minimum(),
                l = this.maximum();
            this.settings.loop ? (!this.settings.rewind && Math.abs(n) > o / 2 && (n += -1 * a * o), (s = (((t = i + n) - r) % o + o) % o + r) !== t && s - n <= l && 0 < s - n && (i = s - n, t = s, this.reset(i))) : t = this.settings.rewind ? (t % (l += 1) + l) % l : Math.max(r, Math.min(l, t)), this.speed(this.duration(i, t, e)), this.current(t), this.$element.is(":visible") && this.update()
    ...
    function(r, a, t, e) {
            ...
            this._core = t, this._loaded = [], this._handlers = {
                "initialized.owl.carousel change.owl.carousel resized.owl.carousel": r.proxy(function(t) {
                    if (t.namespace && this._core.settings && this._core.settings.lazyLoad && (t.property && "position" == t.property.name || "initialized" == t.type))
                        for (var e = this._core.settings, i = e.center && Math.ceil(e.items / 2) || e.items, s = e.center && -1 * i || 0, n = (t.property && void 0 !== t.property.value ? t.property.value : this._core.current()) + s, a = this._core.clones().length, o = r.proxy(function(t, e) {
                                this.load(e)
                            }, this); s++ < i;) this.load(a / 2 + this._core.relative(n)), a && r.each(this._core.clones(this._core.relative(n)), o), n++
                }, this)
        ...
        i.Defaults = {
            ...
            !i || -1 < r.inArray(e.get(0), this._loaded) || (i.each(r.proxy(function(t, e) {
                var i, s = r(e),
                    n = 1 < a.devicePixelRatio && s.attr("data-src-retina") || s.attr("data-src");
    ...
    function(a, t, e, i) {
        var s = function(t) {
            ...
            }, this._core.options = a.extend({}, s.Defaults, this._core.options), this._core.$element.on(this._handlers)
        };
        s.Defaults = {
            autoHeight: !1,
    ...
    function(c, t, e, i) {
        ...
        s.Defaults = {
            ...
            if (-1 < (s = o.match(/(http:|https:|)\/\/(player.|www.|app.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com)|vzaar\.com)\/(video\/|videos\/|embed\/|channels\/.+\/|groups\/.+\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(\&\S+)?/))[3].indexOf("youtu")) i = "youtube";
            ...
            var i, s, n = t.width && t.height ? 'style="width:' + t.width + "px;height:" + t.height + 'px;"' : "",
                ...
                h = function(t) {
                    '<div class="owl-video-play-icon"></div>', i = l.lazyLoad ? '<div class="owl-video-tn ' + r + '" ' + o + '="' + t + '"></div>' : '<div class="owl-video-tn" style="opacity:1;background-image:url(' + t + ')"></div>', e.after(i), e.after('<div class="owl-video-play-icon"></div>')
                };
            if (e.wrap('<div class="owl-video-wrapper"' + n + "></div>"), this._core.settings.lazyLoad && (o = "data-src", r = "owl-lazy"), a.length) return h(a.attr(o)), a.remove(), !1;
    ...
    function(o, t, e, i) {
        ...
        s.Defaults = {
            ...
            if (1 === this.core.settings.items && o.support.animation && o.support.transition) {
                ...
                this.core.current() !== this.previous && (a && (t = this.core.coordinates(this.previous) - this.core.coordinates(this.next), i.one(o.support.animation.end, e).css({
                    left: t + "px"
                }).addClass("animated owl-animated-out").addClass(a)), n && s.one(o.support.animation.end, e).addClass("animated owl-animated-in").addClass(n))
            }
    ...
    function(a, t, e, i) {
        ...
        var s = function(t) {
            this._core = t, this._initialized = !1, this._pages = [], this._controls = {}, this._templates = [], this.$element = this._core.$element, this._overrides = {
                ...
                "prepared.owl.carousel": a.proxy(function(t) {
                ...
                "added.owl.carousel": a.proxy(function(t) {
                    t.namespace && this._core.settings.dotsData && this._templates.splice(t.position, 0, this._templates.pop())
                }, this),
                "remove.owl.carousel": a.proxy(function(t) {
                    t.namespace && this._core.settings.dotsData && this._templates.splice(t.position, 1)
                }, this),
                "changed.owl.carousel": a.proxy(function(t) {
                    t.namespace && "position" == t.property.name && this.draw()
                }, this),
                "initialized.owl.carousel": a.proxy(function(t) {
                    t.namespace && !this._initialized && (this._core.trigger("initialize", null, "navigation"), this.initialize(), this.update(), this.draw(), this._initialized = !0, this._core.trigger("initialized", null, "navigation"))
                }, this),
                "refreshed.owl.carousel": a.proxy(function(t) {
                    t.namespace && this._initialized && (this._core.trigger("refresh", null, "navigation"), this.update(), this.draw(), this._core.trigger("refreshed", null, "navigation"))
                }, this)
            }, this._core.options = a.extend({}, s.Defaults, this._core.options), this.$element.on(this._handlers)
        };
        s.Defaults = {
            nav: !1,
            navText: ["prev", "next"],
            ...
            for (t in this._controls.$relative = (i.navContainer ? a(i.navContainer) : a("<div>").addClass(i.navContainerClass).appendTo(this.$element)).addClass("disabled"), this._controls.$previous = a("<" + i.navElement + ">").addClass(i.navClass[0]).html(i.navText[0]).prependTo(this._controls.$relative).on("click", a.proxy(function(t) {
                    this.prev(i.navSpeed)
                }, this)), this._controls.$next = a("<" + i.navElement + ">").addClass(i.navClass[1]).html(i.navText[1]).appendTo(this._controls.$relative).on("click", a.proxy(function(t) {
                    this.next(i.navSpeed)
                }, this)), i.dotsData || (this._templates = [a("<div>").addClass(i.dotClass).append(a("<span>")).prop("outerHTML")]), this._controls.$absolute = (i.dotsContainer ? a(i.dotsContainer) : a("<div>").addClass(i.dotsClass).appendTo(this.$element)).addClass("disabled"), this._controls.$absolute.on("click", "div", a.proxy(function(t) {
            ...
            var t, e = this._core.settings,
                ...
                n = e.loop || e.rewind;
            this._controls.$relative.toggleClass("disabled", !e.nav || i), e.nav && (this._controls.$previous.toggleClass("disabled", !n && s <= this._core.minimum(!0)), this._controls.$next.toggleClass("disabled", !n && s >= this._core.maximum(!0))), this._controls.$absolute.toggleClass("disabled", !e.dots || i), e.dots && (t = this._pages.length - this._controls.$absolute.children().length, e.dotsData && 0 !== t ? this._controls.$absolute.html(this._templates.join("")) : 0 < t ? this._controls.$absolute.append(new Array(t + 1).join(this._templates[0])) : t < 0 && this._controls.$absolute.children().slice(t).remove(), this._controls.$absolute.find(".active").removeClass("active"), this._controls.$absolute.children().eq(a.inArray(this.current(), this._pages)).addClass("active"))
            ...
            return a.grep(this._pages, a.proxy(function(t, e) {
                return t.start <= i && t.end >= i
            }, this)).pop()
        }, s.prototype.getPosition = function(t) {
            var e, i, s = this._core.settings;
            return "page" == s.slideBy ? (e = a.inArray(this.current(), this._pages), i = this._pages.length, t ? ++e : --e, e = this._pages[(e % i + i) % i].start) : (e = this._core.relative(this._core.current()), i = this._core.items().length, t ? e += s.slideBy : e -= s.slideBy), e
            ...
            var s;
            !i && this._pages.length ? (s = this._pages.length, a.proxy(this._overrides.to, this._core)(this._pages[(t % s + s) % s].start, e)) : a.proxy(this._overrides.to, this._core)(t, e)
        }, a.fn.owlCarousel.Constructor.Plugins.Navigation = s
    }(window.Zepto || window.jQuery, window, document),
    function(s, n, t, e) {
        "use strict";
        var i = function(t) {
