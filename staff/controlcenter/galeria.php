        ...
        default: ?>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <?php echo "<td><a href='galeria.php?source=actualizar-galeria&galeria_id=$galeria_id'><i class=\"fa fa-edit\"></a></td>"; ?>
                    <?php echo "<td><a href='galeria.php?eliminar=$galeria_id'><i class=\"fa fa-trash\"></i></a></td>"; ?>
                </tr>
                <?php }?>
            </tbody>
            </table><?php
