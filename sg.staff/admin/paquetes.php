                            ...
                            default: ?>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php echo "<td><a href='paquetes.php?source=actualizar&paquete_id=$paquete_id'>Actualizar/Cambiar</a></td>"; ?>
                                        <?php echo "<td><a href='paquetes.php?eliminar=$paquete_id'><small>Eliminar</small></a></td>"; ?>
                                    </tr>
                                    <?php }?>
                                </tbody>
                                </table><?php
