...
excursiones, paquetes, tramites de Visas, cruceros. Somos tu mejor opción para organizar el viaje soñado.">
  ...
  <meta charset="UTF-8">
  <title>Gracias por tu reserva | SG Travel Group</title>
...
<div id="success">
    <div class="icon icon--order-success svg">
         <svg xmlns="http://www.w3.org/2000/svg" width="80px" height="80px">
          <g fill="none" stroke="#2ed257" stroke-width="3">
             <circle cx="36" cy="36" r="34" style="stroke-dasharray:240px, 240px; stroke-dashoffset: 480px;"></circle>
             <path d="M17.417,37.778l9.93,9.909l25.444-25.393" style="stroke-dasharray:50px, 50px; stroke-dashoffset: 0px;"></path>
          </g>
         </svg>
     </div>
	<h4><span>¡Tu reserva se ha enviado con éxito!</span> Te contáctaremos en breve.</h4>
	<p>Serás redireccionado automáticamente a nuestra página principal.</p>
</div>
</body>
</html>
