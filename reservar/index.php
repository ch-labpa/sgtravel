		...
		<div class="row row-height">
			<div class="col-lg-6 content-left">
				<div class="content-left-wrapper bg_hotel">
					<div class="wrapper">
						<a href=".././" id="logo"><img src="../img/logo.png" alt="" height="65px"></a>
						<div id="social">
							<ul>
								<li><a href="https://www.facebook.com/viajasiempremasbarato/"><i class="fab fa-facebook"></i></a></li>
								<li><a href="https://www.instagram.com/sgtravelpanama"><i class="fab fa-instagram"></i></a></li>
							</ul>
						</div>
						<!-- /social -->
